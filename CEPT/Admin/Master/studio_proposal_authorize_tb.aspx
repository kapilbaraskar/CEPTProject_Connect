<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="studio_proposal_authorize_tb.aspx.cs" Inherits="Admin_Master_studio_proposal_authorize_tb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", ".authorize", function (event) {
            ...
            //                            convert_VF_Type(instructor_code, instructor_name, email);
            //                        }
            //                    }
            //                    else {
        ...
        //function convert_VF_Type(instructor_code, instructor_name, email) {
        //    $.ajax({
        //        type: "POST",
        //        contentType: "application/json; charset=utf-8",
        //        url: "../../WebService.asmx/change_instructor_mst",
        //        async: false,
        //        data: "{instructor_code : '" + instructor_code + "',instructor_name:'" + instructor_name + "',email:'" + email + "',flag:'S',user_type:'VF',des_letter:'',instructor_first_name:'',instructor_last_name:''}",
        //        dataType: "json",
        //        success: function (data) {
                ...
                "aoColumns": [
...

                    {
                        "sTitle": "Description", "mData": null, "sClass": "cls_desc", "bSortable": false, "mRender": function (data)
                        {
                            var str = ""; 
                            str += "<div><div>";   
                            str += "<div style='width:100%;line-height: 75%;'> <b>Studio Title :</b> " + data['studio_title'] + "</div><br/>";
                            str += "<div style='width:100%;float: left;line-height: 80%;'><b>Instructor Name :</b> " + data['full_name'] + "</div></br>";


                            str += "<div class='row' style='padding-left:15px;'>";
                            str += "<div style='width:30%;float: left;line-height: 80%;'><b>Instructor Code :</b> " + data['user_id'] + "</div>";
                            str += "<div style='width:30%;float: left;line-height: 80%;'><b>Mail :</b> " + data['mail'] + "</div>";
                            str += "<div style='width:40%;float: left;line-height: 80%;'><b>Nationality :</b> " + data['country_name'] + "</div></br>";
                            str += "</div>";

                            str += "<div class='row' style='padding-left:15px;'>";
                            str += "<div style='width:30%;float: left;line-height: 80%;'><b>Instructor Type :</b> " + data['inst_designation'] + "</div>";
                            str += "<div style='width:30%;float: left;line-height: 80%;'><b>No of Tutor :</b> " + data['no_of_tutor'] + "</div>";
                            str += "<div style='width:40%;float: left;line-height: 80%;'><b>Mode of Teaching :</b> " + data['teaching_mode'] + "</div></br>";
                            str += "</div>";


                            str += "<div class='row' style='padding-left:15px;'>";
                            str += "<div style='width:30%;float: left;line-height: 80%;'><b>Level :</b> " + data['studio_level'] + "</div>";
                            str += "<div style='width:30%;float: left;line-height: 80%;'><b>Total Experiance :</b> " + data['total_experiance'] + "</div>";
                            str += "<div style='width:40%;float: left;line-height: 80%;'><b>Faculty Name :</b> " + data['dept_name'] + "</div></br>";
                            str += "</div>";


                            str += "<div class='row' style='padding-left:15px;'>";
                            str += "<div style='width:25%;float: left;line-height: 80%;'><b>Rate Band :</b> " + data['rate_band'] + "</div>"; 
                            str += "</br>";
                            str += "</div>";


                            str += "<div class='row' style='padding-left:15px;'>";
                            str += "<div style='width:30%;float: left;line-height: 80%;'><b>PC/Dean Shortlist Status :</b></div>";
                            str += "<div style='width:30%;float: left;line-height: 80%;'><b>Personal Detail Submit :</b></div>";
                            str += "<div style='width:40%;float: left;line-height: 80%;'><b>Rateband Submit :</b></div>";
                            str += "<br>";
                            ...
                            if (data['shortlist_status'] == "A") {
                                ...
                                str += "<div style='width:30%;float: left;line-height: 80%;'><p style='color: green'>Submitted</p></div>";
                            }
                            else {
                                str += "<div style='width:30%;float: left;line-height: 80%;'><p style='color: blue'>Pending</p></div>";
                            }
                            ...
                            if (data['rateband_approved'] == "Y") {
                                ...
                                str += "<div style='width:40%;float: left;line-height: 80%;'><span style='color: green'>Submitted</span></div>";
                            }
                            else {
                                str += "<div style='width:40%;float: left;line-height: 80%;'><span style='color: blue'>Pending</span></div>";
                            }
                            ...
                            str += "<div class='row' style='padding-left:15px;'>";
                            str += "<div style='width:30%;float: left;line-height: 80%;'><b>Workload Submit :</b></div>";
                            str += "<div style='width:30%;float: left;line-height: 80%;'><b>Dean/PC Authorized :</b></div>";
                            str += "<br>";
                            ...
                            if (data['instructor_workload_hr_approved'] == "Y") {
                                ...
                                str += "<div style='width:30%;float: left;line-height: 80%;'><p style='color: green'>Authorized</p></div>";
                            }
                            else {
                                str += "<div style='width:30%;float: left;line-height: 80%;'><p style='color: blue'>Pending</p></div>";
                            }
                            ...
                            str += "<div class='row' style='padding-left:15px;'>";
                            str += "<div style='width:100%;float: left;'><b>Studio Description :</b></div></br>";
                            str += "<div style='width:100%;float: left; margin-bottom: 19px;'>" + data['studio_description'] + "</div></br>"; 
                            str += "</div>";
                            ...
                            str += "<div class='row' style='padding-left:15px;'>";
                            str += "<div style='width:30%;float: left;line-height: 80%;'><b>Previous Semester :</b> " + sem_name + "</div>";
                            str += "<div style='width:30%;float: left;line-height: 80%;'><b>Previous Year :</b> " + data['previous_year_code'] + "</div>"; 
                            str += "<div style='width:40%;float: left;line-height: 80%;'><b>Previous Semester Course Code :</b> " + data['previous_sem_course_code'] + "</div>";
                            str += "</br></br>";
                            str += "<div style='width:100%;float: left; margin-bottom: 19px;'></div></br>";
                            str += "</div>";
                            ...
                            str += "<div style='width:10%;float: left;line-height: 80%;'><button type='button' id=" + data['user_id'] + " onclick='rowClick_edit(this)' class='btn btn-primary per_edit'>Edit</button></div>";
                            if (data['cv_file_name'] != '') {
                                str += "<div style='width:10%;float: left;line-height: 80%;'><button type='button' id=" + data['cv_file_name'] + " onclick='rowClick_cv_download(this)' class='btn btn-primary cv_download'>CV</button></div>";  
                            }
                            
                            if (data['portfolio_file_name'] != '') {
                                str += "<div style='width:13%;float: left;line-height: 80%;'><button type='button' id=" + data['portfolio_file_name'] + " onclick='rowClick_portfolio_download(this)' class='btn btn-primary portfolio_download'>Portfolio</button></div>";
                                
                            }   
                            str += "<div style='width:15%;float: left;line-height: 80%;'><button type='button' class='btn btn-primary pdf_download'>Document</button></div>";
                            if (data.approved == 'Y')
                            {
                                var row_value = data.user_id + '_' + data.studio_code;
                                str += "<div style='width:14%;float: left;line-height: 80%;'><button type='button' id=" + row_value + " class='btn btn-primary auth_sendmail'>Send Mail</button></div>";
                            }
                            if (data.previous_sem_course_code != "") {
                                ...
                                str += "<div style='width:30%;float: left;line-height: 80%;'><button type='button' id=" + row_dtl + " onclick='rowClick_view(this)' class='btn btn-primary'>Previous Semester Brief View</button></div>";
                            ...
                            if ($('#drptype').val() == 'R')
                            {
                                if (data.hr_remark_new != "") {
                                    str += "<div style='width:100%;float: left;line-height: 80%;'><b>Remark :</b> " + data['hr_remark_new'] + "</div>";
                                }
                                else
                                {
                                    str += "<div style='width:100%;float: left;line-height: 80%;'><b>Remark :</b></div>";
                                }
                                //str += "<div style='width:30%;float: left;'><textarea id=" + remark_id + " name='remark' rows='4' cols='50'>" + data['hr_remark_new'] + "</textarea></div>";
                            }
                            else if ($('#drptype').val() == 'Y') {
                                if (data.hr_remark != "")
                                {
                                    if (data.approved == "Y") {
                                        str += "<div style='width:100%;float: left;line-height: 80%;'><b>Remark :</b> " + data['hr_remark'] + "</div>";
                                        //str += "<div style='width: 30 %; float: left;'><textarea id=" + remark_id + " name='remark' rows='4' cols='50'>" + data['hr_remark'] + "</textarea></div>";
                                    }
                                    else
                                    {
                                        str += "<div style='width: 30 %; float: left;'><textarea id=" + remark_id + " name='remark' rows='4' cols='50'>" + data['hr_remark'] + "</textarea></div>";
                                ...
                                else
                                {
                                    ...
                                    {
                                        str += "<div style='width: 30%; float: left;'><textarea id=" + remark_id + " name='remark' rows='4' cols='50'></textarea></div>";
                                    }
                            ...
                            {
                                if (data.hr_remark1 != "") {
                                    str += "<div style='width: 30%; float: left;'><textarea id=" + remark_id + " name='remark' rows='4' cols='50'>" + data['hr_remark1'] + "</textarea></div>";
                                }
                                else
                                {
                                    if (data.approved == "Y") {
