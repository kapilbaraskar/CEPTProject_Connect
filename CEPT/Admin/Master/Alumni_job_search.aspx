<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="Alumni_job_search.aspx.cs" Inherits="Admin_Alumni_job_search" %>
                     ...
                     if (data.d != "") {
                         ...
                         if (response['status'] == 'true') {
                             ...
                             for (var i = 0; i < response["message"].length; i++) {
                                 ...
                                 str += ' <a  onclick=get_alumni_data(' + response["message"][i]["Doc_no"] + ')>  <b><span>' + response["message"][i]["job_title"] + '</span> </b></a>';
                                 str += ' <br /> ';
