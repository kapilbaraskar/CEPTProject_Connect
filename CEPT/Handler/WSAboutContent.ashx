<%@ WebHandler Language="C#" Class="WSAboutContent" %>

using System;
using System.Web;

public class WSAboutContent : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    int mFileSize = 0;
    string msg = "";
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
            string Serverpath = System.Configuration.ConfigurationManager.AppSettings["WSAboutContentUploadPath"];

            if (context.Request.Files.Count > 0)
            {
                var postedFile = context.Request.Files[0];
                string filesize = System.Configuration.ConfigurationManager.AppSettings["WSAboutContentUploadMaxSize"];
