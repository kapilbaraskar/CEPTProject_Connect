<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="WS_Offer_Student_List.aspx.cs" Inherits="Admin_Report_WS_WS_Offer_Student_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function get_page_load_dtl() {
            ...
            var type = '';
            var cancel_seat_number = $('#hdn_c').val();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="" style="background-color: White;">
        ...
        <div id="DataList" class="panel panel-default" style="display: none;">
            <div class="panel-heading">
                <strong id="panel_head">Offer Student List</strong>
            </div>
            <div>
