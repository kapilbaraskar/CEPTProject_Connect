<%@ WebHandler Language="C#" Class="Fee_Collection_Upload" %>

using System;
using System.Web;

public class Fee_Collection_Upload : IHttpHandler {
        ...
        try
        {
            ...
            else
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = web.ExcelFileToDatatable_upload_fee_collection(file, context);
