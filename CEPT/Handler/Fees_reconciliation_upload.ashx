<%@ WebHandler Language="C#" Class="Fees_reconciliation_upload" %>

using System;
using System.Web;

public class Fees_reconciliation_upload : IHttpHandler {
        ...
        try
        {
            ...
            else
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = web.ExcelFileToDatatable_upload_fees_reconciliation(file, context);
