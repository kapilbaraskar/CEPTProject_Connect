<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GradeReportPDF_Final.aspx.cs" Inherits="Admin_Report_GradeReportPDF_Final" %>
...
<body class="container" style="color:Black;">
    ...
    <div>
        ...
        <div style="margin-top: -15px;">
            <b>C – Core, E – Elective, NGPA - Non GPA, P - Pass, NP - Not Pass, F - Fail, NA - Not Applicable<%--,* - Fail Due to Insufficient Attendance--%></b>
        </div>
    </div>
