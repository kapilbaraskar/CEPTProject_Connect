<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true"
    CodeFile="Alumni_View_job.aspx.cs" Inherits="Admin_Alumni_View_job" %>
        ...
        <div>
            <div class="panel panel-default ">
                ...
                <div class="container" style="margin-left: 20px;">
                    ...
                    <div class="row">
                        <div class="col-md-1" style="margin-left: 11px;margin-top: 15px;">
                            <image  id="img_path" style="width: 100px;"></image>
                        </div>
                        <div class="col-md-3" style="margin-top: 15px;">
                            <b><span class="txt_job_title" style="font-size: 20px;"></span></b><br />
