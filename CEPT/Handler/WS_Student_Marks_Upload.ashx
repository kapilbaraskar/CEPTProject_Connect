<%@ WebHandler Language="C#" Class="WS_Student_Marks_Upload" %>
...
public class WS_Student_Marks_Upload : IHttpHandler, IReadOnlySessionState{
        ...
        try
        {
            ...
            else
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = web.WS_ExcelFileToDatatable_upload_student_wise_marks(file, context);
