<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" 
    CodeFile="PersonalDetailEditAdmin_Alumni.aspx.cs" Inherits="Admin_Report_PersonalDetailEditAdmin_Alumni" %>
      ...
      <script type="text/javascript">
          ...
          function get_alumni_personal_data(userid) {
              $.ajax({
                  type: "POST",
                  contentType: "application/json; charset=utf-8",
                  url: "../../WebService.asmx/get_alumni_personal_data_admin",
                  async: false,
                  data: "{user_id:'" + userid + "'}",
                  dataType: "json",
                  success: function (data) {
                      if (data.d != "") {
                          ...
                          $('#login_email').val(response[0].mail);
          ...
          function save_alumni_personal_data() {
              ...
              $.ajax({
                  type: "POST",
                  contentType: "application/json; charset=utf-8",
                  url: "../../WebService.asmx/save_alumni_personal_data_report",
                  async: false,
