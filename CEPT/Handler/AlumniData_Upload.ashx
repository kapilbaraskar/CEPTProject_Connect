<%@ WebHandler Language="C#" Class="AlumniData_Upload" %>
...
public class AlumniData_Upload :  IHttpHandler, IReadOnlySessionState{
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
            ...
            else
            {
                ...
                string Serverpath = System.Configuration.ConfigurationManager.AppSettings["UploadExcel_Alumni"];
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = web.ExcelFileUpload_alumni(file, context);
