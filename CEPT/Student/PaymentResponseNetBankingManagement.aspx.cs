...
public partial class Student_PaymentResponseNetBankingManagement : System.Web.UI.Page
{
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    if (Session["SessionId"] != null && Session["UserId"] != null)
                    {
                        ...
                        string message = objPayment.SavePaymentDetails(Request, ref paymentResponse, "e7168bf14d5e574138cfd98c0db880f6eae46cfa");
                        ...
                        if (paymentResponse.status.Contains("paymentSuccess"))
                        {
                            ...
                            if (paymentResponse.data.user_id != null && paymentResponse.data.user_id != string.Empty)
                            {
                                ...
                                if (dtCandidatePersonalDetails != null && dtCandidatePersonalDetails.Rows.Count > 0)
                                {
                                    ...
                                    //    email_data["program_name"] = "Cept Faculty of Management";
                                        ...
                                        {
                                            email_data["program_name"] = "Faculty of Management";
                                        }
                ...
                try
                {
                    if (Session["SessionId"] != null && Session["UserId"] != null && paymentResponse.status == "paymentFail")
                    {
                        ...
                        {
                            dic_payment_fail_dtl["program_name"] = "Faculty of Management";
                        }
