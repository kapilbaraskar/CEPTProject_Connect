...
public partial class Admin_Master_Sws_course_wise_enter_session_dtl : System.Web.UI.Page
{
    string course_code = "";
    string year_type = "";
    string semester = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("~/Admin/Master/Sws_course_wise_enter_session_dtl.aspx?autho=false");
        }
        else
        {
