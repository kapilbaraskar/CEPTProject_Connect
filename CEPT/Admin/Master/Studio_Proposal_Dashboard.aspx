<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="Studio_Proposal_Dashboard.aspx.cs" Inherits="Admin_Master_Studio_Proposal_Dashboard" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            if ($("#hdn_is_submit").val() == "Y") {
                ...
                $("#pd").css('background-color', '#2e6da4');
                            ...
                            "sTitle": "Studio Brief", "bSortable": false, "mData": null, "mRender": function (data) {
                                ...
                                else if ($('#hdnusertype').val() == 'PC')
                                {
                                    ...
                                    else if (data.is_submit == 'Y' && data.approved == 'Y')
                                    {
                                        ...
                                        //return '<center><a id=' + data_dtl + ' onclick="rowClick_studio_brief(this)">Edit</a></center>';//by nitinbhai changes 22082025
                                        return '<center></center>';
                                    }
                                    else {
                                        return '<center></center>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row" style="margin-top: 11px; width: 64.3%; border: 0px solid rgba(113, 112, 112, 1); background-color: rgba(255, 255, 255, 1); border-radius: 0; box-shadow: 0 1px 4px rgba(0, 0, 0, 0.6); margin-left: 1px; display: block;" id="for_I2">
        ...
        <ol class="show-grid col-md-8 col-md-offset-2" style="margin-left: -8px; width: 100%; margin-bottom: 10px; margin-top: 5px;">
            ...
            <li class="col-md-3 active" id="pd" style="width: 20.7% !important;"><%--18--%> <%--If you are proposing to run and existig studio unit that you have already offered in a previous semester to submit the detailed studio brief --%>
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <p id="pdclick" style="color: white;">Submit New Proposal</p>


                    </div>
                </div>
            </li>
            <li class="col-md-3 active" id="ip" style="width: 28% !important; display: none;"><%--18--%>
                <div class="media">
                    <div class="pull-left" href="#">
    ...
    <div style="position: absolute; top: 217px; height: 500px; width: 980px; left: 0px;"
        ...
        <div id="PAGES_CONTAINERcenteredContent" class="s9centeredContent">
            ...
            <div id="PAGES_CONTAINERinlineContent" class="s9inlineContent">
                <div style="position: absolute; top: 62px; height: 488px; width: 682px; left: 0px; border: 1px solid #cccccc; box-shadow: 0 1px 4px rgb(0 0 0 / 60%);"
                    ...
                    <div style="position: absolute; top: 7px; height: 500px; width: 980px; left: 8px;"
                        ...
                        <div class="tab" style="width: 36%;">
                            <a id="p" class="tablinks" onclick="openCity(event, 'Paris')" style="border-right: 1px solid #cccccc;">My Proposal</a>
                            <a id="s" class="tablinks" onclick="openCity(event, 'London')">Studio Proposal Details</a>
                        </div>

                        <div id="mainPageinlineContent" class="s11inlineContent">
                            <div id="London" class="tabcontent">
                                <div style="position: absolute; height: 250px; width: 665px; left: 0px; top: 63px;" class="s12" id="i22d06md_new">
                                    ...
                                    <div id="divblanktable_new" style="top: 25%; position: absolute; width: 98%; padding-left: 1%;">
                                        ...
                                        <div id="divblanktable_new" style="top: 16%; position: absolute; width: 98%; padding-left: 1%;">
                                            ...
                                            <div style="margin-top: 1%;" id="">
                                                ...
                                                <a href="../../StudioDetails/4 - Studio Unit Framework and Preparation.pdf" download>Download</a>
                                            </div>
                                            <div style="margin-top: 1%;" id="">
                                ...
                                <div style="position: absolute; top: 65.5%; height: 140px; width: 666px; left: 0px;" class="s12" id="i22d06md_new_2">
                                    ...
                                    <div id="divblanktable_new_2" style="top: 20%; position: absolute; width: 98%; padding-left: 1%;">
                                        ...
                                        <div style="position: absolute; top: 5px; width: 98%; left: 7px;" class="s1" id="i22cwf5i_new_2">
                                            <p style="font-size: 18px;" class="font_8">
                                                <span style="font-size: 18px;">Templates/Samples For Studio Brief:</span>
                                            </p>
                                        </div>
                                        <div id="divblanktable_new_2" style="top: 20%; position: absolute; width: 98%; padding-left: 1%;">
                                            <%-- <div style="margin-top: 1%;" id="">
                            ...
                            <div id="Paris" class="tabcontent">
                                <div style="position: absolute; top: 11.7%; height: 343px; width: 664px; left: 1px;"
                                    ...
                                    <div id="studio_pro_dtl" class="s12inlineContent">
                                        ...
                                        <div id="studio_data" class="tab-pane" style="margin-top: 40px; height: 370px; overflow: auto;">
            ...
            <div style="position: absolute; top: 0px; height: 500px; width: 345px; left: 0px;"
                ...
                <div id="Div11" class="s11inlineContent">
                    <div style="position: absolute; top: 54px; height: 250px; width: 345px; left: 1px;"
                        ...
                        <div style="position: absolute; top: 30px; height: 5px; width: 97%; left: 7px;" class="s13" id="Div16">
                            <div style="margin-top: 2%;" id="">

                                <span style="font-size: 18px; font-size: 15px; margin-top: 10px;">Reference Documents: </span>
                            </div>
                            <div style="margin-top: 2%; display:none;" id="">
                            ...
                            <div style="margin-top: 10%; display:none;" id="">
                            ...
                            <div style="margin-top: 2%;" id="">
                                <div style="float: left; width: 86%;">1. Connect guide to submit new proposal</div>
                                <a href="https://connect.cept.ac.in//Help//Connect guide to submit new proposal.pdf" target="_blank">View</a>
                            </div>
                            <div style="margin-top: 2%;" id="">
                                <div style="float: left; width: 86%;">2. Connect guide to submit the existing brief</div>
                                <a href="https://connect.cept.ac.in//Help//Connect guide to submit the existing brief.pdf" target="_blank">View</a>
                            </div>

                            <div style="margin-top: 2%;" id="">
                                <div style="float: left; width: 86%;">3. General Instructions.</div>
                                <a href="https://connect.cept.ac.in//Help//General Instruction.pdf" target="_blank">View</a>
                            </div>
                            <div style="margin-top: 2%;" id="">
                                <div style="float: left; width: 86%;">4. Studio Proposal Submission Guide video.</div>
                                <a href="https://www.youtube.com/watch?v=qSruZ_k5FJU" target="_blank">View</a>
                            </div>
                            <div id="Div17" class="s13line">
                            </div>
                        </div>
