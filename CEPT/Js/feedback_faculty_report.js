...
$(document).ready(function () {
    ...
    $('#chartContainer').dxChart({ size: { height: 300, width: 650 }, dataSource: dataSource, series: series,
    ...
    $('#btnprint').on('click', function () {
        ...
        //        var contents = document.getElementById("print_data").innerHTML;
          ...
          //  url: "../../WebService.asmx/print_faculty_report_latest_rating",
            ...
            success: function (data) {
                ...
                if (data.d != "") {
                    ...
                    //Get svg markup as string
                    //                    var svg = document.getElementById('print_data').innerHTML;
                    ...
                    //                    doc.addImage(imgData, 'JPEG', 40, 40, 75, 75);
                    //                    doc.save('test.pdf');
                    // Generate PDF


                    //  var html = document.getElementById('print_data').innerHTML;

                    //  GrabzIt("APPLICATION KEY").ConvertHTML(html,{ "format": "pdf" }).Create();

                    //                    var pdf = new jsPDF('p', 'pt', 'letter');
                    //                    var specialElementHandlers = {
                    //                        '#print_data': function (element, renderer) {
                    //                            return true;
                    //                        }
                    //                    };

                    //                    pdf.addHTML($('#print_data').first(), function () {
