...
xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns="https://www.w3.org/TR/REC-html40">
        ...
        $(document).ready(function () {
            ...
            if (trans_data != '') {
                ...
                for (var i = 0; i < trans_data.length; i++) {
                    ...
                    $('.lbl_name_of_institute').text(trans_data[i]["bank_code"] + "-" + trans_data[i]["account_name"]);

                    $('.lbl_pan_no').text('AAAJC0452C');
                    $('.lbl_sem_code').text(trans_data[i]["semester_code"]);
                    $('.cls_account_name').text(trans_data[i]["account_name"]);
                    $('.lbl_payslip_number').text(trans_data[i]["payslip_number"]);

                    //$('.lbl_bank_code').text(trans_data[i]["bank_code"]);
