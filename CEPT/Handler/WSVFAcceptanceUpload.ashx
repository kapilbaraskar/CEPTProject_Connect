<%@ WebHandler Language="C#" Class="WSVFAcceptanceUpload" %>

using System;
using System.Web;

public class WSVFAcceptanceUpload : IHttpHandler , System.Web.SessionState.IRequiresSessionState {
    ...
    public void ProcessRequest (HttpContext context) {
        try
        {
            ...
            string Serverpath = System.Configuration.ConfigurationManager.AppSettings["WSVFAcceptanceUploadPath"];

            if (context.Request.Files.Count > 0)
            {
                var postedFile = context.Request.Files[0];
                string filesize = System.Configuration.ConfigurationManager.AppSettings["VFAcceptanceUploadMaxSize"];
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string fileDirectory = Savepath + "\\" + "WS_" + finalFileName;
