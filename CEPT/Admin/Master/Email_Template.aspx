<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true"
     CodeFile="Email_Template.aspx.cs" Inherits="Admin_Master_Email_Template" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", "#btn_savedata", function () {
                ...
                if (data.body.search(/\\/) != -1) { data.body = data.body.replace(/\\/g, '\\\\'); }
                if (data.body.search("\"") != -1) { data.body = data.body.replace(/"/g, '\\\"'); }
        ...
        function bind_email_type() {
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "../../WebService.asmx/get_email_content_details",
                    data: "{}",
                    dataType: "json",
                    success: function (data) {
                        if (data.d != "") {
