<%@ WebHandler Language="C#" Class="TA_reference_letter" %>

using System;
using System.Web;

public class TA_reference_letter : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        try
        {
            ...
            string Serverpath = System.Configuration.ConfigurationManager.AppSettings["TAReferenceLetterUploadPath"];

            if (context.Request.Files.Count > 0)
            {
                var postedFile = context.Request.Files[0];
                string filesize = System.Configuration.ConfigurationManager.AppSettings["TAReferenceLetterUploadMaxSize"];
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    finalFileName = user_id + "_" + user_name + "_Reference" + "." + extension[1];
