<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FoundationGradeReport.aspx.cs" Inherits="Admin_Report_FoundationGradeReport" %>
        ...
        function set_WS_CourseDetail() {
            ...
            if (obj_ws_course_detail != null && obj_ws_course_detail != undefined) {
                ...
                for (var i = 0; i < obj_ws_course_detail.length; i++) {
                    ...
                    else if (obj_ws_course_detail[i]['c_type'] == 'E' && obj_ws_course_detail[i]['gpa_nongpa'] == 'N') {//New Added on 10 04 2019
                        strTableCourseDetail = strTableCourseDetail + "<td style='text-align: center;'>" + obj_ws_course_detail[i]['c_type'] + "</td>";
                    } //New Added on 10 04 2019
                    ...
                    if (obj_ws_course_detail[i]['c_type'] == 'E' && obj_ws_course_detail[i]['gpa_nongpa'] == 'N') {//New Added on 09 04 2019
                        strTableCourseDetail = strTableCourseDetail + "<td style='text-align: center;'>NA</td>";
        ...
        function display_Grade_Range() {
            if (obj_stud_detail != null && obj_stud_detail != undefined) {
                if (obj_stud_detail[0]["year_code"] < 'Y2014') {
                    ...
                    //$('#div_grade_range_' + obj_stud_detail[0]["year_code"] + '_onward').css('display', 'block');
                    $('#div_grade_range_' + obj_stud_detail[0]["year_code"] + '_onward table').css('font-size', '11px');
                    $('#div_grade_range_' + obj_stud_detail[0]["year_code"] + '_onward table tr th').css('line-height', '10px');
                    $('#div_grade_range_' + obj_stud_detail[0]["year_code"] + '_onward table tr td').css('line-height', '10px');

                    $('.cls_marks').css('display', 'none');
                    //$('#tr_semester_marks_avg').css('display', 'none');
                    //$('#div_white_space').css('height', '84px');

                    $('#div_grade_range_' + obj_stud_detail[0]["year_code"] + '_onward table tbody tr th').css('width', '10%');
                    //$('#div_grade_range_' + obj_stud_detail[0]["year_code"] + '_onward table tbody tr th').css('text-align', 'center');
                    $('#div_grade_range_' + obj_stud_detail[0]["year_code"] + '_onward table tbody tr td').css('width', '5%');
                    $('#div_grade_range_' + obj_stud_detail[0]["year_code"] + '_onward table tbody tr td').css('text-align', 'center');
