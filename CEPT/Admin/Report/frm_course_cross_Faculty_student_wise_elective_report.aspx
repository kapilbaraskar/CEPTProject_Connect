<%@ Page Title="Cross Allocation Elective" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="frm_course_cross_Faculty_student_wise_elective_report.aspx.cs" Inherits="Admin_Report_frm_course_cross_Faculty_student_wise_elective_report" %>
    ...
    <script type="text/javascript">
        ...
        function retrieve_Data() {
            ...
            $.ajax(
            {
                ...
                url: "../../WebService.asmx/get_course_cross_Faculty_student_wise_Elective",
...
<div class="row-fluid">
        <div class="page-header position-relative">
            <h1>
                <i class="icon-desktop"></i>&nbsp; Cross Allocation Elective
            </h1>
        </div>
    </div>
