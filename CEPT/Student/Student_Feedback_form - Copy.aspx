...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="../Js/feedbackform.js" type="text/javascript"></script>
    <style>
        .row_selected tr
        {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="divlecture" class="row-fluid" style="font-family: Calibri; font-size: 16px;
        ...
        <div class="tab-content" style="width: 98%; float: right">
            ...
            <p>
                Please provide reasoned opinions to the following questions.
            </p>
            <p>
                    ...
                    <thead>
                        <tr class="table_header">
                            ...
                            <td rowspan="2" style="padding-top: 20px;" align="center" valign="middle">
                                <b>Your answers to questions 1-8 will be useful for assessing the value of this course.</b>
                                <br />
            ...
            <div style="height: 10px; background-color: #e4e6e9;">
            </div>
            <%-- <h1><hr /></h1>--%>
           ...
           <%-- <div>
            ...
            <div id="div_AA_instructor_selection" style="display: none;">
                <p class="instructor_feedback_lable">
                    <br />
                    <b>3. Feedback : Academic Associate </b>
                </p>
            </div>

            <div id="div_AA_instructor" style="display:none;" >
