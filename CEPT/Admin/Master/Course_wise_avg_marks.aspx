<%@ Page Title="Grade Range" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="Course_wise_avg_marks.aspx.cs" Inherits="Admin_Master_Course_wise_avg_marks" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="../../Js/course_wise_avg_marks.js?t=09032022" type="text/javascript"></script>
    <%--30102018--%><%--12022021--%><%--11032021--%><%--27122021--%>
