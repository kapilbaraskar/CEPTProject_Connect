<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="student_course_registration_report.aspx.cs" Inherits="Admin_Report_student_course_registration_report" %>
  ...
  <div class="row-fluid">
        ...
        <div>
            ...
            <div id="DataList" class="panel panel-default" style="display: none">
                ...
                <div class="panel-heading">
                <strong id="panel_head">Student Course Registration Details</strong>
            </div>
                <div>
