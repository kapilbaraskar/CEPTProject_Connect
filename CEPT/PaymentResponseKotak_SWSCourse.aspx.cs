...
public partial class PaymentResponseKotak_SWSCourse : System.Web.UI.Page
{
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    if (UID != null)
                    {
                        ...
                        {
                            Log.PaymentTransactionLog("SWSCourse Fees Payment paymentSuccess " + paymentResponse.status);
                            ...
                            //bool status = objGetMasterDetails.sws_course_allocation_dtl(userid, transactionid);
                ...
                try
                {
                    ...
                    {
                        Log.PaymentTransactionLog("First Step SWSCourse Payment Fail Email " + paymentResponse.status);
                        Masters objGetMasterDetails = new Masters();
