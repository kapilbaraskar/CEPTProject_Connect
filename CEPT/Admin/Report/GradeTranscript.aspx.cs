...
public partial class Admin_Report_GradeTranscript : System.Web.UI.Page
{
    ...
    protected void Download_Student_Grade_Report(object sender, EventArgs e)
    {
        try
        {
            ...
            if (status == "false")
            {
                //obReportPrinter.PageFile = HttpContext.Current.Request.Url.Scheme + "://" + str_path + "New_GradeTranscriptPDF_UG_10sem.aspx?uid=" + student_code + "&sem=" + sem + "&year=" + year + "&new_tab=" + 'N';
