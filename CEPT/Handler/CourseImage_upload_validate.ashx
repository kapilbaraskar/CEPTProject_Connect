<%@ WebHandler Language="C#" Class="CourseImage_upload_validate" %>

using System;
using System.Web;

public class CourseImage_upload_validate : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    int mFileSize = 0;
    string msg = "";
