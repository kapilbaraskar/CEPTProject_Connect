<%@ WebHandler Language="C#" Class="project_final_report_upload" %>

using System;
using System.Web;

public class project_final_report_upload : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
            ...
            string Serverpath = System.Configuration.ConfigurationManager.AppSettings["project_final_report_path"];

            if (context.Request.Files.Count > 0)
            {
                var postedFile = context.Request.Files[0];
               
                string filesize = System.Configuration.ConfigurationManager.AppSettings["project_final_report_MaxSize"];
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    finalFileName = user_id + "." + file.Split('.')[1];
