<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Fees_installment_pay_in_slip_kotak.aspx.cs" Inherits="Student_Fees_installment_pay_in_slip_kotak" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('.cls_bank_img').attr('src', '../image/kotakbanklogo_orgnl.jpg');
            $('.cls_bank_img').css('width', '145px');
            $('.cls_bank_img').css('margin-top', '-5px');
            $('.cls_bank_img').css('margin-left', '-65px');

            $.ajax({
                type: "POST",
                url: "../WebService.asmx/get_user_data_for_pay_slip_kotak",
                data: "{}",
                ...
                success: function (data) {
                    if (data.d != "") {
                        ...
                        $('.lbl_name_of_institute').text(user_data[0]["institution_name"]); //change for foren student 
                        $('.lbl_pan_no').text('AAAJC0452C');
                        $('.lbl_sem_code').text(user_data[0]["semester_code"]);
                        $('.lbl_payslip_number').text(user_data[0]["payslip_number"]);
                        $('.lbl_bank_code').text(user_data[0]["bank_acc_no"]);
                    ...
                    if (data.d != '' && data.d != '[]') {
                        ...
                        if (fees_detail["status"] == 'True') {
                            ...
                            if (fees_data["installment_status"] != 'Y' && fees_data["installment_status"] != 'N') {
                                ...
                                //Added Fees Fine Logic - Start
                                var amount_final = 0;
                                if (fees_data["installment" + cur_installment + "_fine"] == "" || fees_data["installment" + cur_installment + "_fine"] == null)
                                {
                                    amount_final = parseInt(fees_data["installment" + cur_installment]);
                                }
                                else
                                {
                                    amount_final = parseInt(fees_data["installment" + cur_installment]) + parseInt(fees_data["installment" + cur_installment + "_fine"]);
                                }

                                //$('.cls_cur_installment_amount').html(fees_data["installment" + cur_installment]);
                                $('.cls_cur_installment_amount').html(amount_final);

                                //$('.lbl_amount1').text(fees_data["installment" + cur_installment]);
                                $('.lbl_amount1').text(amount_final);

                                //var rupees = convert_number(fees_data["installment" + cur_installment]);
                                var rupees = convert_number(amount_final);

                                //Added Fees Fine Logic - End
    ...
    <div id="main_fees" align="center" x:publishsource="Excel" style="display: none">
        <table border="0" cellpadding="0" cellspacing="0" width="1454" class="xl6512954"
            ...
            <tr class="xl6512954" height="16" style='height: 12.0pt'>
                ...
                <td colspan="16" style='border-left: none; width: 374pt; padding-left: 102px;'>
                    <center>Bank's Copy</center>
                </td>
            </tr>
            <tr class="xl6512954" height="21" style='mso-height-source: userset; height: 16.35pt'>
                ...
                <td rowspan="3" height="51" width="99" style='height: 40.05pt; width: 74pt' align="left"
                    ...
                    <![if !vml]><span style='mso-ignore: vglayout; position: absolute; z-index: 1; margin-left: 2px;
                        ...
                        <img style="margin-top: 7px; margin-left: -33px;" class="cls_bank_img" />
            ...
            <tr class="xl6512954" height="15" style='mso-height-source: userset; height: 11.85pt'>
                <td colspan="14" rowspan="2" height="30" class="xl10712954" style='height: 23.7pt;padding-left: 40px;'>
                    Ahmedabad
                </td>
                <td colspan="14" rowspan="2" class="xl10712954" style="padding-left: 40px;">
                    Ahmedabad
                </td>
                <td colspan="14" rowspan="2" class="xl10712954" style="padding-left: 40px;">
                    Ahmedabad
...
<label class="lbl_payslip_number">
            ...
            <tr height="40" style='mso-height-source: userset; height: 30.0pt'>
                <td colspan="16" height="40" width="475" style='height: 30.0pt; width: 356pt' class="style56">
                   Note:DD has to be drawn in favor of <span class="cls_account_name" style='mso-spacerun: yes'>&nbsp; </span>
                </td>
                <td colspan="16" width="480" style='width: 361pt' class="style56">
                   Note:DD has to be drawn in favor of <span class="cls_account_name" style='mso-spacerun: yes'>&nbsp; </span>
                </td>
