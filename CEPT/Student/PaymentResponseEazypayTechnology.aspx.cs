...
public partial class Student_PaymentResponseEazypayTechnology : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            //    Log.PaymentTransactionLog("" + str_request[i] + Environment.NewLine);
            //}
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    if (Session["SessionId"] != null && Session["UserId"] != null)
                    {
                        ...
                        string message = objPayment.SavePaymentDetails_Eazypay(Request, ref paymentResponse, "5");// 5 = Technology
