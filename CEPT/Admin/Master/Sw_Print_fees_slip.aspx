<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sw_Print_fees_slip.aspx.cs" Inherits="Admin_Master_Sw_Print_fees_slip" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: "../../WebService.asmx/Get_sws_fees_payment_receipt",
                data: "{}",
        ...
        function createPaySlip(sem_code, year_code) {
            for (var i = 0; i < installment_data.length; i++) {
                ...
                var return_date = splitdate(fees_data["fees_paid_date"]);
                ...
                else if (fees_data["Citrus_TxGateway"] == "Kotak" || fees_data["Citrus_TxGateway"] == "Kotak API") {
                    if (fees_data["Citrus_TxGateway"] == "Kotak API") {
                        $('#div_temp_payslip .cls_BankName td:nth-child(2)').text('Kotak');

                    }
                    else { $('#div_temp_payslip .cls_BankName td:nth-child(2)').text(fees_data["Citrus_TxGateway"]); }
                ...
                if (installment_data[i]['semester_type'] == 'S') {
                    $('.s_type').text("Spring");
                }
                else {
                    $('.s_type').text("Winter");
                ...
                $('.y_code').text(installment_data[i]['year_semester']);
                ...
                //{
                    debugger;
                    setCellData('cls_StudentCode', installment_data[i]['user_id']);
                    ...
                    {
                        $('#div_temp_payslip .cls_Amount td:nth-child(2)').text(fees_data["total_amount"] + "/-");
                        rupees = 'Rupees ' + convert_number(fees_data["total_amount"]) + ' Only';
                    }
    ...
    <div id="div_blank_payslipp" style="display: none;">
        <div>
            <div style="width: 45%; float: left; padding: 1%;">
                ...
                <div style="font-size: 18px;">
                    <table cellpadding="5" style="border-spacing: 0px !important; width: 100%;">
                        ...
                        <tr class="cls_Amount">
                            <td style="border-bottom: none !important;">Amount</td>
            ...
            <div style="width: 45%; float: right; padding: 1%;">
                ...
                <div style="font-size: 18px;">
                    <table cellpadding="5" style="border-spacing: 0px !important; width: 100%; padding-right: 4px;">
                        <tr class="cls_StudentCode">
                            <td style="width: 155px;">Student Code</td>
                            <td></td>
                        </tr>
