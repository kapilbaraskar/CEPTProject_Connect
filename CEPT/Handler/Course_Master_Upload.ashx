<%@ WebHandler Language="C#" Class="Course_Master_Upload" %>

using System;
using System.Web;

public class Course_Master_Upload : IHttpHandler {
        ...
        try
        {
            ...
            else
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = "";//web.ExcelFileToDatatable_upload_course_master(file, context);
