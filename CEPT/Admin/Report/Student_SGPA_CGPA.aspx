<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="Student_SGPA_CGPA.aspx.cs" Inherits="Admin_Report_Student_SGPA_CGPA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>
                <i class="icon-desktop"></i>&nbsp; Students SGPA CGPA
            </h1>
        </div>
    </div>
    ...
    <div class="well" style="background-color: White;">
        ...
        <div id="div_course_list" class="panel panel-default" style="display: none;">
            <div class="panel-heading">
                <strong>Student SGPA CGPA</strong>
            </div>
