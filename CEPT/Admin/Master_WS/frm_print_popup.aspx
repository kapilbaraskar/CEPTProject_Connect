<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_print_popup.aspx.cs" Inherits="Admin_Master_frm_print_popup" %>
...
<![endif]-->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            // var student = "UP0812";
            var fees = getParameterByName('amount');
            var student_name = getParameterByName('student_name');
            var fees_type = getParameterByName('fees_type');

            var trans_id = getParameterByName('trans_id');
            ...
            if (student != "") {
                ...
                $('.lbl_student_name').text(student_name);
                ...
                $('.lbl_amount1').text(fees);
                var rupees = convert_number(fees);
                $('.lbl_amount_in_word1').text(rupees + ' ' + 'Only');

//                $('.lbl_amount1').text("22500");
//                var rupees = convert_number("22500");
//                $('.lbl_amount_in_word1').text(rupees + ' ' + 'Only');

                if (fees_type == 'online') {

                    //$('#online_trans').css('display', 'block');
                    $('.lbl_trans_id').text(trans_id);
                    $('.lbl_trans_name').text('Transaction Id');
                    $('.lbldateofdeposit').text(date);
                }
                else {
                    $('.lbl_trans_id').text('');
                    $('.lbl_trans_name').text('');
                    //  $('#online_trans').css('display', 'none');
                   ...
                   /// $('.lbldateofdeposit').text("25/2/2015");
