<%@ WebHandler Language="C#" Class="feedback_disable" %>
...
public class feedback_disable : IHttpHandler, IReadOnlySessionState {
        ...
        try
        {
            ...
            else
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = web.ExcelFileToDatatable_upload_feedback_disable(file, context);
