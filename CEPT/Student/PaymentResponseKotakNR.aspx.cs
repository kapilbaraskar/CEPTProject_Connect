...
public partial class Student_PaymentResponseKotakNR : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            string encResponse = ccaCrypto.Decrypt(Request.Form["enc_response"], workingKey);
            ...
            Log.PaymentTransactionLog("Payment Response From Kotak. ");
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    paymentResponse.data.payment_mode = "NEFT/RTGS";//Netbanking

                    if (Params["status"] != null)
                    {
                        Log.PaymentTransactionLog("transaction id on cancel payment  : " + Params["status"]);
                    }
