<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Print_fees_fine_pay_in_slip.aspx.cs" Inherits="Admin_Master_Print_fees_fine_pay_in_slip" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: "../../WebService.asmx/get_fine_fees_installment_dtl_all",
