<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageDesign.master" AutoEventWireup="true" CodeFile="Alumni_View_job.aspx.cs" Inherits="Student_Alumni_View_job" %>
            ...
            <div class="panel panel-default ">
                ...
                <div class="container" style="margin-left: 20px; ">
                    ...
                    <div class="row" style="padding-left: 20px;">
                        <div class="col-md-10">
                            <hr style="width: 85%;" />
                            <b><span class="txt_job_title"></span></b><br />
                    ...
                    <div class="row" style="padding-left: 20px;">
                        <div class="col-md-10">
                            ...
                            <span id="lbl_contact_person"></span>
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-left: 20px;">
                        <div class="col-md-10">
                            <hr style="width: 85%;" />
                            <b><span>Email Id</span></b>
                            <span id="lbl_email_id"></span>
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-left: 20px;margin-bottom: 20px;">
                        <div class="col-md-10">
                            <hr style="width: 85%;" />
                            <b><span>Contact No</span> <i class="fa fa-phone" aria-hidden="true"></i></b>
                            <span id="lbl_contact_no"></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <input type="hidden" id="hdn_doc_no" />
     ...
     <script type="text/javascript">
         ...
         function display_data(data) {
             ...
             $("#img_path").attr("src", "http://alumni.cept.ac.in/image/" + data[0].image_path);
         }
         ...
         function PageLogActivite(no) {

             var obj_data = {};
             obj_data.jobid = no;
             obj_data.pagename = "AlumniViewJob.aspx";
