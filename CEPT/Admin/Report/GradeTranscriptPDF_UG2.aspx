<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GradeTranscriptPDF_UG2.aspx.cs" Inherits="Admin_Report_GradeTranscriptPDF_UG2" %>
            ...
            if (obj_course_detail != null && obj_course_detail != undefined) {
                ...
                for (var cur_table = 1; cur_table < total_table; cur_table++) {
                    if (sem_cnt < obj_course_detail.length) {
                        var strTableCourseDetail = "<tr><th style='width:10px;'>COURSE CODE</th><th>COURSE TITLE</th>" +
                        ...
                        for (var cur_sem = sem_cnt; cur_sem < (sem_cnt + 2); cur_sem++) {
                            ...
                            if (obj_course_detail[cur_sem]['course_detail'] != '') {
                                ...
                                if (cur_sem_courses[0]['semester_type'] == 'M') {
                                    strTableCourseDetail = strTableCourseDetail + "<tr><td colspan=5 style='border-left:1px solid black;'><b>Monsoon ";
                                    ...
                                    strTableCourseDetail = strTableCourseDetail + "<tr><td colspan=5 style='border-left:1px solid black;'><b>Spring ";
                                    strTableCourseDetail = strTableCourseDetail + cur_sem_courses[0]['year_semester'].toString() + "-" + (parseInt(cur_sem_courses[0]['year_semester'].toString()) + 1).toString().substr(2, 2) + "</b></td></tr>";
                                }
                            ...
                            //                            if (obj_course_detail[cur_sem]['course_detail'] == '') {
                            //                                if (cur_sem % 2 == 0) {
                            //                                    var row_length = $('#tbl_course_marks1 tr').length - $('#tbl_course_marks' + cur_table + ' tr').length;
                            ...
                            if (obj_course_detail[cur_sem]['credit_detail'] != '') {
                                ...
                                strTableCourseDetail = strTableCourseDetail + "<tr>" +
                                            "<td style='text-align: center;' colspan=2><b>SEMESTER AGGREGATE</b></td>"; //<td></td>";
                                ...
                                if (cur_sem_credit_dtl[0]['semester_marks_avg'].toString() == '-') {
                                    ...
                                    if (obj_stud_detail[0]["year_code"] < 'Y2014')
                                        strTableCourseDetail = strTableCourseDetail + "<td style='text-align: center;'><b>" + parseFloat(cur_sem_credit_dtl[0]['semester_marks_avg']).toFixed(1) + "</b></td><td></td>"; //<td></td>";
                                    else
                                        strTableCourseDetail = strTableCourseDetail + "<td style='text-align: center;'><b>" + parseFloat(cur_sem_credit_dtl[0]['semester_marks_avg']).toFixed(1) + "</b></td><td></td>"; //<td></td>";
                                }
                        ...
                        $('#tbl_course_marks' + cur_table).html(strTableCourseDetail);
                        $('#tbl_course_marks' + cur_table + ' tr th').css('font-size', '14px');
                        $('#tbl_course_marks' + cur_table + ' tr td').css('font-size', '14px');
                        $('#tbl_course_marks' + cur_table + ' tr th').css('padding-top', '1px');
                        $('#tbl_course_marks' + cur_table + ' tr th').css('padding-bottom', '1px');
                        $('#tbl_course_marks' + cur_table + ' tr td').css('padding-top', '0px');
                        $('#tbl_course_marks' + cur_table + ' tr td').css('padding-bottom', '2px');
                        $('#tbl_course_marks' + cur_table + ' th,#tbl_course_marks' + cur_table + ' td').css('font-size', '11px');
                        $('#tbl_course_marks' + cur_table + ' th,#tbl_course_marks' + cur_table + ' td').css('padding', '1px 1px 1px 1px');
                        $('#tbl_course_marks' + cur_table + ' th,#tbl_course_marks' + cur_table + ' td').css('line-height', '16px');
                ...
                for (var row = 0; row < $('#tbl_course_marks1 tr').length; row++) {
                    var max_height = 0;
                    for (var j = 1; j <= 5; j++) {
                        if ($('#tbl_course_marks' + j + ' tr').length > 0 && $('#tbl_course_marks' + j + ' tr')[row].children.length > 0) {
                            if ($('#tbl_course_marks' + j + ' tr')[row].children[0].offsetHeight > max_height) max_height = $('#tbl_course_marks' + j + ' tr')[row].children[0].offsetHeight;
                        }
                    }

                    for (var j = 1; j <= 5; j++) {
                        if ($('#tbl_course_marks' + j + ' tr').length > 0 && $('#tbl_course_marks' + j + ' tr')[row].children.length > 0) {
                            //$('#tbl_course_marks' + j + ' tr')[row].children[0].height = max_height;

                            //var str_height = "" + $('#tbl_course_marks' + j + ' tr')[row].children[0].offsetHeight + "/" + max_height;
                            //$('#tbl_course_marks' + j + ' tr')[row].children[0].innerHTML = str_height;

                            if (max_height < 67) $('#tbl_course_marks' + j + ' tr')[row].children[0].style.height = "" + (max_height - 27) + "px";
                            else if (max_height < 70) $('#tbl_course_marks' + j + ' tr')[row].children[0].style.height = "" + (max_height - 30) + "px";
                            else if (max_height < 87) $('#tbl_course_marks' + j + ' tr')[row].children[0].style.height = "" + (max_height - 45) + "px";
                            else $('#tbl_course_marks' + j + ' tr')[row].children[0].style.height = "" + (max_height - 61) + "px";
                        }
                    }
                }
            }
...
<body style="color:Black;padding-left:1%;padding-right:1%;">
    ...
    <div>
        ...
        <table id="tbl_student_detail" class="table table-condensed">
            ...
            <tr>
                <td style="border:none;width:240px;"><b>AGGREGATE PERCENTAGE MARKS</b></td>
                <td style="border:none;width:10px;"> : </td>
                <td id="td_aggre_per_marks" style="border:none;"></td>
    ...
    <div>
        <table id="tbl_course_marks1" class="table table-bordered" style="margin-bottom: 0px;border-right:1px solid black;width:25%;float: left;">
            <tr>
                <th>COURSE CODE</th>
        ...
        <table id="tbl_course_marks2" class="table table-bordered" style="margin-bottom: 0px;border-right:1px solid black;width:25%;float: left;margin-left: 0px;">
        </table>

        <table id="tbl_course_marks3" class="table table-bordered" style="margin-bottom: 0px;border-right:1px solid black;width:25%;float: left;margin-left: 0px;">
        </table>

        <table id="tbl_course_marks4" class="table table-bordered" style="margin-bottom: 0px;border-right:1px solid black;width:25%;float: left;margin-left: 0px;">
        </table>
