<%@ WebHandler Language="C#" Class="Drp_Dtl_Upload" %>

using System;
using System.Web;

public class Drp_Dtl_Upload : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
        ...
        try
        {
            ...
            else
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = web.ExcelFileToDatatable_upload_drp_dtl(file, context);
