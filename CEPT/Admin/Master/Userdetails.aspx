<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="Userdetails.aspx.cs" Inherits="Admin_Master_Userdetails" %>
                ...
                <div class="panel panel-default ">
                    <div style="padding: 15px;">
                        ...
                        <table id="tbl_personal_detail1" style="width: 100%;">
                            ...
                            <tr>
                                <td>Nationality</td>
                                <td><span id="txt_nationality"></span></td>
                                <td style="width: 20%;">Passport no</td>
                                <td style="width: 30%;"><span id="txt_passport_no"></span></td>
                            </tr>

                            <tr>
                                <td>Highest Qualification</td>
                                <td><span id="txt_hig_qua"></span></td>
                                <td style="width: 20%;padding-bottom: 20px;">Total Years of Experience</td>
                                <td style="width: 30%;padding-bottom: 20px;"><span id="txt_total_experience"></span></td>
                            </tr>

                            <tr>
                                <td style="width: 20%;padding-bottom: 10px;">Aadhaar No</td>
                                <td style="width: 20%;padding-bottom: 10px;"><span id="txt_aadhar_no"></span></td>
