<%@ Page Title="Add New Course" Language="C#" MasterPageFile="~/AdminCEPT.master"
    AutoEventWireup="true" CodeFile="frmcoursemaster_add.aspx.cs" Inherits="Admin_Master_frmcoursemaster_add" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="../../Js/course_master_add.js?t=13032025" type="text/javascript"></script>
    <%--27112019--%><%--06052020--%><%--08062020--%>
    <%--31072019--%>
  ...
  <%--  <script src="../../Js/multiselect-dropdown.js"></script>--%>
   <%-- <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js" integrity="sha384-p34f1UUtsS3wqzfto5wAAmdvj+osOnFyQFpp4Ua3gs/ZVWx6oOypYoCJhGGScy+8" crossorigin="anonymous"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function add_multiple_dropdown()
        {
            var strs = "<tr><td> <select id='11' class='js-select2-multi' multiple='multiple' >";//class='js-select2-multi' multiple='multiple'
            strs += "<option>A</option>";
            strs += "<option>B</option>";
            strs += "<option>C</option>";
            strs += "<option>D</option>";
            strs += "<option>10:30-11:00  - Tuesday- FP201 Hall</option></select></td></tr>";

            $("#tbody_tblinstructor_time_slot").append(strs);
            //var data = {
            //    id: 1,
            //    text: 'Barn owl'
            //};
            ...
            //$('#11').append(newOption).trigger('change');
            $("#11").select2({
                tags: true,
                multiple:true
           ...
           //$("#tbody_tblinstructor_time_slot").append(strs).trigger('change');;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>
                <i class="icon-desktop"></i> Add New Course
            </h1>
        </div>
    </div>
    <div class="" style="background-color: White;">
        <div class="panel panel-default ">
            <div class="panel-heading">
                ...
                <%--< Comment By Ananth>--%>
                <strong><span class="panel-headingfont">Course Data</span></strong>
            </div>
            <div style="padding: 15px;" id="div3">
                <%--<div class="row">
                    <div class="form-group col-md-5" style="margin-bottom: 10px;">
                        Previous Year Semester : <span id="spnprevsem"></span>
                    </div>
                </div>--%>
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div id="div_cur_sem_course" class="col-md-9" style="padding: 0 0 0 0;">
        ...
        <div class="panel panel-default" id="admin_rights">
            <div class="panel-heading">
                <input type="checkbox" id="previous_semester" style="margin-top: -2px!important;" />&nbsp;<strong><span class="panel-headingfont">Check & Select Semester and Year to Add Course in Previous Semester</span></strong>
            </div>
            <div style="padding: 10px; overflow: visible;" id="prev_data" class="panel-collapse collapse in">
                <div class="row">
                    <div class="form-group col-md-4">
                        <div class="col-md-5" style="padding: 0 0 0 0; margin-top: 4px;">
                            Previous Semester :
                        </div>
                        <div class="col-md-4" style="padding: 0 0 0 0;">
                            <select class="chosen-select" id="prev_drpsemester">
                            </select>
                        </div>
                    </div>
                    <div class="form-group col-md-3">
                        ...
                        <div class="col-md-4" style="padding: 0 0 0 0;">
                            <select class="col-md-8" id="prev_drpyear" style="width: 222%!important;">
                            </select>
                        </div>
                    </div>
                </div>
        ...
        <div class="panel panel-default ">
            <div class="panel-heading">
                <strong><span class="panel-headingfont">New Course Data &nbsp;( Program Coordinator
                    Panel )</span></strong>
            </div>
            <div style="padding: 10px; overflow: visible;" id="div_progcoord_panel" class="panel-collapse collapse in">
                <div>
                    <table style="width: 100%;" cellpadding="10" cellspacing="20">
                        ...
                        <%-- onkeypress='return IsNumeric_istructor_credits(event);' onInput='edValueKeyPress_tutorial(this)'<tr>
                            <%--  <td>
                        ...
                        <tr>
                            ...
                            <td class="cls_tutorial_offered" style="display: none;">
                                ...
                                <input type="radio" name="rdo_tutorial_offered" value="N" onclick="rdo_tutorial_click()"
                                    checked="checked" />&nbsp;No
                            </td>
                            ...
                            <td class="gpa_nongpa" style="vertical-align: top; padding-right: 0px; display: none;">GPA/Non-GPA<span class="cls_mendatory" style="display: none; color: Red;">*</span>
                            </td>
                            <td class="gpa_nongpa" style="display: none;">
                                <select class="chosen-select" id="drp_gpa_ngpa">
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <%--<td style="vertical-align: top; padding-right: 0px;">Course Expense<span class="cls_mendatory" style="display: none; color: Red;">*</span>
                            </td>
                            <td>
                            ...
                            <%-- <td class="cls_studio_mode" style="display: none;vertical-align: top; padding-right: 0px;">
                                <span>Mode of Studio</span><span class="cls_mendatory" style="display: none; color: Red;">*</span>
                            </td>
                            <td class="cls_studio_mode" style="display: none;">
                                <select class="chosen-select" id="studio_mode">
                        ...
                        <tr id="tutor_type_select" style="display:none;">
                            <td class="cls_select_type">Course has tutorial Hours
                            </td>
                            <td class="cls_select_type">
                                <input type="radio" id="rdo_t" name="rdo_select_type" value="Y" />&nbsp;Yes&nbsp;&nbsp;
                                <input type="radio" id="rdo_ta" name="rdo_select_type" value="N" checked="checked" />&nbsp;No
                            </td>

                        </tr>

                        <tr id="tutor_type_select_ta" style="display:none;">
                            <td class="cls_select_type_ta">Course Required TA
                            </td>
                            <td class="cls_select_type_ta">
                                <input type="radio" id="rdo_ta_y" name="rdo_select_type_ta" value="ta_y" />&nbsp;Yes&nbsp;&nbsp;
                                <input type="radio" id="rdo_ta_n" name="rdo_select_type_ta" value="ta_n" checked="checked" />&nbsp;No
                            </td>

                        </tr>

                        <tr id="studio_type_select" style="display:none;">
                            <td class="cls_select_dual_type">Select Studio Type
                            </td>
                            <td class="cls_select_dual_type">
                                <input type="radio" id="rdo_s" name="rdo_select_studio_type" value="S" />&nbsp;Single&nbsp;&nbsp;
                                <input type="radio" id="rdo_d" name="rdo_select_studio_type" value="D" />&nbsp;Dual
                            </td>

                        </tr>
                        <tr>
                            <td colspan="7">
                        <p id="single_show" style="color:blue; display:none;"><span style="color:red">Note 1 :</span> Contact Hours for Single tutor Studio: Contact hours- 288 (15hr/week for 12 week & 18hr/week for 6 weeks) and 94 preparatory hours.Total hours are 382.</p>
                        <p id="dual_show" style="color:blue; display:none;"><span style="color:red">Note 1 :</span> Contact Hours for Dual tutor Studio: . Contact hours-180 (9 hr/week for 12 week & 12 hr./week for 6 weeks) and 47 preparatory hours. Total hours are 227.</p>
                            </td>
                        </tr>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-9">
                            <textarea id="txt_evalmethod" style="width:100%"" rows="6" cols="50" name="address"></textarea>
                        </div>--%>
                        <%--<div class="form-group col-md-2">
                            Add Student Prep/Self Study Hours :
                        </div>
                        <div class="form-group col-md-2">
                            <input type="text" id="txt_prep_self_hrs" class="marg-btm txtwidth" onkeypress='return IsNumeric(event);'/>
                        </div>--%>
                    ...
                    <%--<div class="row">
                        ...
                        <div class="form-group col-md-9">
                           <textarea id="txtremarks" style="width:100%"" rows="6" cols="50" name="address"></textarea>
                        </div>
                    </div>--%>
                </div>
                <div class="row" style="display: block; width: 100%;">

                     <div class="row-fluid" id="datalist_timeday" style="margin-top: 50px; margin-left: 2%; float: left; margin-bottom: 12px; width: 37%; display: block;">
                ...
                <div style="display: block; width: 100%;">
                    <div class="row-fluid" id="dataList_instructor" style="margin-top: 50px; float: left; width: 31%; display: block;">
                        <div class="box-content box-no-padding">
                            <button class="btn  btn-primary" type="button" id="btn_instructor">
                                <i class="icon-plus"></i>&nbsp;Add Instructor
                            </button>
                             <div id="course_panel_show" style="width: 316%; display:none;"> <span style="color:red;"> Note 2 :</span><b> You can edit the contact hours, weeks, and additional hours. In case of dual tutor, Kindly edit and distribute the additional hours according to tutors contact hours.</b></div>
                        </div> 
                        <table class="data-table table table-bordered table-striped" border="0" id="tblinstructor"
                            style="width: 320% !important">
                            <thead>
                                <tr>
                                    <th style="width: 25%;">Instructor
                                    </th>
                                    <th style="width: 21%;">Unit
                    ...
                    <div class="row-fluid" id="datalist_area" style="margin-top: 50px; margin-left: 6%; float: left; width: 26%;">
                        ...
                        <%--<div class="form-group col-md-9" style="padding-left: 0px;padding-right: 0px;">
                            Add Student Preparatory/Self Study hr/week :
                        </div>
                    ...
                    <div class="panel panel-default ">
                        ...
                        <div style="padding: 15px;">
                            ...
                            <div class="row-fluid" id="datalist_timeday_tutorial" style="margin-left: 1%; float: left; margin-bottom: 12px; width: 36%;">
                                ...
                                <table class="data-table table table-bordered table-striped" border="0" id="tbltimeday_tutorial"
                                    style="width: 118%;">
                                    <thead>
                                        <tr>
                                            <th>From Time
                    ...
                    <div class="panel panel-default ">
                        ...
                        <div style="padding: 15px;">
                            <div class="row-fluid" id="dataList_instructor_aa" style="float: left; width: 45%;">
                                <div class="box-content box-no-padding">
                                    <button class="btn btn-primary" type="button" id="btn_instructor_aa" disabled>
                            ...
                            <div class="row-fluid" id="dataList_instructor_ta" style="margin-left: 1%; float: left; margin-bottom: 12px; width: 45%;">
                                <div class="box-content box-no-padding">
                                    <button class="btn btn-primary" type="button" id="btn_instructor_ta" disabled="disabled">
        ...
        <div class="panel panel-default ">
            <div class="panel-heading">
                <strong><span class="panel-headingfont">New Course Data &nbsp;( Instructor Panel )</span></strong>
            </div>
               ...
               <%-- <div class="box-content box-no-padding">
                ...
                <div class="panel panel-default ">
                    ...
                    <div class="panel-body">
                        <div id="studio_panel_showing" style="display:none;">
                ...
                <div class="panel panel-default ">
                    <div class="panel-heading">
                        <%--<b>Course Catalog Information</b>--%>
                        <b>Course Detail</b>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="row" style="margin-top: 15px;">
                            <div class="form-group col-md-2 color-blue cls_studio_mode" style="vertical-align: top; padding-right: 0px;">
                                <span>Mode of Teaching</span><span class="cls_mendatory" style=" color: Red;">*</span>
                            </div>
                            <div class="form-group col-md-9 cls_studio_mode">
                                <select class="chosen-select" id="studio_mode" style="margin-left: 2%;">
                                    <option value="">- Please Select Teaching Mode -</option>
                                    <option value="Online">Online</option>
                                   <%-- <option value="Partial On-Campus">Partial On-Campus</option>--%>
                                    <option value="Full On-Campus">Full On-Campus</option>
                            ...
                            <div class="form-group col-md-2 color-blue">
                                ...
                                (Max 150 words with space)<%--(Max. 170 to 200 words)--%><span class="cls_mendatory cls_mendatory_instructor" style="display: none; color: Red;">*</span>
                            ...
                            <div class="form-group col-md-9">
                                <textarea id="txtcourse_description" style="width: 100%; margin-bottom: 0px;" rows="6"
                                    cols="50" name="address" maxlength="13800"></textarea><%--onkeypress="charcount(event)" onkeydown="return keydown_removechar(event)"--%>
                            ...
                            <div class="form-group col-md-2 color-blue l2l3 l2l3l4">
                                Long Description
                                <br />
                                (Min 1100- Max 3000 characters with space) or (Approximately Min 220 - Max 600 Word with space)<%--Course Description--%><span class="cls_mendatory cls_mendatory_instructor" style="display: none; color: Red;">*</span>
                        ...
                        <div class="row studioprobstmnt" style="margin-top: 15px; display:none;">
                            <div class="form-group col-md-2 color-blue">
                                Problem Statement:
                                <br />
                ...
                <div class="panel panel-default ">
                    ...
                    <div class="panel-body">
                        ...
                        <br /><%--//../../StudioDetails/Mode-of-Teaching-v3.pdf--%>
                        <br />
                        <div class="row">
                            <div class="form-group col-md-2 color-blue">
                    ...
                    <div class="panel-body">
                        <%--<div class="row">
                            <div class="form-group col-md-2 color-blue l2l3">
                                Long Description Course Description <span class="cls_mendatory cls_mendatory_instructor" style="display: none; color: Red;">*</span>
                                <%--<p style="color: Red;">(Please insert NA for L2-L3 studios) NA-Not Applicable</p>
                            </div>
                        ...
                        <div id="div_weekly_plan" style="display: none;">
                            ...
                            <div id="div_week_title" class="row" style="margin-bottom: 10px; margin-top: 10px;">
                                <div class="form-group col-md-12">
                                    ...
                                    <%--<div id="div_ref_title" class="form-group txtwidth" style="float: left; text-align: center;display:none">
                                        Reference
                                    </div>--%>
                                    ...
                                    <div id="div_assign_percentage" class="form-group txtwidth" style="float: left; text-align: center;">
                                        ...
                                        <br />
                                       <p class="txt_change_course">(70% Internal, 30% Portfolio for all programs)</p>
                        ...
                        <div class="row" style="margin-top: 10px; margin-bottom: 10px;">
                            <div class="form-group col-md-2 color-blue">
                                References/Reading (if any)<span class="cls_mendatory" style="display: none; color: Red;">*</span>
                            </div>
                            <div class="form-group col-md-9">
                ...
                <div class="panel panel-default" style="display: none;">
                    ...
                    <div class="panel-body">
                        <div class="row" style="margin-top: 10px;">
                            <div class="form-group col-md-2 color-blue">
                                Assessment Criteria, Break Up & Details of Assignments <span class="cls_mendatory cls_mendatory_instructor"
                ...
                <div id="div_tutor_profile" class="panel panel-default ">
                    <div class="panel-heading">
                ...
                <div id="div_course_image" class="panel panel-default" style="display: none;">
                    <div class="panel-heading">
                        ...
                        <span style="color: red; margin-left: 3px;">(The height has to be 600 pixels, but the width can vary.)</span>
                    </div>
                    <div class="panel-body">
                        <input type="button" id="btn_add_course_image" class="btn btn-primary" value="Add Image"
                            onclick="addCourseImage()" />
    ...
    <div>
        <input id="btn_show_modal" type="button" class="btn btn-primary" data-toggle="modal"
            data-target="#mynewModal" value="Add Exam" style="height: 40px; margin-top: -10px; display: none;" />
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button id="btn_modal_close" type="button" class="btn btn-default" data-dismiss="modal">
                            Close</button>
    ...
    <input type="hidden" id="hdn_s" />
    <input type="hidden" id="hdn_y" />
