<%@ Page Title="Faculty Information" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="Facultyinformation.aspx.cs" Inherits="Admin_Report_Facultyinformation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function type() {
            $('#drptype').empty().append($("<option></option>").val("").html("-- Please Type Semester --"));
            $('#drptype').append($("<option></option>").val("F").html("Faculty"));
            $('#drptype').append($("<option></option>").val("P").html("Program Coordinator"));
            $('#drptype').append($("<option></option>").val("D").html("Dean"));
        ...
        function total_assigned_report_data() {
            ...
            $.ajax({
                ...
                url: "../../WebService.asmx/Faculty_information_dtl_list",
                data: "{sem_code: '" + semester + "',year_code:'" + year_code + "',dept_code:'" + dept_code + "',prog_code:'" + prog_code + "',program_level_code:'" + prog_level_code + "',type:'" + type+"'}",
                dataType: "json",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>
                <i class="icon-desktop"></i>&nbsp;Faculty Information
            </h1>
        </div>
    </div>
    ...
    <div class="" style="background-color: White;">
        ...
        <div id="DataList" class="panel panel-default" style="display:none;margin-bottom:40px;">
            <div class="panel-heading">
                <strong id="panel_head">Faculty Information</strong>
            </div>
