...
public partial class Admin_Report_GradeTranscriptPDF_UG_10sem : System.Web.UI.Page
{
    ...
    public DataTable get_Student_transcript_dtl(string uid, string sem, string year)
    {
        ...
        try
        {
            ...
            cmd.CommandText = "select degree_mst.degree_name, student_transcript_dtl.* from student_transcript_dtl "
