<%@ WebHandler Language="C#" Class="Fee_Bank_Dtl_Upload" %>

using System;
using System.Web;

public class Fee_Bank_Dtl_Upload : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
        ...
        try
        {
            ...
            else
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = web.ExcelFileToDatatable_upload_fees_bank_dtl(file, context);
