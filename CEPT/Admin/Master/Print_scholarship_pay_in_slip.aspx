<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Print_scholarship_pay_in_slip.aspx.cs" Inherits="Admin_Master_Print_scholarship_pay_in_slip" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>ScholarShip Payslip</title>
    ...
    <script type="text/javascript">
        ...
        function createPaySlip(sem_code, year_code) {
            for (var i = 0; i < installment_data.length; i++) {
                ...
                $('#div_temp_payslip .cls_StudentName td:nth-child(2)').text(fees_data["full_name"]);
                //$('#div_temp_payslip .cls_StudentCode td:nth-child(2)').text(fees_data["user_id"]);
                ...
                $('#div_temp_payslip .cls_TransactionId td:nth-child(2)').text(fees_data["ref_no"]);
                //$('#div_temp_payslip .cls_DateofPayement td:nth-child(2)').text(": " + fees_data["created_date"]);
                var return_date = splitdate(fees_data["approve_date"]);
               ...
               // }
                //else {
                    setCellData('cls_StudentCode', fees_data["user_id"]);
                    ...
                    //if (installment_data.length == 1) {
                        $('#div_temp_payslip .cls_Amount td:nth-child(2)').text(fees_data["apprve_scholarship_amount"] + "/-");
                    rupees = 'Rupees ' + convert_number(fees_data["apprve_scholarship_amount"]) + ' Only';
                    //}
            ...
            <div style="width: 45%; float: left; padding: 1%;">
                ...
                <div style="font-size: 18px;">
                    <table cellpadding="5" style="border-spacing: 0px !important; width: 100%;">
                        ...
                        <tr class="cls_Amount">
                            <td style="border-bottom: none !important;">Scholarship Amount</td>
