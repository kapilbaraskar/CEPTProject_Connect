...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.d != "") {
                        ...
                        $('#lbldescription1').text(user_data[0]["account_name"]);
                        $('#lbldescription2').text(user_data[0]["account_name"]);
                        $('#lbldescription3').text(user_data[0]["account_name"]);

                        lbl_drawn3

                        $('#lbl_drawn1').text(user_data[0]["account_name"]);
                        $('#lbl_drawn2').text(user_data[0]["account_name"]);
                        $('#lbl_drawn3').text(user_data[0]["account_name"]);


                        $('#lblcode1').text(user_data[0]["bank_code"]);
                        $('#lblcode2').text(user_data[0]["bank_code"]);
                        $('#lblcode3').text(user_data[0]["bank_code"]);
                        ...
                        //                        $('#lblSemester1').text(user_data[0]["semester_code"]);
                        //                        $('#lblSemester2').text(user_data[0]["semester_code"]);
                        //                        $('#lblSemester3').text(user_data[0]["semester_code"]);
            ...
            $.ajax({
                type: "POST",
                url: "../WebService.asmx/Get_total_credits_for_pay_slip",
                data: {},
                contentType: "application/json",
                datatype: "json",
                async: false,
                success: function (data) {
                    ...
                    if (data.d != "") {
                        ...
                        if (fees_status[0]["credits"] != '') {


                            if (fees_status[0]["credits"] > 12) {

                                $('#lblamount1').text(user_data[0]["fees"]);
                                $('#lblamount2').text(user_data[0]["fees"]);
                                $('#lblamount3').text(user_data[0]["fees"]);

                                $('#lbltot_amount1').text(user_data[0]["fees"]);
                                $('#lbltot_amount2').text(user_data[0]["fees"]);
                                $('#lbltot_amount3').text(user_data[0]["fees"]);



                                var rupees = convert_number(user_data[0]["fees"]);
                                ...
                                $('#lblamount1').text(user_data[0]["fees"] / 2);
                                $('#lblamount2').text(user_data[0]["fees"] / 2);
                                $('#lblamount3').text(user_data[0]["fees"] / 2);

                                $('#lbltot_amount1').text(user_data[0]["fees"] / 2);
                                $('#lbltot_amount2').text(user_data[0]["fees"] / 2);
                                $('#lbltot_amount3').text(user_data[0]["fees"] / 2);

                                var rupees = convert_number(user_data[0]["fees"] / 2);
                    ...
                    <table class="style1">
                        ...
                        <tr>
                            <td height="50" style="border: thin solid #000000;">
                                ...
                                <label id="Label6" style="word-spacing: inherit; font-size: smaller">
                                </label>
                            </td>
                            <td height="50" style="border: thin solid #000000;">
                                <label id="lblcode1" style="font-size: smaller">
                                </label>
                                <label id="Label8" style="font-size: smaller">
                                </label>
                            </td>
                            <%-- <td height="50" style="border: thin solid #000000;">
            ...
            <td class="style56">
                <div style="width: 353px; height: 623px; background-color: #FFFFFF;">
                    ...
                    <table class="style1">
                        ...
                        <tr>
                            <td colspan="2" rowspan="2" class="style41" height="30">
                                This Pay Slip Valid Upto<label id="Label20"></label>
                            </td>
                        </tr>
                    </table>
                    <table class="style1">
