<%@ Page Language="C#" AutoEventWireup="true" CodeFile="print_personal_profile.aspx.cs"
    Inherits="Admin_Master_print_personal_profileaspx" %>
       ...
       //   getinstructor();
         ...
         else
         {
                            ...
                            for (var i = 0; i < CT_details.length; i++) 
                            {
                                debugger;
                                    ...
                                    if (CT_details[i]["section"] == 'A') 
                                    {
                                            ...
                                            str_course_taught_area += "<td class='semester_year'>"+ CT_details[i]["semester_year"] +"</td> ";
                                    ...
                                    else if(CT_details[i]["section"] == 'O') 
                                    {
                                         var str_course_taught_other = "<tr><td class='sr_no'>"+ count_other +"</td> ";
                                            ...
                                            str_course_taught_other += "<td class='semester_year'>"+ CT_details[i]["semester_year"] +"</td> "
            ...
            $('#btn_edit_profile').on('click', function () {
                 ...
                 window.location.href = "<%= Page.ResolveClientUrl("~/Admin/Master/vf_edit_personal_detail.aspx") %>";
            });
...
<body>
    ...
    <div id="main" role="main" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif">
        <div id="content-columns" class="row-fluid">
            <div id="portal-column-one" class="cell width-1:4 position-0" style="position:absolute;">
                <div class="portletWrapper" id="portletwrapper-706c6f6e652e6c656674636f6c756d6e0a636f6e74656e745f747970650a466163756c74790a666163756c74792d7069782d706f72746c6574"
                    ...
                    <div class="newsImageContainer">
                        ...
                        <p class="discreet">
                            ...
                            <br>
                            <%--Biology--%>
                            <li style="display:none;" id="li_other_profile" style="margin-top: 10px;"><span id="_st_node_3433_2" class="easytree-node  easytree-ico-cf easytree-exp-c easytree-active">
                                <span class="easytree-expander" onclick="return tree_menu_click(this);"></span><span
                                    ...
                                    padding-left: 0px; font-size: 14px;">Other Profile</span> </span>
                            ...
                            <div>
                                <div class="row-fluid">
                                    ...
                                    <div style="display:none;" class="span6">
                                        ...
                                        <div style="float: right;">
                                            <a id="btn_edit_profile" title="Edit"><i class="icon-edit icon-2x text-blue" style="cursor: pointer;
                                                width: 33px;"></i></a>|   <a  title="Print"><i class="icon-print icon-2x text-blue" style="cursor: pointer;">
                                                </i></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <dl>
                                   ...
                                   <dl>
                                    <dt>
                                        <h2 style="margin-bottom: 2px;">
                                            Courses Taught in the Areas of Expertise</h2>
                                    </dt>
                                    <dd>
                                        <div id="dd_tblcoursetaught" style=" overflow: hidden;">
                                     ...
                                     <%--   <span id="show_more_dd_tblcoursetaught" style="font-size: 14px; cursor: pointer;
                                            text-decoration: underline; color: Blue;" onclick="show_more_click('dd_tblcoursetaught')">
                                            Show More</span> <span id="show_less_dd_tblcoursetaught" style="font-size: 14px;
                                                display: none; cursor: pointer; text-decoration: underline; color: Blue;" onclick="show_less_click('dd_tblcoursetaught')">
                                                Show Less</span>--%>
                                    </dd>
                                </dl>
                                <dl id="dl_other_course_taught">
                                    <dt>
                                        <h2 style="margin-bottom: 2px;">
                                            Other Courses Taught</h2>
                                    </dt>
                                    <dd>
                                        <div id="dd_tblcoursetaughtother" style="overflow: hidden;">
                                      ...
                                      <%--  <span id="show_more_dd_tblcoursetaughtother" style="font-size: 14px; cursor: pointer;
                                            text-decoration: underline; color: Blue;" onclick="show_more_click('dd_tblcoursetaughtother')">
                                            Show More</span> <span id="show_less_dd_tblcoursetaughtother" style="font-size: 14px;
                                                display: none; cursor: pointer; text-decoration: underline; color: Blue;" onclick="show_less_click('dd_tblcoursetaughtother')">
                                                Show Less</span>--%>
                                    </dd>
                                </dl>
                                <dl>
                                    <dt>
                                        ...
                                        <h2>
                                            Recent Research/ Design Projects in Areas of Expertise (last 5 year)</h2>
                                    </dt>
                                    <dd>
                                        <p id="txt_projects">
                                        </p>
                                ...
                                <dl style="float: left;">
                                    <dt>
                                        <h2>
                                            Recent Presented Papers and Invited Lectures in Areas of Expertise (last 5 year)</h2>
                                    </dt>
                                    <dd>
                                ...
                                <dl style="float: left;">
                                    <dt>
                                        ...
                                        <h2>
                                            Research Articles and Book Chapters in Areas of Expertise</h2>
                                    </dt>
                                    <dd>
                                ...
                                <dl>
                                    <dt>
                                        <h2>
                                            Professional Affiliations / Public Service</h2>
                                    </dt>
                                    <dd>
