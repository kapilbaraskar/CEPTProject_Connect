...
public partial class Admin_Report_GradeReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //string s = HttpContext.Current.Request.Url.Authority + HttpContext.Current.Request.Url.Segments[0] + HttpContext.Current.Request.Url.Segments[1] + HttpContext.Current.Request.Url.Segments[2] + HttpContext.Current.Request.Url.Segments[3];
            ...
            if (dt_student_detail.Rows.Count > 0)
            {
                ...
                if (hdnIDs.Value != "")
                {
                    ...
                    for (int i = 0; i < idArray.Length; i++)
                    {
                        ...
                        obReportPrinter.PageFile = HttpContext.Current.Request.Url.Scheme + "://" + str_path + "GradeReportPDF2.aspx?uid=" + idArray[i] + "&sem=" + sem + "&year=" + year;
