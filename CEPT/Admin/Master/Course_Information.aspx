<%@ Page Title="Course Information" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="Course_Information.aspx.cs" Inherits="Admin_Master_Course_Information" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="../../Js/course_information.js?t=14062022" type="text/javascript"></script><%--26112019--%><%--17092020--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="well" style="background-color: White;">
        ...
        <div class="panel panel-default ">
            <div class="panel-heading">
                ...
                <a target="_blank" href="Course_information_tabular.aspx" class="panel-headingfont" style="float: right;"><u>View as Tabular</u></a>
            </div>
              ...
              <div id="inital_pendingcourse" class="tab-pane">
                ...
                <div id="approvedcourses" class="tab-pane">
                    <div style="position: absolute;">
                         <button class="btn btn-primary" type="button" id="download_Course_outline" style="display: block;">
                            <i class=""></i>&nbsp; View Course Outline
                        </button>
                    </div>
    ...
    <input type="hidden" id="hdn_all_course_code" runat="server" clientidmode="Static" />
    <div style="display: none;">
        <asp:Button ID="btn_download" runat="server" ClientIDMode="Static" Text="test" OnClick="Download_OutLine" />
    </div>
    <%--<div style="display: none;">
        <asp:Button ID="btn_all_download" runat="server" ClientIDMode="Static" Text="test" OnClick="Download_All_OutLine" />
    </div>--%>
</asp:Content>
