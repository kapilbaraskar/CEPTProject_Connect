<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="student_wise_session_dtl.aspx.cs" Inherits="Admin_Master_student_wise_session_dtl" %>
    ...
    <script type="text/javascript">
        ...
        function course_wise_entered_attendence_list(data) {
          ...
          function rowClick(row)
          {
              ...
              window.location = "student_wise_session_attendence.aspx?c=" + rowId + "&s=" + semester + "&y=" + year_code;
          }
