<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="VF_TA_Authorize.aspx.cs" Inherits="Admin_Master_VF_TA_Authorize" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="row-fluid">
        <div class="page-header position-relative">
            <h1> 
                <i class="icon-desktop"></i>&nbsp;VF TA Authorization Report
            </h1>
        </div>
    </div>
    <div class="well" style="background-color: White;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="chosen-select" id="instructortype">
                                        ...
                                        <option value="TEA">Teaching Assistant</option>
                                        <option value="AA">Academic Associate</option>
                                        <option value="TA">Teaching Associate </option>
                                    </select>
                                </td>
                                <td>
        ...
        <div id="div_course_list" class="panel panel-default" style="display: none;">
            <div class="panel-heading">
                <strong id="panel_head">VF TA Authorize Report</strong>
            </div>
            <div>
                <%--class="panel-body"--%>
    ...
    <script type="text/javascript">
            ...
            $.ajax(
                {
                    ...
                    //async: false,
                    data: "{sem_code:'" + semester + "',year_code:'" + year_code + "',dept_code:'" + dept_code + "',prog_code: '" + prog_code + "',prog_level_code:'" + prog_level_code + "',instructor_type:'" + instructor_type + "',type:'course',course_type:''}",
                    dataType: "json",
                    success: function (data) {
                        if (data.d != "" && data.d != "[]") {
                            inst_profile_pic = [];
        ...
        function display_get_vf_personal_detail(data) {
            ...
            //{ "sTitle": "Instructor Name", "mData": "instructor_name" },
            {
                ...
                { "sTitle": "User Type", "mData": "user_type" },
            ...
            $.ajax(
                {
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "../../WebService.asmx/insert_course_remark",
        ...
        function rowClick_Hr_Authorized(element) {
            ...
            var instructor_name = row_data["instructor_name"].toString();
            var email = row_data["mail"].toString();
            ...
            $.ajax(
                {
                    ...
                    //async: false,
                    data: "{instructor_code:'" + a_instructor_code + "', sem_code:'" + semester_type + "',year_code:'" + year_semester + "',course_code:'" + a_course_code + "',user_type_ta :'" + TA_user + "',rate_band :'" + rate_band +"'}",
                    dataType: "json",
                    success: function (data)
                    {
                        if (TA_user == 'temp') {
