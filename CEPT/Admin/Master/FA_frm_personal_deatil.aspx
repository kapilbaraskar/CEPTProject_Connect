<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master
    "
    AutoEventWireup="true" CodeFile="FA_frm_personal_deatil.aspx.cs" Inherits="Admin_Master_FA_frm_personal_deatil" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        str += "<td class='year_of_completion'></td> ";
        str += "<td class='certificate'> <a target='' id='certificate_path' download href=''></a></td></tr> ";
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.d[0] != null) {
                        ...
                        $('#txt_code').text(p_details[0]["superviser_code"]);
                        ...
                        $('#doj').text(p_details[0]["date_of_join"]);

                        $('#total_exp').text(p_details[0]["total_year_experience"]);
                        $('#exp_cept').text(p_details[0]["year_of_expe_cept"]);
                        $('#wrok_time').text(p_details[0]["start_time"]);
                        $('#reporting_to').text(p_details[0]["reporting_to"]);
                        $('#per_review_band').text(p_details[0]["performance_review_band"]);
                        $('#salary').text(p_details[0]["current_salary"]);
                        $('#txt_education_description').html(p_details[0]["education_description"]);
                        $('#wrok_time_end').html(p_details[0]["work_time"]);
                        $('#txt_area').html('');
                        ...
                        if (p_details[0]["experince_ceritificate_path"] != '') {
                            document.getElementById('Certificate_path').href = "../../Experience_certificate/" + p_details[0]["experince_ceritificate_path"];
                            document.getElementById('Certificate_path').innerText = "Download Ceritificate";
                        }
                        ...
                        $("#tbleducation tbody tr").each(function (j) {
                            ...
                            for (var i = 0; i < E_details.length; i++) {
                                if (j == i) {
                                    ...
                                    if (E_details[i]["edu_certificate"] != '') {
                                        //$(this).find('#certificate_path').href = ;
                                        $(this).find('#certificate_path').text("Download");

                                        $(this).find('#certificate_path').attr("href", "../../Education_Certificate/" + E_details[i]["edu_certificate"]);
                                    }
                                }
                            }
                        });
            ...
            $('#btn_edit_profile').on('click', function () {
                window.location.href = "<%= Page.ResolveClientUrl("~/Admin/Master/FA_frm_edit_personal_detail.aspx") %>";
            });
                    ...
                    <div id="content">
                        <div>
                            <div>
                                    ...
                                    <%--  <a href="/academics/departments/">Biology</a>--%></b><p>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>Employee Code:<span id="txt_code"></span>
                                                </td>
                                                <td></td>
                                                <td class="tdpadd"><span id="Span2"></span>
                                                </td>

                                            </tr>
                                            <tr>

                                                <td>Phone : <span id="txt_contact"></span>
                                                </td>
                                                <td></td>
                                                <td class="tdpadd">Date of Join : <span id="doj"></span>
                                                </td>

                                            </tr>
                                            <tr>
                                                <td>Office Location : <span id="spn_office_collection"></span>
                                                </td>
                                                <td></td>
                                                <td class="tdpadd">Total year Experience : <span id="total_exp"></span></span>
                                                </td>

                                            </tr>
                                            <tr>
                                                <td>Email <span id="txt_mail"></span>
                                                </td>
                                                <td></td>
                                                <td class="tdpadd">Year of Experience at Cept : <span id="exp_cept"></span>
                                                </td>

                                            </tr>
                                            <tr>
                                                <td>Start Work Time : <span id="wrok_time"></span>
                                                </td>
                                                <td></td>
                                                <td class="tdpadd">Reporting To : <span id="reporting_to"></span>
                                                </td>

                                            </tr>
                                            <tr>
                                                <td>End Work Time : <span id="wrok_time_end"></span>
                                                </td>
                                                <%--<td style="display:none;">Performance Review : <span id="per_review_band"></span>
                                                </td>--%>
                                                <td></td>
                                                <td class="tdpadd">Current Salary: <span id="salary"></span>
                                                </td>
                                        ...
                                        <br />
                                        <a target="_blank" id="Certificate_path" download href=""></a>
                                ...
                                <dl id="dl_other_course_taught" style="display: none;">
                                    <dt>
