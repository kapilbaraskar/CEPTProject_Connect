<%@ Page Title="Publish MidTerm Result" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="Grade_PublishMidTermGrades.aspx.cs" Inherits="Admin_Master_Grade_PublishMidTermGrades" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="../../Js/admin_report_midterm.js?08032022" type="text/javascript"></script><%--08102021--%>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>
                <i class="icon-desktop"></i>Publish MidTerm Marks
            </h1>
        </div>
    </div>
                    ...
                    <div>
                        <table border="0" cellpadding="10" cellspacing="5">
                            ...
                            <tr>
                                ...
                                <td style="display: none;">Assessment Type
                                </td>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btnretrieve').on('click', function () {
                ...
                if ($('#drp_exam_type').val() != 'MT') { $('.copyright').css('display', 'none'); } else { $('.copyright').css('display', 'block'); }
                return false;
            });
        ...
        function rowClick(row) {
            ...
            window.location = "EditMidTermMarks.aspx?c=" + rowId + "&s=" + semester + "&y=" + year_code;
        }
            ...
            $.ajax(
                {
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "../../WebService.asmx/send_for_review_midterm",
                    //async: false,
                    data: "{course_code:'" + course_code + "', sem_code:'" + semester + "', year_code:'" + year_code + "'}",
                    dataType: "json",
                    success: function (data) {
                                        ...
                                        if (obj_selected_course.length > 0) {
                                            ...
                                            if (publish_data.length > 0) {
                                                ...
                                                $.ajax({
                                                    type: "POST",
                                                    contentType: "application/json; charset=utf-8",
                                                    url: "../../WebService.asmx/publish_selected_course_grade_midterm",
                                                    //async: false,
                ...
                $.ajax(
                    {
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "../../WebService.asmx/course_wise_entered_marks_list_Pending_Approve_midterm", //course_wise_entered_marks_list_AD_new
                        //async: false,
                        data: "{sem_code:'" + semester + "',year_code:'" + year_code + "',dept_code:'" + dept_code + "',prog_code:'" + prog_code + "',status:'P',prog_level_code:'" + prog_level_code + "',course_typology:'" + course_typology +"'}",
                        dataType: "json",
                        success: function (data) {
                            ...
                            if (data.d != "" && data.d != "[]") {
                                ...
                                if ($('#hdnusertype').val() != 'PC') {
                                    $('#div_course_list').css('display', 'none');
                                    $("#div_course_pending").css('display', '');
                                    
                                    $("#DataList_tab").css("display","none");
                                    //$("#DataList_tab").html(' <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover" id="example_tab" width="100%"><thead></thead><tbody><tr>No courses pending to be published</tr></tbody></table>');
                                }
                            }
                        },
                        error: function (result) {
                ...
                $.ajax(
                    {
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "../../WebService.asmx/course_wise_midterm_exam_dtl_midterm",
                        //async: false,
            ...
            $.ajax(
                {
                    ...
                    url: "../../WebService.asmx/course_wise_entered_marks_list_Pending_Approve_midterm", //course_wise_entered_marks_list_AD_new
                    //async: false,
                    data: "{sem_code:'" + semester + "',year_code:'" + year_code + "',dept_code:'" + dept_code + "',prog_code:'" + prog_code + "',status:'A',prog_level_code:'" + prog_level_code + "',course_typology:'" + course_typology +"'}",
                    dataType: "json",
                    success: function (data) {
                        ...
                        if (data.d != "" && data.d != "[]") {
                            ...
                            bootbox.alert('No Publish Course Found For Selected Semester and Year.');
                            if ($('#hdnusertype').val() != 'PC') {
                                $('#div_course_list').css('display', 'none');
                                $('#DataList_approvedcourses').css('display', 'none');
                            }
        ...
        function course_wise_entered_marks_list_midterm(data) {
            ...
            for (var i = 0; i < max_exams; i++) {
                ...
                obj_col.push({
                    "sTitle": "Exam" + (i + 1) + "<br><button id='btn_exam_" + (i + 1) + "' type='button' class='btn btn-small btn-primary' style='margin-top:5px;' onclick='submit_exam(\"exam" + (i + 1) + "\")'>Publish</button>",
                        ...
                        if (data.aData['exam' + (i + 1)] != '') {
                            if ($('#hdnusertype').val() == 'AD' || $('#hdnusertype').val() == 'A1') {
                                if (data.aData[data.aData['exam' + (i + 1)] + '_eligible'] == 'Y') {
                                    if (data.aData[data.aData['ugpg_approval']] == 'Y') {
                                        return '<div><input type="checkbox" class="cls_chk_exam' + (i + 1) + '" style="float:left;" value="' + data.aData['exam' + (i + 1)] + '" checked disabled/>' +
