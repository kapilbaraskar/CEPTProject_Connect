<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="download_visa.aspx.cs" Inherits="Admin_Master_download_visa" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <%-- <script src="../../Js/downloadvisa.js?t=01112022" type="text/javascript"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function BulkDownloadVisa() {
            ...
            if (flag == "Y") {
                ...
                $.ajax({
                    type: "POST",
                    url: "../../WebService.asmx/BulkDownloadVisa",
                    data: data,
                    contentType: "application/json; charset=utf-8",
                    datatype: "json",
                    async: false,
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>
                <i class="icon-desktop"></i>Download Wisa
            </h1>
        </div>
    </div>
