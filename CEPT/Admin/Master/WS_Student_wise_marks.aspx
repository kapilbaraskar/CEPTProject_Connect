<%@ Page Title="WS Student Wise Marks" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="WS_Student_wise_marks.aspx.cs" Inherits="Admin_Master_WS_Student_wise_marks" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">    
    ...
    <script src="../../Js/ws_student_wise_marks_11082017.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
       <%-- function student_marks_upload() {
            ...
            $("#" + '<%=student_marks_upload.ClientID%>').uploadify({
                ...
                'uploader': '../../Handler/WS_Student_Marks_Upload.ashx',
        ...
        function UploadMarks() {
            try {
                ...
                if (CheckMarksDocumentExtension(fileToUpload)) {
                    ...
                    $.ajaxFileUpload({
                        url: '../../Handler/WS_Student_Marks_Upload.ashx',
                        secureuri: false,
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="well" style="background-color: White;">
        ...
        <table style="width: 62%;margin-left: 15%;">
            <tr>
                ...
                <td align="left" id="td_btn_submit">
    ...
    <div class="modal fade" id="mynewModal" style="display:none;top:5%;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <%--<iframe src="#DataList" width="500" height="580" frameborder="0" allowtransparency="true"></iframe>--%>
