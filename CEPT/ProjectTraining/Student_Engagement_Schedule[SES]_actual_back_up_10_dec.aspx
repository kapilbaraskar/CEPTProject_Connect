...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="well" style="background-color: White;">
         <span style="color: red">Upload Image file size must be less then 2 mb.</span>
        <a href="https://tinypng.com/" target="_blank"> Compress Image</a>
                ...
                <div class="modal-body">
                    ...
                    <div style="padding: 15px;" id="div3">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-3">Signature Of Student: </div>
                            <div class="col-sm-3 ">Signature of Engineew in-chagre: </div>
                            <div class="col-sm-5 pull-right save_submit">
                                <input type="button" id="save_daily_sheet" value="save" />
                                <%--<input type="button" id="submit_daily_sheet" value="Submit" />--%>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function redirect(str) {
            $('#loading').hide();
            bootbox.alert('Site Join Report Not submitted !!', function () {
                ...
                for (var i = 0; i < 119; i++) {
                    ...
                    if (day == "Sun") {
                        ...
                        if (t == t1) {
                            ...
                            + "<td><label class='btn btn-primary file-upload btn_hide radio_hide ' style='vertical-align: bottom; width:100px'><span><strong>Upload Files</strong></span>"
                            ...
                            + "<a id='download_link" + monthNames[now.getMonth()] + now.getDate() + "' class='fancybox radio_hide download_link' download='' rel='group' href=''></a></td>"
                            ...
                            str += "<tr> <td class='id1' id=" + (now.getMonth() + 1) + "/" + now.getDate() + "/" + now.getFullYear() + ">" + monthNames[now.getMonth()] + ' ' + now.getDate() + "</td> "
                              ...
                              //+ "<span id='upload_span'><strong class='upload_result'></strong><span></span>"
                              //+ "</td> "
                                    + "<td><a id='download_link" + monthNames[now.getMonth()] + now.getDate() + "' class='fancybox radio_hide download_link' download='' rel='group' href=''></a></td>"
                              + "<td>  <button type='button'  class='time_sheet bt btn btn-sm' data-toggle='modal' data-target='#myModal'>Time Sheet</button></td> "
                        //  + "<td></td>"
                              + "</tr>";
                        }
        ...
        $(document).on('click', ".time_sheet", function () {
            ...
            $('#dailysheet_time').text(a.getDate() + "/" + d.getMonth() + 1 + "/" + d.getFullYear());
