<%@ WebHandler Language="C#" Class="FacultyProfile_CV_Upload" %>

using System;
using System.Web;

public class FacultyProfile_CV_Upload : IHttpHandler, System.Web.SessionState.IReadOnlySessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
            ...
            string Serverpath = System.Configuration.ConfigurationManager.AppSettings["FacultyProfileCVUploadPath"];
            ...
            if (context.Request.Files.Count > 0)
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    finalFileName = user_id + "_" + "CV.pdf";
