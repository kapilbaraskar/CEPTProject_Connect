<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="FA_frm_edit_personal_detail.aspx.cs"
    Inherits="Admin_FA_frm_edit_personal_detail" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btn_education').on('click', function () {
                ...
                var str_edu = "<tr><td><input style='width: 202px;' type='text' class='degree'/></td> ";
                str_edu += "<td><input style='width: 202px;' type='text' class='Institution'/></td> ";
                str_edu += "<td><input style='width: 202px;' type='text' class='Field'/></td> ";
                str_edu += "<td><input style='width: 50px;' type='text' maxlength='4' class='year_of_completion' onkeypress='return isNumber(event);'/></td> ";
                str_edu += '<td><label class="btn btn-primary btn-small file-upload " style="vertical-align: bottom;"><span><strong>Upload Image</strong></span>';
                str_edu += '<input type="file" name="portfolioImageUpload' + (count) + '" id="portfolioImageUpload' + (count) + '" onchange="javascript:return UploadPortfolioImage(' + (count) + ');" style="display: none;" />';
                str_edu += '</label><span id="lbl_portfolioimage_file_name' + (count) + '" class="cls_portfolio_image_name" style="vertical-align: super;"></span>';
                str_edu += ' <input style="clear: both;" class="portfolioImageUpload_hdn" type="hidden" id="hdn_EDU_upload' + (count) + '"/>'
                str_edu += '</td>';
                str_edu += "<td><center><i class='icon-trash icon-2x text-blue 'style='cursor:pointer;'></i></center></td></tr>";
            ...
            $('#btnsave').on('click', function () {
                ...
                data.fname = $('#txt_fname').val();
                data.mname = $('#txt_mname').val();
                data.lname = $('#txt_lname').val();
                data.date_of_join = $('#doj').val();
                data.start_time = $('#txt_starttime').val();
                data.work_time = $('#wrok_time').val();
                data.total_year_experience = $('#total_exp').val();
                data.year_of_experience_cept = $('#exp_cept').val();
                data.reporting_to = $('#reporting_to').val();
                data.performance_band = $('#per_review_band').val();
                data.current_salary = $('#salary').val();
                ...
                data.upload_ec_path = $('#hdn_ec_upload').val();

                var education_data_list = [];

                $("#tbleducation tbody tr").each(function (j) {
                    var education_data = { 'degree': '', 'institution': '', 'field': '', 'year_of_completion': '', 'edu_certificate': '' };
                    ...
                    education_data.edu_certificate = $(this).find(".portfolioImageUpload_hdn").val();
                ...
                $.ajax({
                    ...
                    url: "../../WebService.asmx/save_profile_data_non_teaching_faculty",
        ...
        function get_profile_details() {
            ...
            $.ajax({
                type: "POST",
                url: "../../WebService.asmx/get_non_teaching_faculty_detail",
                ...
                success: function (data) {
                    ...
                    if (data.d[0] != null) {
                        ...
                        $('#doj').val(convertDate(p_details[0]["date_of_join"]));

                        $('#total_exp').val(p_details[0]["total_year_experience"]);
                        $('#exp_cept').val(p_details[0]["Cal_exp"]);
                        $('#wrok_time').val(p_details[0]["work_time"]);
                        $('#txt_starttime').val(p_details[0]["start_time"]);
                        $('#reporting_to').val(p_details[0]["reporting_to"]);
                        $('#per_review_band').val(p_details[0]["performance_review_band"]);
                        $('#salary').val(p_details[0]["current_salary"]);
                        $('#txt_fname').val(p_details[0]["firstName"]);
                        $('#txt_mname').val(p_details[0]["middle_name"]);
                        $('#txt_lname').val(p_details[0]["last_name"]);
                        // $('#txt_area').html('');
                        ...
                        if (p_details[0]["experince_ceritificate_path"] != '') {
                            $('#lbl_ec_upload').text('file uploaded');
                            $('#hdn_ec_upload').val(p_details[0]["experince_ceritificate_path"]);
                        }
                        ...
                        $("#tbleducation tbody tr").each(function (j) {
                            for (var i = 0; i < E_details.length; i++) {
                                ...
                                if (j == i) {
                                    ...
                                    $(this).find(".portfolioImageUpload_hdn").val(E_details[i]["edu_certificate"]);
                ...
                if (CheckUserCVExtension(fileToUpload)) {
                    ...
                    if (filename != "" && filename != null) {
                        ...
                        if (flag == true) {
                            $("#UploadingProgress").fadeIn(200);
                            $.ajaxFileUpload({
                                url: '../../Handler/EductionUploadCertificate.ashx?t=' + (new Date()).getTime() + '.' + extension,
                                secureuri: false,
                                ...
                                success: function (data, status) {
                                    if (typeof (data.error) != 'undefined') {
                                        if (data.error != '') {
                                            ...
                                            $('#lbl_portfolioimage_file_name' + id).html('<b>' + "file uploaded" + '</b>');
                                            ...
                                            //   FileName = data.upfile;
                                            $('#hdn_EDU_upload' + id).val(data.upfile);
                                            // $('#lbl_ec_upload').text('file uploaded');
        ...
        function UploadExperince_certificate() {

            try {

                var fileToUpload = GetFileNameFromPath($('#ECUpload').val());
                ...
                if (CheckUserCVExtension(fileToUpload)) {
                    ...
                    if (filename != "" && filename != null) {
                        ...
                        if (flag == true) {
                            $("#UploadingProgress").fadeIn(200);
                            $.ajaxFileUpload({
                                url: '../../Handler/Experince_certificate.ashx',
                                secureuri: false,
                                fileElementId: 'ECUpload',
                                dataType: 'json',
                                data: { name: name },
                                success: function (data, status) {
                                    if (typeof (data.error) != 'undefined') {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="tabbable">
                ...
                <div id="Div2" class="tab-pane active" style="padding-left: 75px;">
                    <table width="100%" cellpadding="10" cellspacing="50">
                        <tr>
                            <td>
                                <div class="control-group">
                                    <label class="control-label" for="txtfullname">
                                        FName<span class="required"> *</span>
                                    </label>
                                </div>
                            </td>
                            <td>
                                <div class="controls">
                                    <input type="text" id="txt_fname" ng-model="data.supervisor_name" placeholder="" />
                                    <span style="color: red" ng-show="name.$dirty && name.$invalid"></span>
                                </div>
                            ...
                            <td>
                                <div class="controls">
                                    <input type="text" id="txt_mname" ng-model="data.supervisor_name" placeholder="" />
                                    <span style="color: red" ng-show="name.$dirty && name.$invalid"></span>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="controls">
                                    <input type="text" id="txt_lname" ng-model="data.supervisor_name" placeholder="" />
                                    <span style="color: red" ng-show="name.$dirty && name.$invalid"></span>
                                </div>
                ...
                <td>
                    <div class="controls">
                        ...
                        <input type="text" id="drp_type" ng-model="data.capstone_project" placeholder="Link to personal web page" />
                    </div>
                </td>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="controls">
                                    ...
                                    <input type="text" id="txt_contact" ng-model="data.contact" placeholder="Phone number" onkeypress='return IsNumeric(event);' maxlength="10" />
                                </div>
        </div>
        </td>
                            <td>
    ...
    <tr>
        ...
        <td>
            <div class="controls">
                <input type="text" id="doj" placeholder="MM-DD-YY" />
            </div>
        ...
        <td>
            <div class="controls">
                <input type="number" id="total_exp" placeholder="" />
            </div>
    ...
    <tr>
        ...
        <td>
            <div class="controls">
                <input type="text" id="txt_starttime" placeholder="HH:MM AM?PM" />
            </div>
        ...
        <td>
            <div class="controls">
                <input type="text" id="wrok_time" placeholder="HH:MM AM?PM" />
            </div>
    ...
    <tr>
        ...
        <td>
            <div class="controls">
                <input type="text" id="reporting_to" placeholder="" />
            </div>
        ...
        <td>
            <div class="control-group">
                <label class="control-label">
                    Perfomance Review band
                </label>
            </div>
        </td>
        <td>
            <div class="controls">
                <input type="text" id="per_review_band" placeholder="" />
            </div>
    ...
    <tr>
        ...
        <td>
            <div class="controls">
                <input type="number" id="salary" placeholder="" />
            </div>
        ...
        <td>
            <div class="control-group">
                <label class="control-label">
                    Years of Experience at CEPT
                </label>
            </div>
        </td>
        <td>
            <div class="controls">
                <input type="number" id="exp_cept" placeholder="" />
            </div>
    ...
    <tr>
        <td colspan='2'>
            <div class="control-group">
                ...
                <label id="Label1" class="btn btn-primary file-upload " style="vertical-align: bottom; float: left;">
    ...
    <tr>
        <td colspan='2'>
            <div class="control-group">
                ...
                <label id="Label2" class="btn btn-primary file-upload " style="vertical-align: bottom; float: left;">
                    <span><strong>Upload  Experience Certificate </strong></span>
                    <input type="file" name="ECUpload" id="ECUpload" onchange="javascript:return UploadExperince_certificate();" /></label>
                <label style="float: left;" id="lbl_ec_upload">
                </label>
                <input style="clear: both;" type="hidden" id="hdn_ec_upload" />
            </div>
        </td>
    </tr>
    </table>
    ...
    <div class="panel panel-default" style="width: 92%; display: none;">
        <div class="panel-heading">
            <strong><span class="panel-headingfont">Courses Taught in the Areas of Expertise</span></strong>
        </div>
            ...
            <table class="data-table table table-bordered table-striped" border="0" id="tblcoursetaught">
                <thead>
                    <tr>
                        ...
                        <th>Courses Taught in Area of Expertise
                        </th>
                        <th>Other Course Taught
                        </th>
                        <th>Delete
                        </th>
                    </tr>
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tbody>
            <tr>
                <td>Brief Description (Education & Work Profile)<%--<span class="required"> *</span>--%>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="control-group">
                        <div>
                            <textarea id="txt_education_description" ng-model="data.education_description" style="width: 91%; height: 110px"
                                rows="3" cols="50" name="address"></textarea>
                        </div>
                    </div>
                </td>
            </tr>
    ...
    <div class="panel panel-default" style="width: 92%; display: none">
        <div class="panel-heading">
            <strong><span class="panel-headingfont">Areas of Expertise</span></strong>
        </div>
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <div class="control-group">
                        <div>
                            <textarea class="ckeditor" id="txt_projects" ng-model="data.projects" style="width: 98%; height: 110px"
                                rows="3" cols="50" name="address"></textarea>
                        </div>
                    </div>
                </td>
    ...
    <table style="display: none;" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
            <tr>
                <td>Background (Brief Resume 100 word max)<%--<span class="required"> *</span>--%>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="control-group">
                        <div>
                            <textarea class="ckeditor" id="txt_Background" ng-model="data.Background" style="width: 98%; height: 110px"
                                rows="3" cols="50" name="address"></textarea>
                        </div>
                    </div>
                </td>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" style="display: none;">
        <tbody>
            <tr>
                <td>Presented Papers and Invited Lectures in Areas of Expertise (last 5 year)
                </td>
            </tr>
            <tr>
                <td>
                    <div class="control-group">
                        <div>
                            <textarea class="ckeditor" id="txt_presented_papers_and_invited_lectures" style="width: 98%; height: 110px"
                                rows="3" cols="50" name="address"></textarea>
                        </div>
                    </div>
                </td>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" style="display: none;">
        <tbody>
            <tr>
                <td>Professional Honors, Prizes , Fellowships (From Latest)<%--<span class="required"> *</span>--%>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="control-group">
                        <div>
                            <textarea class="ckeditor" id="txt_prof_honors" ng-model="data.prof_honors" style="width: 98%; height: 110px"
                                rows="3" cols="50" name="address"></textarea>
                        </div>
                    </div>
                </td>
    ...
    <div class="panel panel-default" style="width: 92%;">
        <div class="panel-heading">
            <strong><span class="panel-headingfont">Professional Affiliations</span></strong>
        </div>
