<%@ Page Title="Course Instructor Feedback Report for send pdf file" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="course_instructor_wise_feedback_send_pdf.aspx.cs" Inherits="Admin_Report_course_instructor_wise_feedback_send_pdf" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script src="../../Js/feedback_report.js?t=02082024" type="text/javascript"></script><%--28082018--%>
   <%--//kapil--%>
            ...
            function uploadfile() {
               ...
               // var EncodeValue = toBinary(getval);
                ...
                $.ajax({
                    ...
                    url: "../../WebService.asmx/UploadPDFServer",
                        ...
                        if (data.d != "") {
                            ...
                            else
                            {
                               // window.open('https://connect.cept.ac.in/' + 'FeedbackPdf' + '/' + 'Feedback Report.zip'); 
                                //window.open('http://localhost:1121/' + 'FeedbackPdf' + '/' + data.d);
                                window.open('https://connect.cept.ac.in/' + 'FeedbackPdf' + '/' + data.d);
...
<div class="modal hide fade" id="myModal" style="left: 50%; width: 40%;">
    ...
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>
                <i class="icon-desktop"></i>Course Instructor Feedback Report for send pdf file
            </h1>
        </div>
        <div>
            <div>
                    ...
                    <table>
                        <tr>
                         ...
                         <td style="display:block;">
                            ...
                            <td style="display:block-inline;">
                            <button class="btn btn-primary send_feedback_pdf_mail_bulk" type="button" id="btnbulk">Send Mail </button>
                        </td>
