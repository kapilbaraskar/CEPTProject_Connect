...
public partial class Student_PaymentInstallmentEazypayDesign : System.Web.UI.Page
{
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    if (Session["SessionId"] != null && Session["UserId"] != null)
                    {
                        ...
                        string message = objPayment.SavePaymentDetails_Eazypay(Request, ref paymentResponse, "2");// 2 = Design
