...
public partial class Admin_Master_EditMidTermMarks : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["user_type"].ToString() == "I2" || Session["user_type"].ToString() == "PC" || Session["user_type"].ToString() == "D" || Session["user_type"].ToString() == "A1")
        {
