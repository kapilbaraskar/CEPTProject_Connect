<%@ WebHandler Language="C#" Class="DepartmentFeedbackPDF_upload" %>

using System;
using System.Web;

public class DepartmentFeedbackPDF_upload : IHttpHandler,System.Web.SessionState.IRequiresSessionState
{
    int mFileSize = 0;
    string msg = "";
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
            ...
            string Serverpath = System.Configuration.ConfigurationManager.AppSettings["DepartmentFeedbackPDFUploadPath"];

            if (context.Request.Files.Count > 0)
            {
                var postedFile = context.Request.Files[0];
                string filesize = System.Configuration.ConfigurationManager.AppSettings["DepartmentFeedbackPDFUploadMaxSize"];
