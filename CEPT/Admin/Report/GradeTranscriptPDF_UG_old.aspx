<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GradeTranscriptPDF_UG_old.aspx.cs" Inherits="Admin_Report_GradeTranscriptPDF_UG_old" %>
    ...
    <script type="text/javascript">
        ...
        function setCourseDetail() {
            ...
            if (obj_course_detail != null && obj_course_detail != undefined) {
                ...
                $('#td_total').html(total_core_credit + total_elective_credit + total_ngpa_credit);
            }
        }
...
<body style="color:Black;padding-left:1%;padding-right:1%;">
    ...
    <div id="div_ug_note" style="margin-top: -15px;font-size:8px;">
        <b>Note = 1. Related Study Program (RSP) not taken into account for AGG.AVG. 2. Summer / Winter Training (ST / WT) not taken into account for AGG.AVG. 3. Interative Studio (IS) not taken into account for AGG.AVG. 4. Office Training (OT) not taken into account for AGG.AVG. 5. NGPA : NON GPA</b>
    </div>
