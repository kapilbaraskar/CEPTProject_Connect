        ...
        if (!IsPostBack)
        {
            if (Session["UserId"] != null)
            {
                ...
                if (dtUserMultiRoleDtl != null)
                {
                    ...
                    dtAdminRights = objAdminUserRights.Site_GetMultiRoleMenuRights(Session["UserId"].ToString(), Session["user_type"].ToString());
                ...
                {
                    //Get Admin Access Rights 
                    dtAdminRights = objAdminUserRights.Site_GetMenuRights(Session["UserId"].ToString());
                }
