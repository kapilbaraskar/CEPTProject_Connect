<%@ WebHandler Language="C#" Class="EductionUploadCertificate" %>

using System;
using System.Web;

public class EductionUploadCertificate : IHttpHandler, System.Web.SessionState.IReadOnlySessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
            ...
            string Serverpath = System.Configuration.ConfigurationManager.AppSettings["NON_FacultyProfile_eductioncertificate_UploadPath"];

            if (context.Request.Files.Count > 0)
            {
                var postedFile = context.Request.Files[0];
                string filesize = System.Configuration.ConfigurationManager.AppSettings["FacultyProfileCVUploadMaxSize"];
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                 ...
                 //   finalFileName = user_id + "_" + "Experince_certi.pdf";
                    finalFileName = user_id + "_" + context.Request.QueryString["t"].ToString();
