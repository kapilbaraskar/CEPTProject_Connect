...
public partial class Student_PaymentResponseKotak_HostelFees : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            string encResponse = "order_id=FCCPFTUC30161P2021083575&tracking_id=109989764129&bank_ref_no=0121953016&order_status=Success&failure_message=&payment_mode=Net Banking&card_name=Kotak Mahindra Bank&status_code=null&status_message=&currency=INR&amount=40000.00&billing_name=ANISH NOONE&billing_address=GANDHI NAGAR&billing_city=HYDERABAD&billing_state=TELANGANA&billing_zip=500082&billing_country=India&billing_tel=9700575057&billing_email=anishnoone@gmail.com&delivery_name=ANISH NOONE&delivery_address=GANDHI NAGAR&delivery_city=HYDERABAD&delivery_state=TELANGANA&delivery_zip=500082&delivery_country=India&delivery_tel=9700575057&merchant_param1=UC3016&merchant_param2=NOONE ANISH&merchant_param3=5&merchant_param4=-#1#1#Y#S#Y2016&merchant_param5=&vault=N&offer_type=null&offer_code=null&discount_value=0.0&mer_amount=40000.00&sub_account_id=CEPTFAK&eci_value=null&retry=N&response_code=0&billing_notes=&trans_date=15/10/2020 17:41:16&bin_country=&trans_fee=0.0&service_tax=0.0";
            ...
            Log.PaymentTransactionLog("Hostel Fees Payment Response From Kotak. " + encResponse);
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    {
                        Log.PaymentTransactionLog("Hostel Fees Payment transaction id on cancel payment  : " + Params["order_status"]);
                    }
                    ...
                    if (UID != null)
                    {
                        ...
                        string message = objPayment.SaveHostelPaymentDetails_Kotak(Params, ref paymentResponse, Params["merchant_param3"]);
                        ...
                        if (paymentResponse.status.Contains("paymentSuccess"))
                        {
                            ...
                            if (paymentResponse.data.user_id != null && paymentResponse.data.user_id != string.Empty)
                            {
                                ...
                                if (dtCandidatePersonalDetails != null && dtCandidatePersonalDetails.Rows.Count > 0)
                                {
                                    ...
                                    try
                                    {
                                        DataTable dt_transaction_data = objGetMasterDetails.get_hostelTransactionsDetail_for_mail_send(paymentResponse.data.transaction_id);
                                        ...
                                        string mail_status = objmail.SendEmailOnHostelfeesPaymentSuccess(email_data);
                ...
                try
                {
                    ...
                    if (UID != null && paymentResponse.status == "paymentFail" && Request["ReferenceNo"] != null)
                    {
                        ...
                        DataTable dt_transaction_data = objGetMasterDetails.get_hostelTransactionsDetail_for_mail_send(Request["ReferenceNo"].ToString());
                        ...
                        string mail_status = objmail.SendEmailOnHostelfeesPaymentFail(dic_payment_fail_dtl);
