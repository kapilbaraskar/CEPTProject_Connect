    ...
    $.ajax(
        {
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "../../WebService.asmx/submit_course_wise_grade_range_midterm",
            //async: false,
    ...
    $.ajax(
        {
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "../../WebService.asmx/get_course_wise_avg_sd_range_midterm",
            //async: false,
...
function course_wise_avg_marks_list(data) {
    ...
    oTable = $("#example").dataTable({
        ...
        "aoColumns": [
            ...
            { "sTitle": "Average Marks", "mData": null, "bSortable": false, mRender: function (data) { return parseFloat(data.Average).toFixed(2); } },

            { "sTitle": "Standard Deviation", "mData": null, "bSortable": false, mRender: function (data) { return parseFloat(data.SD).toFixed(2); } },
