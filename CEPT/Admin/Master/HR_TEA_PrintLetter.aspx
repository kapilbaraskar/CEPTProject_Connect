<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HR_TEA_PrintLetter.aspx.cs" Inherits="Admin_Master_HR_TEA_PrintLetter" %>
...
<body style="margin: 12px 70px 0px 70px;" class="pg_font">
    ...
    <h5 class="pg_font mg_top">Sub : Engagement as Teaching Associate
    ...
    <p class="mg_top" style="text-align: justify;">
        I am pleased to confirm your engagement as a Teaching Associate
    ...
    <p style="text-align: justify;">
        The term of your engagement as a Teaching Associate for&nbsp;<asp:Label ID="weeks" runat="server" ClientIDMode="Static"></asp:Label>&nbsp;weeks of the duration
    ...
    <p style="text-align: justify;">
        As a Teaching Associate you will assist the course/studio faculty in teaching
    ...
    <p style="text-align: justify;">
        As a Teaching Associate, you are expected to avoid conflict of commitment.
        Conflict of commitment will arise when the Teaching Associate engages outside CEPT University
    ...
    <div style="width: 60.2%; float: left;">
        ...
        <p style="margin-bottom: 0px; margin-top: 0px;">
            <asp:Label ID="lbl_sincerely_dean_director" runat="server" ClientIDMode="Static"></asp:Label>
        </p>
        <p style="margin-bottom: 0px; margin-top: 0px;">
