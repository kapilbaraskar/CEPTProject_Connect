<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="VF_TA_Authorize.aspx.cs" Inherits="Admin_Report_VF_TA_Authorize" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="well" style="background-color: White;">
        ...
        <div style="display: none;">
            ...
            <%--<asp:Button ID="hdn_print_letter" runat="server" ClientIDMode="Static" OnClick="Btn_Print_Letter_Click" />--%>
             <asp:Button ID="hdn_print_letter" runat="server" ClientIDMode="Static" Text="Button" OnClick="hdn_print_letter_Click" />
            <asp:Button ID="btnDownloadExcelDocuments" runat="server" Text="Button" ClientIDMode="Static"  OnClick="btnDownloadExcelDocuments_Click" />
        </div>
    ...
    <script type="text/javascript">
            ...
            $.ajax(
                {
                    ...
                    //async: false,
                    data: "{sem_code:'" + semester + "',year_code:'" + year_code + "',dept_code:'" + dept_code + "',prog_code: '" + prog_code + "',prog_level_code:'" + prog_level_code + "',instructor_type:'" + instructor_type + "',type:'',course_type:''}",
                    dataType: "json",
                    success: function (data) {
                        if (data.d != "" && data.d != "[]") {
                            inst_profile_pic = [];
        ...
        function display_get_vf_personal_detail(data) {
            ...
            // commented by nitin bhai 09082023
