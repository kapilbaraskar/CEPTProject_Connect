...
public partial class Admin_Master_HR_PrintLetter_phd : System.Web.UI.Page
{
            ...
            try
            {
                ...
                if (instructor_code != "")
                {
                    ...
                    if (dt_instructor_detail != null)
                    {
                        ...
                        string str_sincere_prof = "Dr. Rutul Joshi";
                        string str_sincere_dean_dept = "";
                        string str_signature = "../../image/signature_doctoral.png?t=1";
                        //string str_signature = "../../image/signature_doctoral.jpg?t=1";
                        //switch (dt_instructor_detail.Rows[0]["dept_name"].ToString())
                        //{
                        //    case "Architecture":
                        //        str_sincere_prof = "Prof. Surya Kakani";
                        ...
                        //        break;
                        //    case "Management":
                        //        str_sincere_prof = "Prof. Manvita Baradi";
                        ...
                        //        //str_sincere_prof = "Prof. A. Srivathsan";
                        //        str_sincere_prof = "Dr. Paresh Shah";
                        ...
                        for (int i = 0; i < dt_instructor_detail.Rows.Count; i++)
                        {
                            ...
                            str_div_html = str_div_html + "<table class='table table-bordered clsCourseTable'>" +
                                            "<tr>" +
                                               "<td style='width: 25%;'><b>Name of the Studio / Course Unit</b></td>" +
                                            ...
                                            "<tr>" +
                                               ...
                                               "<td style='width: 25%;'><b>Co-tutor</b></td>" +
                                               "<td style='width: 25%;'>";
                            ...
                            if (hours_bifurcation != null)
                            {
                                for (int k = 0; k < hours_bifurcation.Count; k++)
                                {
                                    ...
                                    else if (hours_bifurcation.Count == 2)
                                    {
                                        ...
                                        //else
                                        //{
                                        str_div_html = str_div_html + "<td class='two'>";
                                        //}
                                    }
                                    ...
                                    str_div_html = str_div_html + "<b>Contact Hrs <br/>(" + dic_instructor_data["weeks"].ToString() + " weeks)</b></td>";
                                    ...
                                    str_div_html = str_div_html + Convert.ToDouble(dic_instructor_data["weeks"].ToString()) * Convert.ToDouble(dic_instructor_data["contact_hrs"].ToString()) + "</td>";
                            ...
                            str_div_html = str_div_html + "</tr></table></td></tr><tr>" +
                                   "<td style='width: 25%;'><b>Total Hours of Professional Fees</b></td>" +
                                    ...
                                    for (int k = 0; k < dr.Length; k++)
                                    {
                                        if (!str_prog_co_html.Contains(dr[k]["user_name"].ToString()))
                                        {
                                            ...
                                            if (dr[k]["letter_label"].ToString() != "")
                                            {
                                                ...
                                                {
                                                    str_prog_co_html = str_prog_co_html + "<tr><td style='border: none; width: 165px;'>Program Cord</td>";
                                                }
                                                else if (dr[k]["letter_label"].ToString() == "PCH")
                                                {
                                                    str_prog_co_html = str_prog_co_html + "<tr><td style='border: none; width: 165px;'>Program Chair</td>";
                                                }
                                            }
                                            else 
                                            {
