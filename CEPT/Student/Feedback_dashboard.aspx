...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="../Js/feedback_dashboard.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>
                <i class="icon-desktop"></i>Feedback DashBoard
                                ...
                                <div class="widget-box">
                                    ...
                                    <div class="widget-body">
                                        <div style="font-size: 14px" class="widget-main">
                                            ...
                                            <br />
                                            <br />
                                            2. Check the Course code, Course title and the Name of the Instructor on the feedback
                                            form. (In case you have any query related to Course title and Instructor, please
                                            contact University Staff Office at student.feedback@cept.ac.in before filling up the form).<br />
                                            <br />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            if (getParameterByName("autho") == 'c') {
                bootbox.alert('Feedback is Closed.');
            }
        });
