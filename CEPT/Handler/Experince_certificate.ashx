<%@ WebHandler Language="C#" Class="Experince_certificate" %>

using System;
using System.Web;

public class Experince_certificate : IHttpHandler, System.Web.SessionState.IReadOnlySessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
            ...
            string Serverpath = System.Configuration.ConfigurationManager.AppSettings["NON_FacultyProfile_EXP_UploadPath"];
