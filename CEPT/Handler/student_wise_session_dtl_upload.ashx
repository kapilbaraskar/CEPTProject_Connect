<%@ WebHandler Language="C#" Class="student_wise_session_dtl_upload" %>
...
public class student_wise_session_dtl_upload : IHttpHandler, IReadOnlySessionState {
         ...
         try
        {
            ...
            else
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = web.ExcelFileToDatatable_upload_student_session_wise_attendance(file, context);
                    //string message = "";
