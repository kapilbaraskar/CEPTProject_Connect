<%@ WebHandler Language="C#" Class="site_joining_report_handler" %>

using System;
using System.Web;

public class site_joining_report_handler : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
            ...
            string Serverpath = System.Configuration.ConfigurationManager.AppSettings["SiteJoinReportPath"];

            if (context.Request.Files.Count > 0)
            {
                var postedFile = context.Request.Files[0];
                string filesize = System.Configuration.ConfigurationManager.AppSettings["SiteJoinReportPathMaxSize"];
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    finalFileName = user_id + "_" + d + file;
