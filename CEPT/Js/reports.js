...
function get_total_offered_course() {
    ...
    $.ajax({
        type: "POST",
        url: "../../WebService.asmx/get_total_offered_course_report",
...
//          { "sTitle": "Total No. of Elective subjects Offered", "mData": "elective", "bSortable": false },
        //            { "sTitle": "Total", "mData": "total", "bSortable": false }
                    ...
                    { "sTitle": "Elective", "mData": "E", "bSortable": false },
                    { "sTitle": "Mandatory", "mData": "M", "bSortable": false }
...
function get_faculty_wise_total_course() {
    ...
    $.ajax({
        type: "POST",
        url: "../../WebService.asmx/get_faculty_wise_total_course_report",
        data: "{}",
        contentType: "application/json; charset=utf-8",
        datatype: "json",
        success: function (data) {
...
function get_faculty_type_wise_total_course() {
    ...
    $.ajax({
        type: "POST",
        url: "../../WebService.asmx/get_faculty_type_wise_total_course_report",
        data: "{}",
        contentType: "application/json; charset=utf-8",
        datatype: "json",
        success: function (data) {
...
function get_course_type_offered_report() {
    ...
    $.ajax({
        type: "POST",
        url: "../../WebService.asmx/get_course_type_offered_report",
        data: "{}",
        contentType: "application/json; charset=utf-8",
        datatype: "json",
        success: function (data) {
...
function get_course_type_and_credits_offered_report() {
    ...
    $.ajax({
        type: "POST",
        url: "../../WebService.asmx/get_course_type_various_offered_report",
        data: "{}",
        contentType: "application/json; charset=utf-8",
        datatype: "json",
        success: function (data) {
...
function get_course_type_credits_offered_report() {
    ...
    $.ajax({
        type: "POST",
        url: "../../WebService.asmx/get_course_type_credit_various_offered_report",
        data: "{}",
        contentType: "application/json; charset=utf-8",
        datatype: "json",
        success: function (data) {
