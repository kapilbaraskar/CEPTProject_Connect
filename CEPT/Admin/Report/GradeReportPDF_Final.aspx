<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GradeReportPDF_Final.aspx.cs"
    Inherits="Admin_Report_GradeReportPDF_Final" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if ($("#hdn_course_detail").val() != '') {
                for (var k = 0; k < obj_course_detail.length; k++) {
                    if (obj_course_detail[k]["course_code"] == "CFP001" || obj_course_detail[k]["course_code"] == "CFP002" || obj_course_detail[k]["course_code"] == "CFP003" || obj_course_detail[k]["course_code"] == "CFP004" || obj_course_detail[k]["course_code"] == "CFP005" || obj_course_detail[k]["course_code"] == "CFP006" || obj_course_detail[k]["course_code"] == "CFP007" || obj_course_detail[k]["course_code"] == "CFP008" || obj_course_detail[k]["course_code"] == "CFP009" || obj_course_detail[k]["course_code"] == "CFP010")
                    {
            ...
            $('table,table th,table td').css('border-color', 'black');
            ...
            $('#td_dateofissue').html(day + "/" + month + "/" + year);
        });
        ...
        function setStudentFoundationDetail() {
            ...
            //30072019 keep this below Ln 127 - else if (obj_stud_detail[0]['prog_code'] == '1') { // FD UG
            ...
            if (obj_stud_detail != null && obj_stud_detail != undefined) {
                ...
                $('#td_found_degree').html(str_program_new.toUpperCase());//27/08/2019 15122021

                //if (obj_stud_detail[0]["degree_code"] != "" && obj_stud_detail[0]["degree_name"] != "") {
                //    $('#td_found_degree').html(obj_stud_detail[0]["degree_name"].toUpperCase());//15122021
                //} else {
                //    $('#td_found_degree').html(str_program_new.toUpperCase());//27/08/2019 15122021
                //}
        ...
        function setStudentDetail() {
            ...
            if (obj_stud_detail != null && obj_stud_detail != undefined) {
                ...
                else if (obj_stud_detail[0]['dept_code'] == '4' && obj_stud_detail[0]['prog_code'] == '2' && stud_year_code >= 'Y2018' && obj_stud_detail[0]['prog_level_code'] == 'PP2') { // FP PG
                    str_program = 'MASTER OF URBAN DESIGN';
                }
                else if (obj_stud_detail[0]['dept_code'] == '4' && obj_stud_detail[0]['prog_code'] == '2' && stud_year_code >= 'Y2018' && obj_stud_detail[0]['prog_level_code'] == 'PP3') { // FP PG
                    str_program = 'MASTER OF URBAN PLANNING';
                }
                else if (obj_stud_detail[0]['dept_code'] == '4' && obj_stud_detail[0]['prog_code'] == '2' && stud_year_code >= 'Y2018' && obj_stud_detail[0]['prog_level_code'] == 'PP4') { // FP PG
                    str_program = 'MASTER OF URBAN TRANSPORT SYSTEMS';
                }
                else if (obj_stud_detail[0]['dept_code'] == '4' && obj_stud_detail[0]['prog_code'] == '2' && stud_year_code >= 'Y2018' && obj_stud_detail[0]['prog_level_code'] == 'PP5') { // FP PG
                    str_program = 'MASTER OF URBAN INFRASTRUCTURE';
                }
                else if (obj_stud_detail[0]['dept_code'] == '4' && obj_stud_detail[0]['prog_code'] == '2' && stud_year_code >= 'Y2018' && obj_stud_detail[0]['prog_level_code'] == 'PP6') { // FP PG
                    str_program = 'MASTER OF URBAN HOUSING';
                }
                else if (obj_stud_detail[0]['dept_code'] == '4' && obj_stud_detail[0]['prog_code'] == '2' && stud_year_code >= 'Y2015') { // FP PG
                    str_program = 'MASTER OF URBAN AND REGIONAL PLANNING';
                }
                ...
                //$('#td_program').html(str_program_new.toUpperCase());//27/08/2019 08/02/2021 Mahroofbhai Called.The value should be picked up from the degree table based on the degree code.

                if (obj_stud_detail[0]["degree_code"] != "" && obj_stud_detail[0]["degree_name"] != "") {
                    $('#td_program').html(obj_stud_detail[0]["degree_name"].toUpperCase());
                } else {
                    $('#td_program').html("");
                }
                ...
                $('#td_program_name').html(str_program_new.toUpperCase());

                $('#td_name').html((obj_stud_detail[0]["full_name"]).toUpperCase());

                $('#td_faculty_name').html('FACULTY OF ' + obj_stud_detail[0]["dept_name"]);
        ...
        function setCourseFoundationDetail() {
            ...
            if (obj_stud_detail[0]["year_code"] >= "Y2019")
            {
                ...
                {
                    grade_style = "NEW";
                    //if ($('#hdn_sem').val() == "M" && parseInt($('#hdn_year').val()) >= 2024) {
                    //    grade_style = "OLD";
                    //}
                    
                }
            }
            //11092020 CFP Marks Grade Change like M 2019 and onwardsd
        ...
        function setCourseDetail() {
            if (obj_course_detail != null && obj_course_detail != undefined) {
                ...
                for (var i = 0; i < obj_course_detail.length; i++) {
                    ...
                    //strTableCourseDetail = strTableCourseDetail + "<td style='text-align: center;' class='cls_found_hide'>" + obj_course_detail[i]['grade_point'] + "</td>"; //02012020
            ...
            $('#tbl_course_marks').css('border-right', '0');
            $('#tbl_course_marks th:last-child').css('border-right', '1px solid');
            $('#tbl_course_marks td:last-child').css('border-right', '1px solid');
        }
        ...
        function set_WS_CourseDetail() {
            ...
            //if (obj_ws_course_detail != null && obj_ws_course_detail != undefined) {
            //    var strTableCourseDetail = "<tr><th colspan='9' style='padding-top:20px;padding-left:0;border-left:0;border-right:0 !important;'><b>" + $('#h5_ws').html() + "</b></th></tr>";

            //    strTableCourseDetail += "<tr><th style='text-align: center;'>COURSE CODE</th><th class='cls_set_colspan' style='text-align: center;' colspan='4'>COURSE NAME</th><th style='text-align: center;'>GPA/ NGPA</th><th style='text-align: center;' colspan='2'>CREDITS</th><th style='text-align: center;border-right:1px solid;'>STATUS</th></tr>";
            ...
            //                                "<td style='text-align: center;'>" + obj_ws_course_detail[i]['course_code'] + "</td>" +
            //        //"<td>" + obj_ws_course_detail[i]['course_name'] + "</td>";
            //                                "<td class='cls_set_colspan' colspan='4'>" + str_course_name + "</td>";
            ...
            //        strTableCourseDetail = strTableCourseDetail + "<td style='text-align: center;' colspan='2'>" + obj_ws_course_detail[i]['course_credits'] + "</td>";
            ...
            if (obj_credit_detail != null && obj_credit_detail != undefined) {
                ...
                if (obj_credit_detail[0]['grade_point_avg'].toString() == '-') {
                    ...
                    if (obj_stud_detail[0]["year_code"] < 'Y2014') {
                        ...
                        $('#td_grade_point_avg').html("<b>" + round_num(obj_credit_detail[0]['grade_point_avg'], 2) + "</b>");
                        ...
                        $('#td_grade_point_avg').html("<b>" + round_num(round_num(obj_credit_detail[0]['grade_point_avg'], 2), 1) + "&nbsp; </b>");
                    } else {
                        $('#td_grade_point_avg').html("<b>" + round_num(round_num(obj_credit_detail[0]['grade_point_avg'], 2), 1) + "&nbsp; </b>");//*
                    }
                }
        ...
        function display_Grade_Range() {
            ...
            if (obj_stud_detail[0]["year_code"] >= 'Y2014') {
                //$('.cls_set_colspan').attr('colspan', '3');
            }
        }
...
<body class="container" style="color: Black; width: 985px;">
    <%--<div style="top: 20px; height: 120px; left: 1px;" title="" id="i22byht1">
        <a style="width: 297px; height: 96px; cursor: pointer;float:right;" href="../Master/Home.aspx">
            <div style="width: 297px; height: 96px; position: relative;">
                <img alt="" style="width: 297px; height: 96px; object-fit: cover;" src="../../image/ceptlogo_pdf.jpg" id="img_pdf_logo" class="s4imgimage" />
            </div>
        </a>
    ...
    <%--<div style="top: 20px; height: 50px; left: 1px;" title="" id="i22byht1">
        %--<a style="width: 288px; height: 96px; float: right; margin-top: 1px;">--%
        <a style="width: 288px; height: 75px; float: right; margin-top: 1px;">
            <div id="div_pdf_logo" style="width: 288px; height: 152px; position: relative; display: none;">
    ...
    <div style="margin-top: 48px;">
        <table class="table table-condensed cls_found_hide">
            <tr>
                ...
                <td id="td_name" style="border: none;" colspan="3"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border: none; width: 10px;">:</td>
                <td id="td_program_name" style="border: none;" colspan="3"></td>
            </tr>
            <tr class="PG">
                <td style="border: none; width: 240px;"><b>NAME OF THE DEGREE</b></td><%--NAME OF THE DEGREE--%><%--20/01/2021 Mahroofbhai Called--%><%--NAME OF THE PROGRAM--%><%--08/02/2021 Mahroofbhai Called--%>
                <td style="border: none; width: 10px;">:</td>
                <td id="td_program" style="border: none;" colspan="3"></td>
            </tr>
            <tr>
                <td style="border: none; width: 240px;"><b>NAME OF THE FACULTY</b></td>
                <td style="border: none; width: 10px;">:</td>
                <td id="td_faculty_name" style="border: none;" colspan="3"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border: none; width: 10px;">:</td>
                <td id="td_year" style="border: none; width: 450px;"></td>

                <%--<td style="border:none;width:160px;"><b>DATE OF ISSUE : </b></td>
                <td id="td_dateofissue" style="border:none; float: right;"></td>--%>

                <td style="border: none; float: right;"><b>DATE OF ISSUE : </b></td>
                <td style="border: none;"><span style="float: right; font-weight" id="td_dateofissue"></span></td>
            </tr>
        ...
        <table class="table table-condensed cls_found_show">
            ...
            <%--NAME OF THE DEGREE--%><%--20/01/2021 Mahroofbhai Called--%><%--NAME OF THE PROGRAM--%><%--08/02/2021 Mahroofbhai Called--%>
            <%--<tr>
                <td style="border: none; width: 240px;"><b>NAME OF THE DEGREE</b></td>
                <td style="border: none; width: 10px;">: </td>
                <td id="td_found_degree" style="border: none; " colspan="3"></td>
            </tr>--%>
            <tr>
                <td style="border: none; width: 240px;"><b>NAME OF THE PROGRAM</b></td><%--NAME OF THE DEGREE--%><%--20/01/2021 Mahroofbhai Called--%><%--NAME OF THE PROGRAM--%><%--08/02/2021 Mahroofbhai Called--%>
                <td style="border: none; width: 10px;">: </td>
                <td id="td_found_degree" style="border: none; " colspan="3"></td>
            </tr>
            <tr>
    ...
    <div style="min-height: 567px;"><%--595--%>
        <div>
            ...
            <tr>
                <td>
                    <table class="table table-condensed" style="margin-bottom: 15px; margin-top:15px;">
                        ...
                        <tr>
                            <td style="border: none; padding-left: 35px;">GPA
                            </td>
                            <td style="border: none;">-
                            </td>
                        ...
                        <tr>
                            <td style="border: none; padding-left: 35px;">NGPA
                            </td>
                            <td style="border: none;">-
                            </td>
                        ...
                        <tr style="display:none;">
                            <td style="border: none;">SUMMER/WINTER SCHOOL
                            </td>
                            <td style="border: none;">-
                            </td>
                ...
                <td>
                    <table>
                        <tr id="tr_semester_marks_avg">
                            <td style="border: none;">
                                <b>SEMESTER MARKS AVERAGE</b>
                            </td>
                            <td style="border: none;">
                                <b>: </b>
                            </td>
                        ...
                        <tr style="display: none;">
                            <td style="border: none;">SEMESTER GRADE POINT RATIO
                            </td>
                            <td style="border: none;">:
                            </td>
    ...
    <div style="margin-top: -15px; margin-bottom: 5px; font-size: 11px; display: none">
    ...
    <%--28/082019 Call Removed for all Tapanbhai Said--%>
    ...
    <div style="display: block;" class="cls_found_hide">
        <div id="div_white_space" style="height: 70px;"></div>
        <div style="float: left; font-weight: bold; margin-top: 10px; width: 50%;">PROGRAM CHAIR</div>
        <div style="float: left; font-weight: bold; margin-top: 10px;">DEAN</div>
    </div>

    <div class="cls_found_show" style="font-weight: bold; float: left; margin-top: 4%;">PROGRAM CHAIR  <span style="margin-left: 260px;">DEAN, CFP</span></div>
