<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="VF_Finance_Report_Print.aspx.cs" Inherits="Admin_Report_VF_Finance_Report_Print" %>
...
//            }
        ...
        function display_Student_Data(data) {
            ...
            $('#SITE_CONTAINER').append(tbl_example);
