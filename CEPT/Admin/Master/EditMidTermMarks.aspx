<%@ Page Title="Edit Mid-Term Marks" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="EditMidTermMarks.aspx.cs" Inherits="Admin_Master_EditMidTermMarks" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="../../Js/EditMidTermMarks.js?t=08102021" type="text/javascript"></script><%--19092020--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="well" style="background-color: White;">
        ...
        <table style="width: 62%; margin-left: 15%;display:none;">
            <tr>
                <td align="right">
