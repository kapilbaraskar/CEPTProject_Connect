<%@ Page Title="Edit Course" Language="C#" MasterPageFile="~/AdminCEPT.master"
    AutoEventWireup="true" CodeFile="frmcoursemaster.aspx.cs" Inherits="Admin_Master_frmcoursemaster" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../../DesignCss/jquery.timepicker.css" rel="stylesheet" type="text/css" />
    <script src="../../Js/course_master.js?t=13032025" type="text/javascript"></script> 
    <%--14062019--%><%--11122019--%><%--06052020--%><%--15062020--%><%--09072020--%><%--18112020--%>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            if ($("#hdn_utype").val() == 'CW') {
                ...
                $('#btnRetrieve1').css('display', 'block');
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>
                <i class="icon-desktop"></i>Course Modification
            </h1>
        </div>
    </div>
            ...
            <div style="padding: 10px; overflow: visible;" id="div_progcoord_panel" class="panel-collapse collapse in">
                <div>
                    <table style="width: 100%;" cellpadding="10" cellspacing="20">
                       ...
                       <%-- <tr id="tutor_type_select" style="display:none;">
                            <td class="cls_select_type">Course Include
                            </td>
                            <td class="cls_select_type">
                                <input type="checkbox" id="rdo_t" name="rdo_select_type" value="Y" />&nbsp;Tutorial&nbsp;&nbsp;
                                <input type="checkbox" id="rdo_ta" name="rdo_select_type" value="N" />&nbsp;TA
                            </td>
                 ...
                 <div class="row" style="display: block; width: 100%;">
                     ...
                     <div class="row-fluid" id="datalist_timeday" style="margin-top: 50px; margin-left: 2%; float: left; margin-bottom: 12px; width: 37%; display: block;">
                        ...
                        <table class="data-table table table-bordered table-striped" border="0" id="tbltimeday" style="width: 180%;">
                            <thead>
                                <tr>
                                    <th>From Time</th>
                                    <th>To Time</th>
                    ...
                    <p style="color:red;display:none;" id="course_text"><b>Note: This is also change the instructor time slot.</b></p>
                    <p style="color:red;display:none;" id="studio_text"><b>Note: Please ensure that your modify the instructor time slot.(Approximately)</b></p>
                     </div>
                ...
                <div style="display: block; width: 100%;">
                    <div class="row-fluid" id="dataList_instructor" style="margin-top: 50px; float: left; width: 31%; display: block;">
                        <span id="no_of_tutor" style="display:none;"><b>No Of Tutor :  </b><span id="no_of_tutor_bind" style="color:red;"></span><br />
                        ...
                        <table class="data-table table table-bordered table-striped" border="0" id="tblinstructor" style="width: 320% !important">
                            <thead>
                                <tr>
...
<%--                        <div class="box-content box-no-padding">
                            <button class="btn  btn-primary" type="button" disabled>
                                <i class="icon-plus"></i>&nbsp; Instructor hours
                            </button>
                        </div>

                        <table class="data-table table table-bordered table-striped" border="0" id="tblinstructor_time_slot" style="width: 170% !important">
                            <thead>
                                <tr>
                                     <th>Instructor</th>
                                    <th>From Time</th>
                    ...
                    <div class="panel panel-default ">
                        <div class="panel-heading">
                            <strong><span class="panel-headingfont">Add AA</span></strong>
                        </div>

                        <div style="padding: 15px;">
                            <div class="row-fluid" id="dataList_instructor_aa" style="float: left; width: 100%;">
                                <div class="box-content box-no-padding">
                     ...
                     <div class="panel panel-default ">
                        <div class="panel-heading">
                            <strong><span class="panel-headingfont">Add TA</span></strong>
                        </div>

                        <div style="padding: 15px;">
                           

                            <div class="row-fluid" id="dataList_instructor_ta" style="margin-left: 1%; float: left; margin-bottom: 12px; width: 100%;">
                                <div class="box-content box-no-padding">
            ...
            <div style="padding: 10px;" id="div_instructor_panel" class="panel-collapse collapse in">
                ...
                <div class="panel panel-default ">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" style="margin-top: 15px;">
                            ...
                            <div class="form-group col-md-2 color-blue">
                                Brief Description:  <%--Course Introduction--%>
                                <br />(Max 2000 characters with space) or
                            ...
                            <div class="form-group col-md-9">
                                <textarea id="txtcourse_description" style="width: 100%; margin-bottom: 0px;" rows="6"
                                    cols="50" name="address" maxlength="2000"></textarea><%--onkeypress="return charcount(event)"onkeydown="return keydown_removechar(event)"--%>
                            ...
                            <div class="form-group col-md-2 color-blue l2l3 l2l3l4">
                                Long Description
                                <br /><%--(Min 1100- Max 3000 characters with space)--%>
                ...
                <div class="panel panel-default ">
                    ...
                    <div class="panel-body">
                     ...
                     <%--  <a href="#" download="" style="color:blue;font-size:12px;">(Refer docs)</a>--%>
                        <br />
                        <br />
                        <div class="row">
                            <div class="form-group col-md-2 color-blue">
    ...
    <asp:HiddenField ID="hdn_faculty_flag" runat="server" ClientIDMode="Static" />
    <asp:HiddenField ID="hdn_pc_flag" runat="server" ClientIDMode="Static" />
    <asp:HiddenField ID="hdn_ugpg_flag" runat="server" ClientIDMode="Static" />
</asp:Content>
