<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageDesign.master" AutoEventWireup="true"
    CodeFile="PaymentResponseNetBanking_WS.aspx.cs" Inherits="Student_PaymentResponseNetBankingArchitecture" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        <div data-bind="template: {name:status,data:data}" class="col-md-8 col-md-offset-2"
