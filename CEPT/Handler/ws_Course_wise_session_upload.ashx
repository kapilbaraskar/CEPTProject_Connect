<%@ WebHandler Language="C#" Class="ws_Course_wise_session_upload" %>

using System;
using System.Web;
using System.Web.SessionState;

public class ws_Course_wise_session_upload : IHttpHandler,IReadOnlySessionState {
        ...
        try
        {
            ...
            else
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = web.ws_ExcelFileToDatatable_upload_session_wise_attendance(file, context);
                   // string message = "";
