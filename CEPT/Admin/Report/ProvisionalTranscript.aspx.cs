...
public partial class Admin_Report_ProvisionalTranscript : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            else if(Session["user_type"].ToString() != "FA" && Session["user_type"].ToString() != "A1" && Session["user_type"].ToString() != "PC") 
            {
    ...
    public DataTable get_Student_transcript_dtl(string uid, string sem, string year)
    {
        ...
        try
        {
            ...
            if (Get_convocation_year_data != null && Get_convocation_year_data.Rows[0]["completion_date_code"] != "" && Convert.ToInt32(Get_convocation_year_data.Rows[0]["completion_date_code"].ToString().Substring(0, 4)) >= Convert.ToInt32("2023"))
            {
            ...
            {
                cmd.CommandText = "select student_transcript_completion_date.completion_date,student_transcript_completion_date.convocation_year,degree_mst.degree_name,UPPER(programme_level_mst.prog_level_name)prog_level_name, student_transcript_dtl.* from student_transcript_dtl "
                             + "left join degree_mst on degree_mst.degree_code=student_transcript_dtl.degree_code "
