<%@ Page Title="Course Selected By Student - CEPT" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true"
    CodeFile="total_selected_course_type_wise.aspx.cs" Inherits="Admin_Report_total_selected_course_type_wise" %>
            ...
            <table style="margin-top:10px" width="100%" border="0" cellpadding="5" cellspacing="5">
                    <tr>
                        <td align="right">
                            ...
                            <td align="left">
                            <button class="btn btn-primary" style="display:none;left: -66px;" type="submit" id="btn_publish">
