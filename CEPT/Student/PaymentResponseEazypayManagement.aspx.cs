...
public partial class Student_PaymentResponseEazypayManagement : System.Web.UI.Page
{
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    if (Session["SessionId"] != null && Session["UserId"] != null)
                    {
                        ...
                        string message = objPayment.SavePaymentDetails_Eazypay(Request, ref paymentResponse, "3");// 3 = Management
