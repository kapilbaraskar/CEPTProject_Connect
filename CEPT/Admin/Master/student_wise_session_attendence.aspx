<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="student_wise_session_attendence.aspx.cs" Inherits="Admin_Master_student_wise_session_attendence" %>
    ...
    <script type="text/javascript">
        ...
        function course_wise_student()
        {
            $.ajax({
                ...
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "../../WebService.asmx/get_session_date_wise_dtl",
                ...
                $.ajax(
                    {
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "../../WebService.asmx/save_all_students_wise_session_value",
                        //async: false,
                        //async: true,
        ...
        function UploadAttendance() {
            try {
                ...
                if (CheckMarksDocumentExtension(fileToUpload)) {
                    ...
                    $.ajaxFileUpload({
                        type: "POST",
                        url: '../../Handler/student_wise_session_dtl_upload.ashx',
                        secureuri: false,
        ...
        function preview_page() {
            window.location = "course_wise_enter_session_dtl.aspx?c=" + $('#hdn_code').val() + "&s=" + $('#hdn_semester').val() + "&y=" + $('#hdn_year').val();
        }
