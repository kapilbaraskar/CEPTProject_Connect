...
public partial class Student_PaymentResponseNetBankingTechnology : System.Web.UI.Page
{
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    if (Session["SessionId"] != null && Session["UserId"] != null)
                    {
                        ...
                        string message = objPayment.SavePaymentDetails(Request, ref paymentResponse, "1b5f4a5d48d6c4a80218a6a105dbe34a1c4ea56a");
                            ...
                            if (paymentResponse.data.user_id != null && paymentResponse.data.user_id != string.Empty)
                            {
                                ...
                                if (dtCandidatePersonalDetails != null && dtCandidatePersonalDetails.Rows.Count > 0)
                                {
                                    ...
                                    try
                                    {
                                       ...
                                       // email_data["program_name"] = "Cept Faculty of Technology";
                                        ...
                                        {
                                            email_data["program_name"] = "Faculty of Technology";
                                        }
                ...
                try
                {
                    if (Session["SessionId"] != null && Session["UserId"] != null && paymentResponse.status == "paymentFail")
                    {
                        ...
                        {
                            dic_payment_fail_dtl["program_name"] = "Faculty of Technology";
                        }
