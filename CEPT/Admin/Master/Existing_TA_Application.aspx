<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="Existing_TA_Application.aspx.cs" Inherits="Admin_Master_Existing_TA_Application" %>
...
<link type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.2.0/css/datepicker.min.css" rel="stylesheet" />
    ...
    <script src="../../Js/TA_Personal_Detail.js?t=04032025" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <div class="row-fluid" id="for_other" style="display: none;">
        <div class="page-header position-relative">
            <h1>
                <i class="icon-desktop"></i>&nbsp;TA Application  
            </h1>
        </div>
    </div>
    ...
    <%--<div class="row" style="margin-top: 11px; width: 64.3%; border: 0px solid rgba(113, 112, 112, 1); background-color: rgba(255, 255, 255, 1); border-radius: 0; box-shadow: 0 1px 4px rgba(0, 0, 0, 0.6); margin-left: 1px; display: none;" id="for_I2">
        <h5 class="font_8" style="margin-left: 5px; font-size: 18px; margin-top: 3px;">TA Application Details
            <span style="font-size: 10pt; float: right; margin-right: 1.2%; text-shadow: 0 0 slateblue; display:none;"><a href="Studio_Proposal_dtl.aspx">View Submitted Proposal</a></span>
                ...
                <li class="col-md-3 active" id="pd" style="width: 27.5% !important;">
                    <div class="media">
                        ...
                        <div class="media-body">
                          ...
                          <p id="pdclick" style="color: black;">TA Application Details</p>
                           

                        </div>
                    </div>
                </li>
                <li class="col-md-3 active" id="ip" style="width: 28% !important; display:none;">
                    <div class="media">
                        <div class="pull-left" href="#">
    ...
    <div class="well" style="background-color: White; margin-top: 1%;">
        ...
        <div class="panel panel-default " style="display:none;">
            ...
            <div class="row" style="margin-left:10px; margin-bottom:5px;">
                <p style="color: blue;">Applying to assist a Course at the faculty of</p><br />
                <input type="checkbox" class="check_dept" value="1" id="course_1" /> Architecture 
                &nbsp;&nbsp;<input type="checkbox" class="check_dept" value="2" id="course_2"  /> Design 
                &nbsp;&nbsp;<input type="checkbox" class="check_dept" value="5" id="course_5" /> Technology 
                &nbsp;&nbsp;<input type="checkbox" class="check_dept" value="4" id="course_4"  /> Planning 
                &nbsp;&nbsp;<input type="checkbox" class="check_dept" value="3" id="course_3" /> Management
                &nbsp;&nbsp;<input type="checkbox" class="check_dept" value="10" id="course_10" /> Doctoral Programs
                &nbsp;&nbsp;<input type="checkbox" class="check_dept" value="9" id="course_9" /> CEPT Foundation Program
            </div>

            <div class="row" style="margin-left:10px; margin-bottom:5px;">
                <p style="color: blue;">Applying to assist a studio at the faculty of</p><br />
                <input type="checkbox" class="check_dept" value="1" id="dept_1" /> Architecture 
                &nbsp;&nbsp;<input type="checkbox" class="check_dept" value="2" id="dept_2"  /> Design 
                &nbsp;&nbsp;<input type="checkbox" class="check_dept" value="5" id="dept_5" /> Technology 
                &nbsp;&nbsp;<input type="checkbox" class="check_dept" value="4" id="dept_4"  /> Planning 
                &nbsp;&nbsp;<input type="checkbox" class="check_dept" value="3" id="dept_3" /> Management
                &nbsp;&nbsp;<input type="checkbox" class="check_dept" value="9" id="dept_9" /> CEPT Foundation Program
            </div>
            </div>
            ...
            <div style="padding: 10px; overflow: visible;" id="div_personal_detail" class="panel-collapse collapse in">
                ...
                <table style="width: 100%;" cellpadding="10" cellspacing="20">
                    ...
                    <tr>
                     ...
                     <tr>
                         <td class="pad-top">Are you a CEPT Student ? <span class="cls_mendatory_I2" style="display: none; color: Red;">*</span>
                        </td>
                        <td>
                            <input type="radio" id="CEPTSTU" class="" name="CEPTSTU_DTL" value="Y" style="margin-top: -1px;" />
                            Yes
                            <input type="radio" id="CEPTSTU" class="" name="CEPTSTU_DTL" value="N" checked style="margin-top: -1px;" />
                            No
                        </td>

                        <td class="pad-top labelstudentid" style="display:none;">CEPT Student ID<span class="cls_mendatory" style="display: none; color: Red;">*</span>
                        </td>
                        <td>
                            <input type="text" id="txt_ceptstudentid" style="display:none;" class="marg-btm textstudentid" placeholder="CEPT Student ID"/>
                        </td>
                    </tr>
            ...
            <div style="padding: 10px; overflow: auto;" id="div_academic_qualification_dtl" class="panel-collapse collapse in">
                <table id="tbl_academic_qualification" style="width: 100%;" cellpadding="10" cellspacing="20">
                    ...
                    <tr>
                        ...
                        <td>
                            <%--<input type="text" class='date-picker' placeholder="MM/YYYY" style="width: 80px;"/></td>--%>
                ...
                <table id="tbl_work_experiance" style="width: 100%;" cellpadding="10" cellspacing="20">
                    <tr>
                     ...
                     <th>Name of Institute / Organization</th>
                        ...
                        <th>Upload WorkExperience Certificate</th>
                        <th>Delete</th>
                    ...
                    <tr>
                        ...
                        <td>
                         ...
                         <td>
                            <select class="work_mode_type" style="width: 110px;">
                                <option value="">Please Select Mode Type</option>
                        ...
                        <td>
                            <input type="text" class="marg-btm onchangetext" id='total_hrs_0' style="width: 120px;" /></td>
        ...
        <div class="panel panel-default">
         ...
         <div class="panel panel-default">
            <div class="panel-heading">
                <b>Last Studio/courses you have assisted as TA at CEPT in past  if any</b>
                <span style="color: blue; display:none">&nbsp;(MAX 150 Words)</span>
            </div>

            <div style="padding: 10px; overflow: visible;" id="div_prev_ta" class="panel-collapse collapse in">
                <div class="row" style="margin-top: 15px;">
                    <div class="form-group col-md-11">
                        <textarea id="txt_prev_ta_dtl" style="width: 100%; margin-bottom: 0px;" rows="6" cols="50" name="prev_ta_dtl"></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="panel panel-default ">
            ...
            <div class="panel-heading">
                <b>Upload Portfolio </b><span class="" style="color: Red;">*</span>
        ...
        <div class="panel panel-default ">
            ...
            <div class="panel-heading">
                <b>Upload Reference Letter </b><span class="" style="color: Red; display:none;">*</span>
                <span style="color: blue;">&nbsp;(From a faculty member who has taught you for at least six months or to whom you have provided academic assistance previously)</span>
            </div>

            <div style="padding: 10px; overflow: visible;" id="div_reference_letter" class="panel-collapse collapse in">
                <label class="btn btn-primary file-upload " style="vertical-align: bottom;">
                    <span><strong>Upload Reference Letter</strong></span>
                    <input type="file" name="referenceletter" id="reference_letter" onchange="javascript:return Uploadreferenceletter();" style="display: none;" />
                </label>
                <span id="lbl_reference_letter_name" style="vertical-align: super;"></span>
            </div>
