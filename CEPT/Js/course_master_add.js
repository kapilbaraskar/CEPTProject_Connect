...
var image_save_date;
var obj_FileName = [];
var short_dept = { '1': 'FA', '2': 'FD', '3': 'FM', '4': 'FP', '5': 'FT' }
...
var dept_timetable_dtl = [];
var ret_status = false;//18052022
var ret_onchange_status = true;
var bind_count = 0;
//14 11 2019
...
//    if ($('#txtcourse_description').val().length >= 1350) {
...
$(document).ready(function () {
    ...
    $("#drcourses").change(function () {
        var selectedText = $(this).find("option:selected").text();
        var selectedValue = $(this).val();

        if (selectedText != ' -- Please Select course -- ') {
            var newdrcourses = $('#drcourses').val();
            if (newdrcourses != '') {
                $("#txtcoursecode").val('' + cur_sem + cur_year + "_" + newdrcourses);

            }
            else {
                $("#txtcoursecode").val('' + cur_sem + cur_year + "_" + d.getDate() + d.getMonth() + d.getHours() + d.getMinutes());
            }
        }
    ...
    $('#previous_semester').click(function () {
        if ($(this).is(':checked')) {
            $("#prev_data").show();
        } else {
            $("#prev_data").hide();
    ...
    //    //$('#spn_desc').html('' + 'Total Char : ' + $('#txtcourse_description').val().length);
    //    if (cnt < 1350) {
    //        if ((cnt + pastedText.length) >= 1350) {
    //            $('#spn_desc').html('' + 'Total Char : ' + 1350);
    //            bootbox.alert('You Exceeds the Character Limit');
    //        }
    //        else {
    ...
    // NEw 17052022
    //$(".cls_select_type input[name='rdo_select_type_T']").click(function ()
    //{
    //    alert($('input:radio[name=rdo_select_type_T]:checked').val());
    //    if ($('input:radio[name=rdo_select_type_T]:checked').val() == "N")
    //    {
    //        alert($('input:radio[name=rdo_select_type_T]:checked').val());
    ...
    $('#drpdepartment').on('change', function () {
        ...
        if ($('#txtcoursecode').val().substring(0, 5) == "" + cur_sem + cur_year)
        {
            //$("#txtcoursecode").val('' + cur_sem + cur_year + $("#drpdepartment").val() + $("#drpprog").val() + "_" + d.getDate() + d.getMonth() + d.getHours() + d.getMinutes());
        }
        bind_program_level_code();
        
        bindweek(); //Mayur 29042019
    ...
    /////// comment by Ananth 18-04-2019 /////////

    //$('#drpsemester').on('change', function () {
    //    if ($('#drpsemester').val() == cur_sem) {
    //        $('#div_other_sem_course').css('display', 'none');
    //        $('#drpothercourse').val('');
    //        $('#drpothercourse').trigger("liszt:updated");

    //        $('#div_cur_sem_course').css('display', 'inline-block');
    //    }
    //    else {
    //        $('#div_cur_sem_course').css('display', 'none');
    //        $('#drcourses').val('');
    //        $('#drcourses').trigger("liszt:updated");

    //        $('#drpothercourse_chzn').css('width', '220px');
    //        $('#div_other_sem_course').css('display', 'inline-block');
    //    }
    //});
    ...
    $('#drptypology').on('change', function () {
        ...
        //if ($('#drptypology').val() == '24') {//For 12 and 16 Week // Mayur 25042019
    ...
    function bindweek() {//Mayur 29042019
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.d != "") {
                        ...
                        weeks = parseInt(temp_week_typology) + 1; //Mayur 25042019 Put Variable instead of 12
                        ...
                        //07102021
                        //if ($('#drptypology').val() == '23' || $('#drptypology').val() == '28' && status_week == true) {
    ...
    function bindfocusofstudio() {//Mayur 11092019
        ...
        if (focus_studio_level != "") {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    //    str_data += '<div style="width:60%;float:left;">Focus</div><div style="width:5%;float:left;text-align:center;">Primary</div><div style="width:5%;float:left;text-align:center;">Secondary</div>';
                    ...
                    //        str_data += '<div style="width:60%;float:left;text-align:justify;">' + focus_of_studio[i]["focus_area_name"] + ' &nbsp;&nbsp; <span style="color:#00a1ff;">(' + focus_of_studio[i]["focus_area_desc"] + ')</span></div><div style="width:5%;float:left;text-align:center;"><input type="radio" name="rdo_focus_studio" value="' + focus_of_studio[i]["focus_area_code"] + '" /></div><div style="width:5%;float:left;text-align:center;"><input type="radio" name="rdo_focus_studio_secondary" value="' + focus_of_studio[i]["focus_area_code"] + '" /></div>';
                    //    }
                    //    str_data += '</div>';
    ...
    $('#btn_instructor').on('click', function () {
        ...
        //Already there - var str = "<tr id ='" + add_instructor_cnt + "' data-row_no='" + add_instructor_cnt + "' ><td>" + instructor + "</td><td><select  data-row_no='" + add_instructor_cnt + "' id ='" + add_instructor_cnt + "' class='cls_drp_contact_hrs' style='width: 100%;'><option value='HW'>Hrs/Week</option><option value='HS'>Hrs/Semester</option></select></td><td><input style='width: 30px;' type='text' class='per_load' maxlength='5' onkeypress='return IsNumeric_istructor(event);' /></td><td><input style='width: 30px;' type='text' class='week' maxlength='5' onkeypress='return IsNumeric_istructor(event);' /></td><td><input type='radio' class='cls_radio_tutor' name='rdo_tutor' value='" + add_instructor_cnt + "' /></td><td><center><i data-row_no='" + add_instructor_cnt + "' class='icon-trash icon-2x text-blue 'style='cursor:pointer;'></i></center></td><td><input type='button' value='View'  class ='but_click' /></td></tr>";//id='" + add_instructor_cnt + "' 11 05 2020

        //06112020-Kapil
        //var str = "<tr data-row_no='" + add_instructor_cnt + "' ><td>" + instructor + "</td><td><select  data-row_no='" + add_instructor_cnt + "' class='cls_drp_contact_hrs' style='width: 100%;'><option value='HW'>Hrs/Week</option><option value='HS'>Hrs/Semester</option></select></td><td><input style='width: 30px;' type='text' class='per_load' maxlength='5' onkeypress='return IsNumeric_istructor(event);' /></td><td><input style='width: 30px;' type='text' class='week' maxlength='5' onkeypress='return IsNumeric_istructor(event);' /></td><td><input type='radio' class='cls_radio_tutor' name='rdo_tutor' value='" + add_instructor_cnt + "' /></td><td><center><i data-row_no='" + add_instructor_cnt + "' class='icon-trash icon-2x text-blue 'style='cursor:pointer;'></i></center></td></tr>"//<td><input type='radio' class='cls_radio_tutor' name='rdo_tutor' value='" + add_instructor_cnt + "' /></td>;
        ...
        str += "<td><input id ='" + add_instructor_cnt + '_' + 'add_hrs' + "' style='width: 30px;' type='text' class='add_hrs' maxlength='6' onkeypress='return IsNumeric_istructor_in(event);' onInput='edValueKeyPress_add(" + add_instructor_cnt + ")' /></td>";
    ...
    $('#btn_instructor_ta').on('click', function () {
        ...
        //if ($('#tblinstructor_ta tbody tr').length > 0)
        //{
        //    add_ta_cnt = $('#tblinstructor_ta tbody tr').length;
        //}
        //// Second Changes 16012023
        var str = "<tr data-row_no ='" + add_ta_cnt + "'><td>" + instructor_tutorial + "</td>";
    ...
    $('#btn_time').on('click', function () {
        ...
        var str = "<tr id ='time_" + row_length + "'><td><input style='width: 56px;' id='" + row_length + "' type='text' class='from_time' onchange='calcTotalHour(this)'/></td><td><input id='" + row_length + "' style='width: 56px;' type='text' class='to_time' onchange='calcTotalHour(this)'/></td><td>" + day + "</td><td><select class='marg-btm cls_roomid' id ='drp_" + row_length + "' onchange='room_onchange_event(this)' style='width: 200px;'>" + str_room + "</select><a class='cls_view_room'>View</a></td><td><center><i class='icon-trash icon-2x text-blue 'style='cursor:pointer;'></i></center></td></tr>";
    ...
    else if ($('#hdn_utype').val() == 'FA') {    //Kapil
        var str = "<table style='width: 100%'><tr><td align='right' style='padding-left:20px;'><button id='btnsave' type='button' style='display: block' class='btn btn-primary'>" +
            "<i class='icon-save bigger-160'></i>Save</button></td> " +
            "<td align='left' style='padding-left:40px;'><button id='btnapprove' type='button' style='display: block' class='btn btn-primary'> " +
            "<i class='icon-save bigger-160'></i>Submit</button></td></tr></table>";
    ...
    //        var str = "<table style='width: 100%'><tr><td align='center'><button id='btnsave' type='button' style='display: block' class='btn btn-lg btn-primary'>" +
    ...
    $('#btnapprove').on('click', function () {
        ...
        if ($('#hdn_utype').val() == 'FA') {
            bootbox.alert('You cannot submit the course.');
            return false;
        }
        ...
        if ($('#hdn_utype').val() == 'A1' || $('#hdn_utype').val() == 'PC' || $('#hdn_utype').val() == 'FA') {
            ...
            if ($('#txtcourse_description').val().split(' ').length > 150) {//1380
                action = 'S';
            ...
            if ($('#txt_prep_self_hrs').val() == '') {
                action = 'S';
                bootbox.alert('Please Enter Student Preparatory/Self Study Hours');
                return false;
            }
            //if ($("#drpsubtypology").val() != 1) {
            ...
            if ($('input[name=rdo_outline]:checked').val() == 'weekly') {
                ...
                var flag = true;
                var weeks = window.temp_week_typology; //Mayur 25042019 Put Variable instead of 12
                for (var i = 1; i <= weeks; i++) {
                    if (flag) {
                        if ($('#txt_week' + i).val() == '') {
                            action = 'S';
            ...
            if ($('#drp_typology_group').val() != '' && $('#drptypology').val() != '') {
                ...
                if (temp_selected_typology.length > 0) {// && temp_selected_typology[0]['sub_group'] == 'SG003'
                    ...
                    else if (cur_year == 2021 && cur_sem == "S") {
                    }
                    else if (cur_year >= 2021 && cur_sem == "M") {
                        if ($("#studio_mode").val() == "") {
                            action = 'S';
                            bootbox.alert('Please Select Teaching Mode');
                            return false;
    ...
    $('#btnsave').on('click', function () {
        ...
        var course_data = {
            ...
            'week_reference1': '', 'week_reference2': '', 'week_reference3': '', 'week_reference4': '', 'week_reference5': '', 'week_reference6': '', 'week_reference7': '', 'week_reference8': '', 'week_reference9': '', 'week_reference10': '', 'week_reference11': '', 'week_reference12': '', 'week_reference13': '', 'week_reference14': '', 'week_reference15': '', 'week_reference16': '', 'problem_statement': '', 'studio_mode': '', 'weekly_excercises_path': '', 'hrs_group_id': ''
        };//07102021
        ...
        if (action == 'A') {
            if ($("#drpsubtypology").val() != "" && $("#hdn_utype").val() != 'PC' && $("#hdn_utype").val() != 'FA') {
                ...
                if (textbox.value.split(' ').length <= 150 && textbox.value.split(' ').length >= 15) {//1380 - 1155

                }
                else {
                    action = 'S';
                    //bootbox.alert("Make sure the Brief Description input is between Min 1100 to Max 1300 characters");
                    bootbox.alert("Make sure the Brief Introduction input is between Min 15 to Max 150 Word");
                    return false;
                }
            }
        ...
        var flag_tutor_type = true;
        $("#tblinstructor tbody tr").each(function (j) {
            var instructor_data = { 'instructor_code': '', 'instructor_name': '', 'percent_load': '', 'instructor_contact_hrs': '', 'total_hrs': '', 'additional_hours': '' };//28042022
       ...
       // if ($('#hdn_utype').val() == 'I2') {
        ...
        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "../../WebService.asmx/save_new_course_data",
    ...
    $('#btnRetrieve').click(function () {
        ...
        //    course_code = $('#drpothercourse').val();
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.d[0] != null) {
                    ...
                    else $('input[type=radio][name=rdo_backlog][value=N]')[0].checked = true; //Mayur 25042019
                ...
                if (data.d[1] != null) {
                    ...
                    temp_sub_group_typology = course_dept_data[0]["sub_category_id"]; // Retured By Ananth
                    ...
                    ret_onchange_status = false;
                    $('#drp_semester,#drpdepartment,#drpprog,#drptypology,#drp_color').trigger("liszt:updated");
                ...
                if (data.d[2] != null) {
                    ...
                    for (var i = 0; i < course_instructor_data.length; i++) {
                        if ($("#hdn_utype").val() == 'I2') {
                            ...
                            //Already - there var str = "<tr data-row_no='" + (i + 1) + "'><td>" + instructor + "</td><td><select class='cls_drp_contact_hrs' style='width: 100%;' disabled><option value='HW'>Hrs/Week</option><option value='HS'>Hrs/Semester</option></select></td><td><input style='width: 30px;' type='text' class='per_load' maxlength='5' onkeypress='return IsNumeric_istructor(event);' disabled/></td><td><input style='width: 30px;' type='text' class='week' maxlength='5' onkeypress='return IsNumeric_istructor(event);' disabled/></td><td><input type='radio' class='cls_radio_tutor' name='rdo_tutor' value='" + (i + 1) + "' disabled/></td><td><center><i data-row_no='" + (i + 1) + "' class='icon-trash icon-2x text-blue 'style='cursor:pointer;'></i></center></td><td><input type='button' value='View' class ='but_click' /></td></tr>";// id='" + (i + 1) + "' 11 05 2020
                            ...
                            str += "<td><input id ='" + (i + 1) + '_' + 'add_hrs' + "' style='width: 30px;' type='text' class='add_hrs' maxlength='6' onkeypress='return IsNumeric_istructor_in(event);' onInput='edValueKeyPress_add(" + ( i + 1 ) + ")'/></td>";
                            ...
                            //Already - there - var str = "<tr data-row_no='" + (i + 1) + "'><td>" + instructor + "</td><td><select class='cls_drp_contact_hrs' style='width: 100%;'><option value='HW'>Hrs/Week</option><option value='HS'>Hrs/Semester</option></select></td><td><input style='width: 30px;' type='text' class='per_load' maxlength='5' onkeypress='return IsNumeric_istructor(event);' /></td><td><input style='width: 30px;' type='text' class='week' maxlength='5' onkeypress='return IsNumeric_istructor(event);'/></td><td><input type='radio' class='cls_radio_tutor' name='rdo_tutor' value='" + (i + 1) + "' /></td><td><center><i data-row_no='" + (i + 1) + "' class='icon-trash icon-2x text-blue 'style='cursor:pointer;'></i></center></td><td><input type='button' value='View' class ='but_click' /></td></tr>";// id='" + (i + 1) + "' 11 05 2020
                            ...
                            str += "<td><input id ='" + (i + 1) + '_' + 'per_load' + "' style='width: 30px;' type='text' class='per_load' maxlength='5' onkeypress='return IsNumeric_istructor_in(event);' onInput='edValueKeyPress(" + (i + 1) + ")' /></td>";
                            str += "<td><input id ='" + (i + 1) + '_' + 'week' + "' style='width: 30px;' type='text' class='week' maxlength='5' onkeypress='return IsNumeric_istructor_in(event);' onInput='edValueKeyPress(" + (i + 1) + ")' /></td>";
                    ...
                    //for (var i = 0; i < course_instructor_data.length; i++) {
                    //    $("textarea[data-bind_row_no='" + (i + 1) + "']")[0].value = course_instructor_data[i]["tutor_description"];
                    //}
    ...
    $('#drpsubtypology').on('change', function ()
    {
        ...
        {
            if ($('#drpsubtypology').val() == "1" || $('#drpsubtypology').val() == "L4")
            {
                $('#tbltimeday tbody').html('');
                $('#tblinstructor_time_slot tbody').html('');
            }
    ...
    typology_onchange();//changes 17052022
    ...
    if ($("#hdn_uid").val() == "ugpgoffice" || $("#hdn_uid").val() == "admin.asc@cept.ac.in" || $("#hdn_uid").val() == "ug" || $("#hdn_uid").val() == "pg") {
        //not remove
        remove = false;
    }
    if (remove) {
        $("#admin_rights").remove();//remove
    }

    //$("#txtavailable_seats").keyup(function ()
    //{
    //    debugger;
    //    appendTimetable();
    //});
...
function calcTotalHour(e) {
    ...
    var new_temp_room_id = '';
    var new_temp_room_text = '';
    //var current_id = $('#datalist_timeday .ui-timepicker-input').eq(0).closest('tr');
    //var current_id = this.type;
    //alert(current_id);
    var total_hour = 0;
    var total_min = 0;
    for (var i = 0; i < $('#datalist_timeday .ui-timepicker-input').length; i = i + 2) {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.d != "") {
                ...
                if ($("#hdn_utype").val() == 'I2') {
                    day = "<select id=" + number + " style='width:100px' class='drpday' onchange='calcTotalHour(this)' disabled>";
                    day_tutorial = "<select id=" + number + " style='width:65px' class='drpday_tutorial' disabled>";
                }
                else {
                    day = "<select id=" + number + " style='width:100px' class='drpday' onchange='calcTotalHour(this)'>";
...
function Get_Current_Semester_Detail() {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.d != "") {
                ...
                if (sem_data.length > 0) {
                    cur_sem = sem_data[0]["sem_code"];
                    cur_year = sem_data[0]["year_code"];
                    $('#hdn_s').val(cur_sem);
                    $('#hdn_y').val(cur_year);
                    $('#spnprevsem').html(sem_data[0]["sem_desc"] + " ( Year of Allocation - " + (cur_year - 1) + " ) ");
                    $("#txtcoursecode").val('' + cur_sem + cur_year + "_" + d.getDate() + d.getMonth() + d.getHours() + d.getMinutes());
                    $("#drpsemester").val(cur_sem);

                    get_all_course_time_data();
                }
            }
        },
        error: function (result) {
...
//        type: "POST",
//        contentType: "application/json; charset=utf-8",
//        url: "../../WebService.asmx/Get_Prev_Sem_course_data",
...
function bind_other_sem_course() {

    var sem_code = '';
    if (cur_sem == 'M') sem_code = 'S';
    else if (cur_sem == 'S') sem_code = 'M';

    var year_code = '';
    //    if (cur_sem == 'M') year_code = (cur_year - 1);
    //    else if (cur_sem == 'S') year_code = cur_year;
    if (cur_sem == 'M') year_code = cur_year;
    else if (cur_sem == 'S') year_code = (cur_year - 1);

    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "../../WebService.asmx/Get_Prev_other_Sem_course_data",
        ...
        success: function (data) {
            if (data.d != "") {
                ...
                $('#drpothercourse').empty().append($("<option></option>").val("").html("-- Please Select course --"));
                for (var i = 0; i < year_data.length; i++) {
                    $('#drpothercourse').append($("<option></option>").val(year_data[i]["course_code"]).html(year_data[i]["course_code"]));
                }

                $('#drpothercourse').chosen();
                ...
                $('#drpothercourse').val('').trigger("liszt:updated");
            }
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.d != "") {
                ...
                $('#prev_drpyear').empty().append($("<option></option>").val("").html("-- Please Select Year --"));

                for (var i = 0; i < year_data.length; i++) {
                    $('#drpyear').append($("<option></option>").val(year_data[i]["year_desc"]).html(year_data[i]["year_desc"]));
                    $('#prev_drpyear').append($("<option></option>").val(year_data[i]["year_desc"]).html(year_data[i]["year_desc"]));
                }
...
function bindsemdata() {
    ...
    $('#prev_drpsemester').empty().append($("<option></option>").val("").html("-- Please Select Semester --"));
    $('#prev_drpsemester').append($("<option></option>").val("M").html("Monsoon"));
    $('#prev_drpsemester').append($("<option></option>").val("S").html("Spring"));
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.d != "") {
                ...
                if ($("#hdn_utype").val() == 'I2') {
                    instructor = "<select onchange='append_tutor_image(this)' style='width:100%' class='drpinstructor' disabled><option value=''>&lt; Select Instructor &gt;</option>";
                    instructor_tutorial = "<select onchange='append_ta_tutor_hrs(this)' style='width:100%' class='drpinstructor_tutorial' disabled>";
                }
                else {
...
//                    str_room += "<option value=" + obj_room_dtl[i]["room_id"] + ">" + obj_room_dtl[i]["room_id"] + "-" + obj_room_dtl[i]["name"] + " (" + obj_room_dtl[i]["capacity"] + ")  </option>";
//                }
//                //create_str_room();
//            }
//        },
                        ...
                        if (profile_data[i]['profile_photo'] != '' && profile_data[i]['profile_photo'] != null && profile_data[i]['profile_photo'] != undefined) {
                            if (document.querySelectorAll("img[data-bind_row_no='" + (i + 1) + "']").length > 0) {
                                if (profile_data[i]['profile_photo'].indexOf("/") >= 0) {
                                    document.querySelectorAll("img[data-bind_row_no='" + (i + 1) + "']")[0].src = profile_data[i]['profile_photo'];
                                }
                                else {
                                    document.querySelectorAll("img[data-bind_row_no='" + (i + 1) + "']")[0].src = "../../UserPersonalPhoto/" + profile_data[i]['profile_photo'];
                                }
...
function create_str_room() {
    ...
    if ($('#txtavailable_seats').val() == '' || $('#txtavailable_seats').val() == '0')
    {
       ...
       //     temp_room_dtl = jQuery.grep(obj_room_dtl, function (data) { return parseFloat(data.capacity) >= parseFloat($('#txtavailable_seats').val()) });
        ...
        if (studio_flag)
        {
            temp_room_dtl = jQuery.grep(temp_room_dtl, function (data)
            {
                return data.possession == short_dept[$('#drpdepartment').val()] && data.room_type == 'Studio'
            });
        }
        else
        {
            without_dept_dtl = jQuery.grep(temp_room_dtl, function (data) { return data.possession != short_dept[$('#drpdepartment').val()] && data.room_type != 'Studio'});
            ...
            $('#tbltimeday tbody tr').each(function (e)
            {
                ...
                if ($(this).find('.from_time').val() != '' && $(this).find('.to_time').val() != '' && $(this).find('.drpday').val() != '') {
                    ...
                    var allocated_room = jQuery.grep(all_course_time_data, function (data) {
                        return data.day_code === selected_day && data.course_code != $('#txtcoursename').val() &&
                ...
                var cur_selection = $('#' + current_row_id_room + '').find('.cls_roomid').val();
                $('#' + current_row_id_room + '').find('.cls_roomid').html(temp_str_room);
                $('#' + current_row_id_room + '').find('.cls_roomid').val(cur_selection);
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.d != "") {
                ...
                dialogDiv.append('<div style="width:70%; float:left;"><b>Name:</b> ' + profile_data[0]['user_name'] + '</br><b>Email:</b> ' + profile_data[0]['mail'] + '</div><div style="float:right;"><img id="theImg" src="' + imgurl + '"style="width:105px;height:110px;"/></div>');
                dialogDiv.dialog();
...
function get_all_course_time_data() {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
...
$('#tblinstructor_tutorial tbody tr td i.icon-trash').live('click', function (e) {
    if ($("#hdn_utype").val() != 'I2' && $('input[type=radio][name=rdo_tutorial_offered]:checked').val() == 'Y') {
        var r = confirm("Are u sure you want to remove this?");
...
function typology_wise_get_hrs() {
    ...
    $.ajax({
        ...
        async: false,
        data: "{ group_id: '" + group_id + "',semester_type: '" + cur_sem + "',year_semester: '" + cur_year + "',intake_capacity: '" + intake_capacity + "',course_credits: '" + course_credits + "',designation: '" + designation + "',course_typology: '" + $('#drptypology').val() + "' }",
        dataType: "json",
        success: function (data) {
            if (data.d != "") {
...
function IsNumeric_istructor_credits() {
...
function edValueKeyPress_tutorial(e) {
    //debugger;
    // validation_hrs();
}
...
function BindCourseTimetable()
{
    ...
    if ($('#drptypology').val() == '23') {
        ...
        $.ajax({
            ...
            async: false,
            data: "{ prog_code: '" + $('#drpprog').val() + "',dept_code: '" + $('#drpdepartment').val() + "',prog_level_code: '" + prog_level_code + "',sub_category_id: '" + sub_category_id + "',course_typology: '" + course_typology + "',semester_type: '" + cur_sem + "',year_semester: '" + cur_year + "' }",
            dataType: "json",
            success: function (data) {
                if (data.d != "") {
                    var typ_hrs_dtl = JSON.parse(data.d);
