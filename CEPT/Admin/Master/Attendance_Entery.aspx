<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="Attendance_Entery.aspx.cs" Inherits="Admin_Master_Attendance_Entery_" %>
      ...
      <script type="text/javascript">
        ...
        function course_wise_entered_attendence_list(data) {
          ...
          function rowClick(row)
          {
              ...
              window.location = "Student_wise_enter_attendance.aspx?c=" + rowId + "&s=" + semester + "&y=" + year_code;
          }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       ...
       <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>
                <i class="icon-desktop"></i>Course Wise Entered Attendace
            </h1>
        </div>
    </div>
