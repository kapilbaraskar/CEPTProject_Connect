<%@ WebHandler Language="C#" Class="Course_wise_session_upload" %>
...
public class Course_wise_session_upload : IHttpHandler, IReadOnlySessionState {
    int mFileSize = 0;
        ...
        try
        {
            ...
            else
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = web.ExcelFileToDatatable_upload_session_wise_attendance(file, context);
                   // string message = "";
