<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_print_multiple_payslip_popup.aspx.cs"
    Inherits="Admin_Master_frm_print_multiple_payslip_popup" %>
   ...
   <title>Print In Payslip</title>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var year_code = getParameterByName('year');
            var Account = getParameterByName('Account');
            var Institute = getParameterByName('Institute');
            ...
            $.ajax({
                ...
                async: false,
                data: "{year_code:'" + year_code + "' ,dept_code:'" + department + "',prog_code:'" + program + "'}",
                dataType: "json",
            ...
            if (trans_data != '') {
                ...
                for (var i = 0; i < trans_data.length; i++) {
                    ...
                    $('.lbl_name_of_institute').text(Institute);

                    $('.lbl_pan_no').text('AAAJC0452C');
             //       $('.lbl_sem_code').text(trans_data[i]["semester_code"]);

                    $('.lbl_payslip_number').text(trans_data[i]["payslip_number"]);

                    $('.lbl_bank_code').text(Account);
        ...
        <div id="main_fees" align="center" x:publishsource="Excel" style="display: block;
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="1454" class="xl6512954"
                ...
                <tr class="xl6512954" height="15" style='mso-height-source: userset; height: 11.85pt'>
                    ...
                    <td colspan="14" rowspan="2" class="xl10712954" style="padding-left: 46px;">
                        Ahmedabad
                    </td>
                    <td colspan="14" rowspan="2" class="xl10712954" style="padding-left: 46px;">
                        Ahmedabad
