<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FinalTranscript.aspx.cs" Inherits="Admin_Report_FinalTranscript" %>
...
<head id="Head1" runat="server">
    ...
    <style>
        ...
        /*  table#tbl_student_detail td#td_rollno {
    ...
    border: 1px solid green !important;
        ...
        /*new add style*/
        table#tbl_student_detail td {
            width: 27% !important;
        }

        table#tbl_student_detail tr td:nth-child(3) {
            width: 25% !important;
        ...
        table#tbl_student_detail tr td:nth-child(2) {
            width: 19.5% !important;
            /* border:1px solid green !important;*/
        }

        table#tbl_student_detail tr td:nth-child(4) {
            /* border:1px solid red !important;*/
            padding-right: 10px !important;
        }
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#footer_div").css('margin-top', page_outer_height + 120 + 'px');
            ...
            if (obj_transcript_detail != null) {
                ...
                //changes 28122021
                if (obj_transcript_detail[0]["degree_name"] != "") {
                    $('#name_fo_the_degree').html(obj_transcript_detail[0]["degree_name"].toUpperCase());
                }

                if (obj_transcript_detail[0]["completion_date"] != "") {
                    // $("#label_of_completion").text('COMPLETION');
                    $('#td_graduation_year').html(obj_transcript_detail[0]["completion_date"]);
                } else {
                    $('#td_graduation_year').html("YET TO COMPLETE");
                }
                //30122021
                if (obj_transcript_detail[0]["graduation_date"] != "") {
                    $('#td_graduation_date').html(obj_transcript_detail[0]["graduation_date"]);
                }
               // else if (obj_transcript_detail[0]["graduation_year"] != "") {
               //     $('#td_graduation_date').html(obj_transcript_detail[0]["graduation_year"]);
               // }
        ...
        function setStudentDetail() {
            ...
            if (obj_stud_detail != null && obj_stud_detail != undefined) {
                ...
                //changes 28122021
                $('#name_fo_the_degree').html(obj_stud_detail[0]["degree_name"].toUpperCase());
        ...
        function setCourseDetail() {
            ...
            if (obj_course_detail != null && obj_course_detail != undefined) {
                            ...
                            if (fnd_prog == "Y") {
                                ...
                                if (grade_style == "OLD") {
                                    if (cur_sem_courses != null && cur_sem_courses != undefined) {
                                        ...
                                        console.log(total_credits_found);
                ...
                if (total_GPA_credits != 0 && total_credits != 0) {
                    ...
                    console.log('total_GPA_credits1 :' + total_GPA_credits);
                    console.log('total_credits1 :' + total_credits);
                ...
                if (rowcount > 51) {
                    ...
                    if (obj_transcript_detail != null) {
                        ...
                        //10012022
                        var new_topic_value = '';
                        var status_topic = true;
                        if (obj_transcript_detail[0]['topic_type_code'] != '')
                        {
                            new_topic_value = obj_transcript_detail[0]['topic_type_code'];
                            status_topic = false;

                        }
                        if (obj_transcript_detail[0]['topic_type'] != '' && status_topic == true)
                        {
                            new_topic_value = obj_transcript_detail[0]['topic_type']
                        }
                        ...
                        if (obj_transcript_detail[0]['topic_type'] != "" || obj_transcript_detail[0]['dissertation_topic'] != "")
                        {
                                ...
                                strTableCourseDetail_right = strTableCourseDetail_right + "<table id ='prg_summ' style='padding: 0; line-height: 19px; margin-bottom:15px; margin-top:5px;'><tr>" +
                                    "<td colspan = 4 style='border-bottom: 1px solid black; font-weight: bold; text-align: left;font-size:15px;'>" + new_topic_value + " DETAILS</td></tr>" +
                                "<tr><td colspan=1 style='text-align: left;font-size:15px; padding: 4px 1px !important;line-height: 17.5px !important;' id='topic'><b>TITLE:   </b>" + obj_transcript_detail[0]['dissertation_topic'] + "</td></tr>" +
                    ...
                    if (obj_transcript_detail != null) {
                        ...
                        {
                            strTableCourseDetail1 = strTableCourseDetail1 + "<table id ='prg_summ' style='padding: 0; line-height: 19px; margin-bottom:15px; margin-top:5px;'><tr>" +
                                "<td class='program_td' colspan = 4 style='border-bottom: 1px solid black; font-weight: bold; text-align: left;font-size:15px;'>" + new_topic_value + " DETAILS</td></tr>" +
                                "<tr><td class='program_td' colspan=1 style='text-align: left;font-size:15px; padding: 4px 1px !important;line-height: 17.5px !important;' id='topic'><b>TITLE:   </b>" + obj_transcript_detail[0]['dissertation_topic'] + "</td></tr>" +
                ...
                if (obj_transcript_detail != null && obj_transcript_detail != undefined) {
                    ...
                    if (obj_transcript_detail[0]['degree_name'] != '') {//changes 28122021
                    ...
                    //}
                    if (obj_transcript_detail[0]['completion_date'] != '') {
                        $('#td_graduation_year').html(obj_transcript_detail[0]['completion_date'].toUpperCase());
                    } else {
                        $('#td_graduation_year').html("YET TO COMPLETE");
                    }
                    //30122021
        ...
        function setCourseDetail_PG() {
            ...
            if (obj_course_detail != null && obj_course_detail != undefined) {
                        ...
                        if (obj_course_detail[cur_sem]['ws_course_detail'] != '') {
                            ...
                            for (var i = 0; i < cur_sem_ws_courses.length; i++) {
                                ...
                                if (cur_sem % 2 == 0) {
                                    ...
                                    strTableCourseDetail1 = strTableCourseDetail1 + "</table>"
                                    console.log(strTableCourseDetail1);
                                }
                                else {
                ...
                if (total_GPA_credits != 0 && total_credits != 0) {
                    ...
                    console.log('total_GPA_credits :' + total_GPA_credits);
                ...
                if (obj_transcript_detail != null) {
                    ...
                    if (obj_transcript_detail[0]['topic_type'] != "" || obj_transcript_detail[0]['dissertation_topic'] != "") {
                        strTableCourseDetail_right = strTableCourseDetail_right + "<table id ='prg_summ' style='padding: 0; line-height: 19px; margin-bottom:15px; margin-top:5px;'><tr>" +
                            "<td colspan = 4 style='border-bottom: 1px solid black; font-weight: bold; text-align: left;font-size:15px;'>" + new_topic_value + " DETAILS</td></tr>" +
                            "<tr><td colspan=1 style='text-align: left;font-size:15px;padding: 4px 1px !importent;line-height: 17.5px !importent;' id='topic'><b>TITLE:   </b>" + obj_transcript_detail[0]['dissertation_topic'] + "</td></tr>" +
...
<body id="body_id" style="color: Black; padding-left: 1.27px; padding-right: 1px; margin-left: 49.13px; margin-right: 38px; margin-bottom: 38px; padding-top: 1px; padding-bottom: 1px;">
    <div id="header_page">
        ...
        <%--<table id="tbl_student_detail" class="table table-condensed" style="width: 60%;">
            <tr>
            ...
            <tr>
                <td style="border: none;">
                    <span id="label_of_completion">GRADUATION</span></td>

                <td id="td_graduation_year" style="border: none;"></td>
                <td style="border: none; padding-left: 130px; text-align: right;">
                    <span>CODE</span>
                </td>
        ...
        <table id="tbl_student_detail" class="table table-condensed" style="width: 69%;">
            <tr>
                <td style="border: none;">
                    <span>NAME OF STUDENT</span>
                </td>
            ...
            <tr>
                ...
                <td id="td_rollno" style="border: none;"></td>
                <td id='date_text' style="border: none; padding-left: 31px; text-align: left;">
                    <span>DATE OF BIRTH</span>
                </td>
                <td id="td_dob" style="border: none; padding-left: 0px;"></td>
            </tr>
            ...
            <tr id="completed_date">
                <td style="border: none;">
                    <span id="label_of_completion">DATE OF COMPLETION</span>

                </td>

                <td id="td_graduation_year" style="border: none;"></td>
                <td class="date_gut_style" style="border: none; padding-left: 32px; text-align: left; ">DATE OF GRADUATION</td>

                <td id="td_graduation_date" style="border: none; padding-left: 0px;"></td>
            </tr>
            <tr>
                <td style="border: none; width: 240px; display: none;"><b>GRADE POINT AVERAGE</b></td>
                <td style="border: none; width: 10px; display: none;">: </td>
    ...
    <div id="footer_div" style='border: none;'>
        <footer class="div_footer" id="UG">
            ...
            <%--<div style="float: left; width: 25%; text-align:left;"><b>Issue Date : </b><span id="spn_issue_date"></span></div>--%>
            <div class="program_footer">PROGRAM CHAIR</div>
            <div class="den_footer">DEAN</div>
            <div class="reg_footer">REGISTRAR</div>
        </footer>
        <%-- <footer class="div_footer" id="PG">
            <div class="program_footer_pg">PROGRAM CHAIR</div>
            <div class="den_footer_pg">DEAN</div>
            <div class="reg_footer_pg">REGISTRAR</div>
            <div class="no_pg">NO : <span class="spn_transcript_no"></span></div>
        </footer>--%>
    </div>
    <div class="trasncript_div">
        <%--<p><b>Issue Date : </b><span id="spn_issue_date"></span></p>--%>
        <div class="issue_date">ISSUE DATE: <span id="spn_issue_date"></span>&nbsp;&nbsp;&nbsp;NO: <span class="spn_transcript_no"></span></div>
        <%--<div class="reg_footer_" style="margin-top:0.5px;">NO : <span class="spn_transcript_no"></span></div>--%>
    </div>

    <div id="desc_div" style="padding-top: 30px;">
        <table id="description_tbl" style="width: 50%; float: left; padding-top: 20px; text-align: left">
            <tr>
                <td><b>Abbreviations:</b></td>
            </tr>
            <tr>
                <%--<td><b>CRS</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Credits</td>--%>
                <td><b>CRS</b></td>
                <td>Credits</td>
            </tr>
            <tr>
            ...
            <tr>
                <%--<td><b>GPA</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Grade Point Average</td>--%>
                <td><b>GPA</b></td>
                <td>Grade Point Average</td>
            </tr>
            <tr>
                <%--<td><b>NGPA</b>&nbsp;&nbsp;&nbsp;Non-Grade Point Average</td>--%>
                <td><b>NGPA</b></td>
                <td>Non- Grade Point Average</td>
            </tr>
            <tr>
                <%--<td><b>CGPA</b>&nbsp;&nbsp;&nbsp; Cumulative Grade Point Average</td>--%>
                <td><b>CGPA</b></td>
                <td>Cumulative Grade Point Average</td>
            </tr>
            <tr>
                <%--<td><b>(E)</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Elective Course</td>--%>
                <td><b>(E)</b></td>
    ...
    <div style="">
        <table id="address" style="font-size: 11px; float: right; margin-right: 25px; margin-top: 875px; margin-bottom: 10px; width: 100%;">
            <tbody>
                <tr>
                    <td></td>
                    <td></td>
