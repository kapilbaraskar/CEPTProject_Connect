<%@ Page Title="WS Assign Details" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="ws_student_allocated_reports.aspx.cs" Inherits="Admin_Report_WS_ws_student_allocated_reports" %>
    ...
    <script type="text/javascript">
        ...
        function get_reg_student_dtl() {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "../../WebService.asmx/Get_Ws_allocate_student_dtl",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>
                <i class="icon-desktop"></i>&nbsp;WS Student Allocated Details
            </h1>
        </div>
    </div>
    ...
    <div class="" style="background-color: White;">
        ...
        <div id="DataList" class="panel panel-default" style="display: none;">
            <div class="panel-heading">
                <strong id="panel_head">WS Student Allocated Details</strong>
            </div>
            <div>
