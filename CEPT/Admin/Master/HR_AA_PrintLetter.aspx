<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HR_AA_PrintLetter.aspx.cs" Inherits="Admin_HR_AA_PrintLetter" %>
...
<body style="margin: 12px 70px 0px 70px;" class="pg_font">
    ...
    <span id="div_pg_title">CEPT/USO/F<asp:Label ID="lbl_short_dept" runat="server" ClientIDMode="Static"></asp:Label>/VFI/
        <asp:Label ID="lbl_month_year" runat="server" ClientIDMode="Static"></asp:Label>/<asp:Label ID="lbl_sr_no" runat="server" ClientIDMode="Static"></asp:Label><br />
        Date :
    ...
    <h5 class="pg_font mg_top">Sub : Engagement as Academic Associate
    ...
    <p class="mg_top" style="text-align: justify;">
        I am pleased to confirm your engagement as an Academic Associate
    ...
    <p style="text-align: justify;">
        The term of your engagement as an Academic Associate for&nbsp;<asp:Label ID="weeks" runat="server" ClientIDMode="Static"></asp:Label>&nbsp;weeks of the duration
    ...
    <p style="text-align: justify;">
        As an Academic Associate, you will assist the studio faculty in teaching
    ...
    <p style="text-align: justify;">
        ...
        please identify possibilities of extra tutoring and ensure that they are up to par
        and also inform the same to the concerned studio faculty. If students consistently
        fail to meet expected quantitative and qualitative standards of work, please notify
        them at the earliest. You are expected to communicate clearly regarding the quality
        and quantity of work expected from students.
        <br />
    </p>
    ...
    <p style="text-align: justify;">
        As an Academic Associate, you are expected to avoid conflict of commitment.
        Conflict of commitment will arise when the Academic Associate engages outside CEPT University
    ...
    <p style="text-align: justify;">
        ...
        decided by the Faculty Dean/Director. The last instalment will be subject to completion
    ...
    <div style="width: 60.2%; float: left;">
        ...
        <p style="margin-bottom: 0px;">
            <asp:Label ID="lbl_sincerely_professor" runat="server" ClientIDMode="Static"></asp:Label>
        </p>
        <p style="margin-bottom: 0px;">
            <asp:Label ID="lbl_sincerely_dean_director" runat="server" ClientIDMode="Static"></asp:Label></p>
        <p style="margin-bottom: 0px; margin-top: 0px;">
            <asp:Label ID="lbl_sincerely_dean_dept" runat="server" ClientIDMode="Static"></asp:Label>
        </p>
    </div>
