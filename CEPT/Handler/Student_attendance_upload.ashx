<%@ WebHandler Language="C#" Class="Student_attendance_upload" %>
...
public class Student_attendance_upload : IHttpHandler, IReadOnlySessionState {
         ...
         try
        {
            ...
            else
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = web.ExcelFileToDatatable_upload_student_wise_attendance(file, context);
