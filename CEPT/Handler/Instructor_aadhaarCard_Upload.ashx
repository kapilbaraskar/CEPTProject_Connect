<%@ WebHandler Language="C#" Class="Instructor_aadhaarCard_Upload" %>

using System;
using System.Web;

public class Instructor_aadhaarCard_Upload : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
            ...
            string Serverpath = System.Configuration.ConfigurationManager.AppSettings["InstructorAADHAARCardUploadPath"];

            if (context.Request.Files.Count > 0)
            {
                var postedFile = context.Request.Files[0];
                string filesize = System.Configuration.ConfigurationManager.AppSettings["InstructorAADHAARCardUploadMaxSize"];
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    finalFileName = user_id + "_" + user_name + "_AADHAARCard" + "." + extension[1];
