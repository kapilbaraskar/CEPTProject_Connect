...
public partial class Admin_Report_feedback_faculty_member_report : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //        obReportPrinter.PageFile = "https://localhost:17675/CEPT/Admin/Master/Download_feedback_PDF.aspx?course_code=" + course_code + "&instructor_code=" + dr_instructor[0]["instructor_code"] + "&semester_type=" + semester + "&year_semester=" + year;

        //        ////////    obReportPrinter.FooterFile = root + "HeaderFooter/Footer.html";
        //     //   System.Diagnostics.Process.Start("https://localhost:17675/CEPT/Admin/Master/Download_feedback_PDF.aspx?course_code=" + course_code + "&instructor_code=" + dr_instructor[0]["instructor_code"] + "&semester_type=" + semester + "&year_semester=" + year);
        ...
        //        //    myProcess.StartInfo.FileName = "https://localhost:17675/CEPT/Admin/Master/Download_feedback_PDF.aspx?course_code=" + course_code + "&instructor_code=" + dr_instructor[0]["instructor_code"] + "&semester_type=" + semester + "&year_semester=" + year;
        //        //    myProcess.Start();
        //        //}
        //        //catch (Exception ex)
        //        //{
