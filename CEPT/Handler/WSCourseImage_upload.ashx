<%@ WebHandler Language="C#" Class="WSCourseImage_upload" %>

using System;
using System.Web;

public class WSCourseImage_upload : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    int mFileSize = 0;
    string msg = "";
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
            ...
            string Serverpath = System.Configuration.ConfigurationManager.AppSettings["WSCourseImageUploadPath"];

            if (context.Request.Files.Count > 0)
            {
                var postedFile = context.Request.Files[0];
                string filesize = System.Configuration.ConfigurationManager.AppSettings["WSCourseImageUploadMaxSize"];
                ...
                if (postedFile != null && postedFile.ContentLength > 0)
                {
                    ...
                    {
                        msg = "{";
                        msg += string.Format("error:'{0}',\n", "The image dimension is not 720px X 540px Please resize and upload");
                        msg += "}";
                    }
                }
                else
