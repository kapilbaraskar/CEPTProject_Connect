<%@ Page Title="WS RateBand Approve" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="WS_RateBand_Approve.aspx.cs" Inherits="Admin_Master_WS_RateBand_Approve" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>
                <i class="icon-desktop"></i>&nbsp;WS RateBand Approve
            </h1>
        </div>
    </div>
    <div class="well" style="background-color: White;">
        ...
        <div id="div_course_list" class="panel panel-default" style="display: none;">
            <div class="panel-heading">
                <strong id="panel_head">WS RateBand Approve</strong>
            </div>
            <div>
                <%--class="panel-body"--%>
            ...
            $.ajax(
                {
                    ...
                    //async: false,
                    data: "{sem_code:'" + semester + "',year_code:'" + year_code + "',dept_code:'" + dept_code + "',authtype:'R'}",
                    dataType: "json",
                    success: function (data) {
                        if (data.d != "" && data.d != "[]") {
                            inst_profile_pic = [];
            ...
            //},
                ...
                },
                {
                    "sTitle": "HR RateBand", "mData": null, "bSortable": false, mRender: function (data)
                    {
                        ...
                        if (data.designation != "instructor") {


                            if (data.inst_uso_hr_approved == 'Y') {
                                return "Approved";
                            }
                            else
                            {
                                 if ($('#hdnusertype').val() == 'HR' && data.inst_dean_approved == "Y" && data.inst_admin_approved == "Y" && data.inst_uso_hr_approved == 'N')
                                 {
                                 ...
                                 else if (data.inst_admin_approved == 'N') {
                        ...
                        else { return "instructor Not Allow Rateband"; }
                    }
                },
                {
    ...
    <asp:Button ID="btnDownloadExcelDocuments" Style="display: none;" runat="server" ClientIDMode="Static" Text="Button" OnClick="btnDownloadExcelDocuments_Click" />
</asp:Content>
