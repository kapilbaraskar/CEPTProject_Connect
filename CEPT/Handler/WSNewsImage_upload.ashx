<%@ WebHandler Language="C#" Class="WSNewsImage_upload" %>

using System;
using System.Web;

public class WSNewsImage_upload : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    int mFileSize = 0;
    string msg = "";
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
            string Serverpath = System.Configuration.ConfigurationManager.AppSettings["WSNewsImageUploadPath"];

            if (context.Request.Files.Count > 0)
            {
                var postedFile = context.Request.Files[0];
                string filesize = System.Configuration.ConfigurationManager.AppSettings["WSNewsImageUploadMaxSize"];
