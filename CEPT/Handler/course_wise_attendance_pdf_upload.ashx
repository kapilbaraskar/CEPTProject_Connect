<%@ WebHandler Language="C#" Class="course_wise_attendance_pdf_upload" %>

using System;
using System.Web;

public class course_wise_attendance_pdf_upload : IHttpHandler,System.Web.SessionState.IRequiresSessionState {
    int mFileSize = 0;
    string msg = "";
        ...
        try
        {
            ...
            if (context.Request.Files.Count > 0)
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    bool save = objWebService.course_wise_save_attendance_doc(finalFileName, UploadType,context);
