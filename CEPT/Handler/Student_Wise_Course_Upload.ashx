<%@ WebHandler Language="C#" Class="Student_Wise_Course_Upload" %>

using System;
using System.Web;

public class Student_Wise_Course_Upload : IHttpHandler {
        ...
        try
        {
            ...
            else
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = web.ExcelFileToDatatable_upload_student_wise_course(file, context);
