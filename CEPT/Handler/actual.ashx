...
public class actual : IHttpHandler,System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
            ...
            string Serverpath = System.Configuration.ConfigurationManager.AppSettings["project_Actual_Path"];

            if (context.Request.Files.Count > 0)
            {
                var postedFile = context.Request.Files[0];
                var date = context.Request.QueryString["selected_date"];
                string filesize = System.Configuration.ConfigurationManager.AppSettings["project_actual_MaxSize"];
