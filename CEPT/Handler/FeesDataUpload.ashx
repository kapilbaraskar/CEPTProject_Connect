<%@ WebHandler Language="C#" Class="FeesDataUpload" %>

using System;
using System.Web;

public class FeesDataUpload : IHttpHandler, System.Web.SessionState.IReadOnlySessionState
{
    int mFileSize = 0;
        ...
        try
        {
            ...
            else
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = web.ExcelFileToDatatable_UploadFeesData(file, context);
