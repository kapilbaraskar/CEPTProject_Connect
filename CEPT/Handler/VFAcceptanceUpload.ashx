<%@ WebHandler Language="C#" Class="VFAcceptanceUpload" %>

using System;
using System.Web;

public class VFAcceptanceUpload : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
            ...
            string Serverpath = System.Configuration.ConfigurationManager.AppSettings["VFAcceptanceUploadPath"];
