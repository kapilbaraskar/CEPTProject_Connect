<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageDesign.master" AutoEventWireup="true" CodeFile="EazypayResponseHandler.aspx.cs" Inherits="Student_EazypayResponseHandler" %>
        ...
        <div id="div_pay_fees" class="panel-body" style="min-height: 20px;">
            ...
            <div>
                ...
                <table class="table table-bordered cls_align_center">
                    ...
                    <tbody>
                        <%--<tr>
                                        <td><label class="radio-inline"><input type="radio" name="rdo_online_pay_option" id="rdo_online_pay_citrus" value="citrus" onclick="pg_change('online_citrus')" />&nbsp;Citrus</label></td>
                                        <td>Yes</td>
                                        <td>Zero</td>
                                        <td>Yes</td>
                       ...
                       <tr>
                                        <td><label class="radio-inline"><input type="radio" name="rdo_online_pay_option" id="rdo_online_pay_eazypay" value="eazypay" onclick="pg_change('online_eazypay')" />&nbsp;Eazypay</label></td>
                                        <td>Yes</td>
                        ...
                        <tr>
                            <td>
                                <label class="radio-inline">
                                    <input type="radio" name="rdo_online_pay_option" id="rdo_online_pay_kotak" value="kotak" onclick="pg_change('online_kotak')" />&nbsp;Kotak</label></td>
                            <td>Yes</td>
                            <td>Zero</td>
                            <td>Yes</td>
                            <td>1% plus applicable GST</td>
