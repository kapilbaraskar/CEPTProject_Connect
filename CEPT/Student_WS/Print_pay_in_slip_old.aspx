<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Print_pay_in_slip_old.aspx.cs" Inherits="Student_Print_pay_in_slip_old" %>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.d != "") {
                        ...
                        $('.lbl_student_code').text(user_data[0]["student_no"]);
                        $('.lbl_pan_no').text('AAAJC0452C');
                        // $('.lbl_sem_code').text(user_data[0]["semester_code"]);
                        $('.lbl_bank_code').text('FCCUVY');
                                ...
                                if (waiver_installmant_data != '') {
                                    ...
                                    if (waiver_installmant_data[0]["fees_type"] == "F") {
                                        ...
                                        if (waiver_installmant_data[0]["fees_type"] == "I") {
                                            ...
                                            $('.lbl_amount1').text((fees_status[0]["credit_choice"] * 4000) / 4);
