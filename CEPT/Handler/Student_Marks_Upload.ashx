<%@ WebHandler Language="C#" Class="Student_Marks_Upload" %>
...
public class Student_Marks_Upload : IHttpHandler, IReadOnlySessionState{
        ...
        try
        {
            ...
            else
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = web.ExcelFileToDatatable_upload_student_wise_marks(file, context);
