<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="Sws_course_wise_enter_session_dtl.aspx.cs" Inherits="Admin_Master_Sws_course_wise_enter_session_dtl" %>
    ...
    <script type="text/javascript">
        ...
        function UploadAttendance() {
            try {
                ...
                if (CheckMarksDocumentExtension(fileToUpload)) {
                    ...
                    $.ajaxFileUpload({
                        type: "POST",
                        url: '../../Handler/ws_Course_wise_session_upload.ashx',
                        secureuri: false,
        ...
        function save_manully_session() {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "../../WebService.asmx/ws_manully_save_session",
            ...
            $.ajax(
                {
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "../../WebService.asmx/ws_cancel_sessions",
        ...
        function step_next_page() {
            window.location = "ws_student_wise_session_attendence.aspx?c=" + $('#hdn_code').val() + "&s=" + $('#hdn_semester').val() + "&y=" + $('#hdn_year').val();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>
                <i class="icon-desktop"></i>SWS Course Wise Session Attendance Entry
            </h1>
        </div>
    </div>
    ...
    <div class="well" style="background-color: White;">
        ...
        <div id="div_course_list" class="panel panel-default" style="display: block;">
            <div class="panel-heading">
                <strong>SWS Course Wise Session Attendance Entry </strong>
                <%--<span style="float: right;">
                    <input id="btn_excel_data" type="button" class="btn btn-primary" value="Excel Data" style="height: 40px; margin-top: -10px; display: none;" onclick="display_data_for_excel()" />
                    <input id="btn_excel_format" type="button" class="btn btn-primary" value="Csv Format" style="height: 40px; margin-top: -10px; display: none;" onclick="display_excel_format()" />
                    <input id="btn_excel" type="button" class="btn btn-primary" value="Excel Format" style="height: 40px; margin-top: -10px;" onclick="display_excel()" />
    ...
    <asp:Button ID="btnDownloadExcelDocuments" runat="server" Text="Button" Style="display: none;" ClientIDMode="Static" OnClick="btnDownloadExcelDocuments_Click"/>
