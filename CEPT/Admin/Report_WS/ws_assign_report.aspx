<%@ Page Title="WS Student Allocated Reports" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="ws_student_allocated_reports.aspx.cs" Inherits="Admin_Report_WS_ws_student_allocated_reports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>
                <i class="icon-desktop"></i>&nbsp;WS Assign Details
            </h1>
        </div>
    </div>
    ...
    <div class="" style="background-color: White;">
        ...
        <div id="DataList" class="panel panel-default" style="display: none;">
            <div class="panel-heading">
                <strong id="panel_head">Student Assign Details</strong>
            </div>
            <div>
