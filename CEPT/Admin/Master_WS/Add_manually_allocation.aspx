...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#drcourses,#drpdepartment,#drpprog,#drptype').on('change', function () {
                $('#example tbody').html('');
                $('#btnsave').css('display', 'none').closest('.copyright').css('display', 'none');
                $('#DataList').css('display', 'none');
                $('#div_student_list').css('display', 'none');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>
                <i class="icon-desktop"></i>&nbsp;Add Courses Manually
            </h1>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="chosen-select" id="drptype">
                                ...
                                <option value="T">Change Student Course Type</option>
                            </select>
                        </td>
                       </tr>
                    <tr>
