<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCEPT.master" AutoEventWireup="true" CodeFile="course_wise_session_dtl.aspx.cs" Inherits="Admin_Master_course_wise_session_dtl" %>
    ...
    <script type="text/javascript">
            ...
            $.ajax(
                {
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    //url: "../../WebService.asmx/attendance_details_data",
                   // url: "../../WebService.asmx/course_wise_entered_marks_list",
                    url: "../../WebService.asmx/course_wise_session_submit_list",
                    //async: false,
        ...
        function course_wise_entered_attendence_list(data) {
                ...
                "aoColumns": [
                    ...
                    },
                    {
                        "sTitle": "", "mData": null, "bSortable": false, fnRender: function (data) {
                            ...
                            if (data['aData'].attendance_status == 'Submitted' && ($('#hdnuserid').val() == 'ugpgoffice' || $('#hdnuserid').val() == 'admin.asc@cept.ac.in'))
                            {

                                return '<center><button type="button" id=' + data['aData'].course_code + ' onclick="sendforreview(this)">Send for Review</button></center>';
                            }
                            else { return ''; }
          ...
          function rowClick(row)
          {
              ...
              window.location = "course_wise_enter_session_dtl.aspx?c=" + rowId + "&s=" + semester + "&y=" + year_code;
          }
        ...
        function sendforreview(data) {
            var course_code = data.id;
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "../../WebService.asmx/Get_Review_data",
                async: false,
                ...
                success: function (data) {
                    if (data.d == "true") {
                        ...
                        alert("problem in review the data");
                    }
                },
                error: function (result) {
                    alert(result);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>
                <i class="icon-desktop"></i>Course Wise Session 
            </h1>
        </div>
    </div>
    <div class="well" style="background-color: White;">
        ...
        <div id="div_course_list" class="panel panel-default" style="display: none;">
            <div class="panel-heading">
                <strong>Course Wise Session Detail</strong>
            </div>
            <div>
