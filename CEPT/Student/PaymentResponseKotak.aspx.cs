...
public partial class Student_PaymentResponseKotak : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            //Log.PaymentTransactionLog("---Start---------------------------------------" + DateTime.Now + "-----------------------------------------------------");
            ...
            //string encResponse = "order_id=FCCPFTucadmin4P2021078463&tracking_id=109989764129&bank_ref_no=0121953016&order_status=Success&failure_message=&payment_mode=Net Banking&card_name=Kotak Mahindra Bank&status_code=null&status_message=&currency=INR&amount=31500.00&billing_name=ANISH NOONE&billing_address=GANDHI NAGAR&billing_city=HYDERABAD&billing_state=TELANGANA&billing_zip=500082&billing_country=India&billing_tel=9700575057&billing_email=anishnoone@gmail.com&delivery_name=ANISH NOONE&delivery_address=GANDHI NAGAR&delivery_city=HYDERABAD&delivery_state=TELANGANA&delivery_zip=500082&delivery_country=India&delivery_tel=9700575057&merchant_param1=ucadmin&merchant_param2=NOONE ANISH&merchant_param3=1&merchant_param4=-#4#1#Y#S#Y2016&merchant_param5=&vault=N&offer_type=null&offer_code=null&discount_value=0.0&mer_amount=31500.00&sub_account_id=CEPTFAK&eci_value=null&retry=N&response_code=0&billing_notes=&trans_date=15/10/2020 17:41:16&bin_country=&trans_fee=0.0&service_tax=0.0";
            ...
            Log.PaymentTransactionLog("Payment Response From Kotak. " + encResponse);

            if (!IsPostBack)
            {
                PaymentRes paymentResponse = new PaymentRes();
                if (Params["order_status"] != "Awaited")
                {
                    ...
                    try
                    {
                        ...
                        if(UID != null)
                        {
                            ...
                            string message = objPayment.SavePaymentDetails_Kotak(Params, ref paymentResponse, Params["merchant_param3"]);
                ...
                else
                {
                    ...
                    paymentResponse.data.transaction_id = Params["order_id"];
                    paymentResponse.data.pg_transaction_id = Params["tracking_id"];
                }
