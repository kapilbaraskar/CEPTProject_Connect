<%@ WebHandler Language="C#" Class="course_master" %>

using System;
using System.Web;
using System.Web.UI;
public class course_master : IHttpHandler,System.Web.SessionState.IReadOnlySessionState {
    int mFileSize = 0;
        ...
        try
        {
            ...
            else
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = web.ExcelFileToDatatable_department_upload(file, context);
