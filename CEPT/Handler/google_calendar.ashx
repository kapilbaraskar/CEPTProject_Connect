<%@ WebHandler Language="C#" Class="google_calendar" %>
...
public class google_calendar : IHttpHandler,System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                //IICalendarCollection calendars = iCalendar.LoadFromFile(@"" + fileDirectory);

                //var All_events = calendars[0].Events.ToList();
                if (!postedFile.FileName.Contains(".ics"))
                {
                    context.Response.ContentType = "text/html";
                    context.Response.Write("Please upload only .ics file format which is export from google calendar.");
                }
                else
                {
                    ...
                    string message = web.Save_google_event(fileDirectory, context);
