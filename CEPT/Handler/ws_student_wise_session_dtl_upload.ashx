<%@ WebHandler Language="C#" Class="ws_student_wise_session_dtl_upload" %>

using System;
using System.Web;
using System.Web.SessionState;

public class ws_student_wise_session_dtl_upload : IHttpHandler,IReadOnlySessionState {
    int mFileSize = 0;
             ...
             try
        {
            ...
            else
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = web.ws_ExcelFileToDatatable_upload_student_session_wise_attendance(file, context);
                    //string message = "";
