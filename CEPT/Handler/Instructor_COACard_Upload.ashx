<%@ WebHandler Language="C#" Class="Instructor_COACard_Upload" %>

using System;
using System.Web;

public class Instructor_COACard_Upload : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    int mFileSize = 0;
    string msg = "";
    ...
    public void ProcessRequest(HttpContext context)
    {
         try
        {
            ...
            string Serverpath = System.Configuration.ConfigurationManager.AppSettings["InstructorCOACardUploadPath"];

            if (context.Request.Files.Count > 0)
            {
                var postedFile = context.Request.Files[0];
                string filesize = System.Configuration.ConfigurationManager.AppSettings["InstructorCOACardUploadMaxSize"];
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    finalFileName = user_id + "_" + user_name + "_COACard" + "." + extension[1];
