<%@ WebHandler Language="C#" Class="Upload_Student_UserId" %>
...
public class Upload_Student_UserId : IHttpHandler, IReadOnlySessionState {
        ...
        try
        {
            ...
            else
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = web.ExcelFileToDatatable_upload_userid_email_id(file, context);//ExcelFileToDatatable_upload_student_wise_marks
