<%@ WebHandler Language="C#" Class="instructer" %>
using System;
using System.Web;
using System.Web.UI;
public class instructer : IHttpHandler, System.Web.SessionState.IReadOnlySessionState
{
        ...
        try
        {
            ...
            else
            {
                ...
                if (mFileSize <= Convert.ToInt32(filesize))
                {
                    ...
                    string message = web.ExcelFileToDatatable_uplad_instructor(file, context);
